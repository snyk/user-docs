...
{% hint style="warning" %}
You must have the View Organization and View Project [permissions](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/IgtgtomLQ2TUgSKOMSAm/snyk-platform-administration/user-roles/pre-defined-roles) to view Import Log messages for imports made within your Organization.
{% endhint %}
