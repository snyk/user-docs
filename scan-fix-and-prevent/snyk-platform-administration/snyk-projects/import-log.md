...
{% hint style="warning" %}
You must have the View Organization and View Project [permissions](https://docs.snyk.io/platform-administration/user-management/pre-defined-roles) to view Import Log messages for imports made within your Organization.
{% endhint %}
...
<figure><img src="../../.gitbook/assets/import-log-timeline.png" alt="The Import Log timeline"><figcaption><p>The Import Log timeline</p></figcaption></figure>
