...
You can also perform these actions using the API endpoints [Add a tag to a Project](https://docs.snyk.io/developer-tools/snyk-api/reference/projects-v1#org-orgid-project-projectid-tags), [Remove a tag from a Project](https://docs.snyk.io/developer-tools/snyk-api/reference/projects-v1#org-orgid-project-projectid-tags-remove), and [List all tags in a Group](https://docs.snyk.io/developer-tools/snyk-api/reference/groups-v1#group-groupid-tags).
...
To delete a Project tag from the Group, use the API endpoint [Delete a tag from a Group](https://docs.snyk.io/developer-tools/snyk-api/reference/groups-v1#group-groupid-tags).
...
<figure><img src="../../.gitbook/assets/filter-tag-option.png" alt="Filter by tag option"><figcaption><p>Filter by tag option</p></figcaption></figure>
