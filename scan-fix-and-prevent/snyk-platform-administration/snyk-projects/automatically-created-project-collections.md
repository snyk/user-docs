...
* Automated Collections does not detect [SAST](https://docs.snyk.io/glossary#sast) scans pushed to the Snyk Web UI using the `snyk code test --report --project-name="name"` command.
