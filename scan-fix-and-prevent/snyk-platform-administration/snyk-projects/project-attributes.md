...
{% hint style="info" %}
You can apply attributes to Projects and remove attributes using endpoint [Applying attributes](https://docs.snyk.io/developer-tools/snyk-api/reference/projects-v1#org-orgid-project-projectid-attributes).
