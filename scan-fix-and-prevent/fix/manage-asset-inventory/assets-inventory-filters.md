...
{% hint style="info" %}
The filters **Application**, **Catalog name**, **Category**, **Lifecycle**, **Owner**, **Title** are visible only if you have configured the [application context](https://docs.snyk.io/developer-tools/integrations/scm-integrations/application-context-for-scm-integrations) catalog for your SCM integrations.
{% endhint %}
