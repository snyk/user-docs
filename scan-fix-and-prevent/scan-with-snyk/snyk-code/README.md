...
* [Snyk IDE](https://docs.snyk.io/developer-tools/integrations/snyk-ide-plugins-and-extensions)
* [Snyk CLI](https://docs.snyk.io/developer-tools/snyk-cli)
* [Snyk API](https://docs.snyk.io/developer-tools/snyk-api/snyk-api)
...
* IDE
  * [JetBrains plugin](https://docs.snyk.io/developer-tools/integrations/snyk-ide-plugins-and-extensions/jetbrains-plugin)
  * [Visual Studio Code extension](https://docs.snyk.io/developer-tools/integrations/snyk-ide-plugins-and-extensions/visual-studio-code-extension)
  * [Visual Studio extension](https://docs.snyk.io/developer-tools/integrations/snyk-ide-plugins-and-extensions/visual-studio-extension)
...
* APIs and extensibility: Query Code Projects and issues using the Snyk [REST API](https://docs.snyk.io/developer-tools/snyk-api/reference).
* Notifications: [Integrate with Jira](https://docs.snyk.io/developer-tools/integrations/jira-and-slack-integrations/jira-integration) to export data to Jira issues.
...
* [Create or log in to a Snyk account](https://docs.snyk.io/getting-started-guides/getting-started#create-or-log-in-to-a-snyk-account)
* [Set up an integration](https://docs.snyk.io/getting-started-guides/getting-started#set-up-a-snyk-integration)
* [Import a Project](https://docs.snyk.io/getting-started-guides/getting-started#import-a-project-to-scan-and-identify-issues)
