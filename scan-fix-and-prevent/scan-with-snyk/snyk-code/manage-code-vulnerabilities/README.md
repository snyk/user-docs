...
* You have completed the steps in [Getting started](https://app.gitbook.com/s/L7HyJj9FsK1W4pNt8Gzl/getting-started-guides/getting-started).
...
Automate importing multiple repositories using the API endpoint [Import targets](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-api/reference/import-projects-v1#org-orgid-integrations-integrationid-import).
