...
Automate importing multiple repositories using the API endpoint [Import targets](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/IEEjSXQQu36y0vmFV8zf/snyk-api/reference/import-projects-v1#org-orgid-integrations-integrationid-import).
