...
* You have completed the steps in [Getting started](https://docs.snyk.io/getting-started-guides/getting-started).
...
Automate importing multiple repositories using the API endpoint [Import targets](https://docs.snyk.io/developer-tools/snyk-api/reference/import-projects-v1#org-orgid-integrations-integrationid-import).
