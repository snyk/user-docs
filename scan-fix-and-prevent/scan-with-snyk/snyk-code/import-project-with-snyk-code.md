...
Imported Projects are organized under Target folders on the Projects page, named after the Git repository account and specific repository. See [Import a Project to scan and identify issues](https://docs.snyk.io/getting-started-guides/getting-started#import-a-project-to-scan-and-identify-issues).
