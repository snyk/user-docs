...
Snyk is not onboarding new Local Engine deployments. If you are evaluating Snyk Code, visit [Configure Snyk Code](configure-snyk-code.md) for the supported deployment options.
