...
{% hint style="info" %}
Customers who managed access during the closed beta must add the updated Rule Extensions permissions to their custom roles — Snyk does not backfill them. The deprecated SAST Rule Extensions permissions are removed from the UI after a 30-day grace period.
{% endhint %}
