...
* In the Snyk Web UI
* With your [IDE](https://docs.snyk.io/developer-tools/integrations/snyk-ide-plugins-and-extensions)
* With a [CI/CD integration](https://docs.snyk.io/developer-tools/integrations/snyk-ci-cd-integrations)
