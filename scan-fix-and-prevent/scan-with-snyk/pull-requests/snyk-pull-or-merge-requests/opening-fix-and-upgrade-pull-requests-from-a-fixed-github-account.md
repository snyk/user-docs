...
For more information about repository permission levels in GitHub, see [GitHub integration](https://docs.snyk.io/developer-tools/integrations/scm-integrations/organization-level-integrations/github).
