...
1. (Optional) Examine the pull request generated by [Snyk Bot](https://docs.snyk.io/developer-tools/integrations/scm-integrations/organization-level-integrations/github#commit-signing) in the Conversation tab in GitHub.
