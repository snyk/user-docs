...
3. Select the checkboxes for the fields you want to require:
...
2. Select one or more findings you wish to accept.
3. From the **State** dropdown menu, select **Accepted Risk**.
4. A dialog box is displayed, listing the custom fields you configured.
