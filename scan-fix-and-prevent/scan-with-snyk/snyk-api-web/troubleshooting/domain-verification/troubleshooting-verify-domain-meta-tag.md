...
In order for Snyk API & Web to run full-fledged scans, you need to verify your domains. Visit [Verify domain ownership](../../configure-targets/verify-domain-ownership/) to learn more about why domain verification is required.
