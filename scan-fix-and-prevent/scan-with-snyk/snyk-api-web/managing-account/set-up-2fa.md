...
<figure><img src="../../../.gitbook/assets/set-up-2fa_image1.png" alt="User profile menu in navigation bar"></figure>

2. In the **Two-factor authentication (2FA)** section, click **Set up**.

<figure><img src="../../../.gitbook/assets/set-up-2fa_image2.png" alt="Two-factor authentication setup button in profile settings"></figure>

3. Enter your password as a security measure in the dialog that appears.
1. In the next dialog, follow the instructions:

<figure><img src="../../../.gitbook/assets/set-up-2fa_image3.png" alt="Two-factor authentication QR code setup dialog"></figure>
   ...
   1. Enter the verification code given by the app.
   1. Click **Verify**.
...
<figure><img src="../../../.gitbook/assets/set-up-2fa_image4.png" alt="Two-factor authentication recovery codes"></figure>
...
<figure><img src="../../../.gitbook/assets/set-up-2fa_image5.png" alt="Two-factor authentication login prompt"></figure>
...
<figure><img src="../../../.gitbook/assets/recover-2fa-access_image1.png" alt="Two-factor authentication verification code prompt"></figure>
...
1. Reset your 2FA with the help of the Snyk API & Web account owner.
1. Contact the Snyk API & Web support team.
...
1. Type the code in the 2FA dialog to complete the authentication.
...
<figure><img src="../../../.gitbook/assets/recover-2fa-access_image2.png" alt="Settings menu with Users option"></figure>

2. On the Users screen, click the line of your user to edit it.
1. On the User edit screen, click **Reset 2FA** and confirm.

<figure><img src="../../../.gitbook/assets/recover-2fa-access_image3.png" alt="Reset 2FA button in user edit screen"></figure>
