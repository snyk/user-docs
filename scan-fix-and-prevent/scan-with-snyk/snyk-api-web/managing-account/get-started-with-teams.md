...
3. Optionally, you can limit the number of targets each team can create by assigning a target quota. This value depends on how many targets can still be added to your Snyk API & Web account.
