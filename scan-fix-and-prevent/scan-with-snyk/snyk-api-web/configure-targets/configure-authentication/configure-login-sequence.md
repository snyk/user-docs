...
* You have recorded a login sequence using the [Snyk API & Web Sequence Recorder](../configure-web-targets/use-sequence-recorder.md).
...
2. Open the Snyk API & Web Sequence Recorder plugin. Visit [Use sequence recorder](../configure-web-targets/use-sequence-recorder.md) for installation instructions.
