...
* If you are using a self-hosted Artifactory instance, see [Snyk Broker - Container Registry Agent](https://docs.snyk.io/platform-administration/snyk-broker/snyk-broker-container-registry-agent).
