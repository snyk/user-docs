...
You can manage the versioning schema for images imported to Projects for a repository in the Web UI  or by using the API endpoint [Create a Custom Base Image from an existing container project](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/IEEjSXQQu36y0vmFV8zf/snyk-api/reference/custom-base-images#custom_base_images).
