...
* Create a **Group** or **Organization** **service account token**. For more information, see [Service accounts](https://docs.snyk.io/platform-administration/service-accounts/service-accounts). Different roles allow the integration to publish data:
  * Group Admin
  * Org Admin
