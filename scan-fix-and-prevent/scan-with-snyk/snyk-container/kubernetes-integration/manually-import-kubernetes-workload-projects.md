...
You can also import one cluster to multiple Snyk Organizations in manual import by [cloning an integration across your Snyk organizations](https://docs.snyk.io/platform-administration/snyk-broker/classic-broker/clone-an-integration-across-your-snyk-organizations), so the integrations have the same integration ID.
