...
For a full list of `snyk iac describe` options, see [`snyk iac describe`](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/snyk-cli/commandsiac-describe) command help or display the help by running:
