...
One way to do this is by using the API endpoint [Update the Infrastructure as Code settings for a group](https://docs.snyk.io/developer-tools/snyk-api/reference/iacsettings#patch-groups-group_id-settings-iac).
