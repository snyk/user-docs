...
For details, see [Snyk Broker - Infrastructure as Code detection](https://docs.snyk.io/platform-administration/snyk-broker/classic-broker/snyk-broker-infrastructure-as-code-detection). For more information about Snyk Broker, see the [Broker](https://docs.snyk.io/platform-administration/snyk-broker/snyk-broker) docs.
