...
Snyk IaC scans Terraform files that use the AWS provider. Version 4.0.0 of the provider changed how S3 buckets are defined, which affects how Snyk reports issues against them.
