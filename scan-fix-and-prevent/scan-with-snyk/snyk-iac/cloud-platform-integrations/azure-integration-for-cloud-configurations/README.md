...
* API only: An Organization-level [service account](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/IgtgtomLQ2TUgSKOMSAm/service-accounts/service-accounts) with an Org Admin role to use the Snyk API
