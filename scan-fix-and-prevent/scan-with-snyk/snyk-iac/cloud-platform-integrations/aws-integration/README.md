...
* A Snyk Group Administrator or Organization Administrator [role](https://docs.snyk.io/platform-administration/user-management/pre-defined-roles)
...
* API only: An Organization-level [service account](https://docs.snyk.io/platform-administration/service-accounts/service-accounts) with an Org Admin role to use the Snyk API
