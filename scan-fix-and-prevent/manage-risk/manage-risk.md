...
* [Application Context](https://docs.snyk.io/developer-tools/integrations/scm-integrations/application-context-for-scm-integrations): Bring the application context with [Assets and risk factors](prioritize-issues-for-fixing/assets-and-risk-factors/), and [Set up Insights](prioritize-issues-for-fixing/set-up-insights/).
