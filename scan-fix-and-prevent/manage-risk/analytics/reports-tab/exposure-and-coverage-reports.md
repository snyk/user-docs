...
**\*** All filters marked with `*` are visible only if you configured the [application context](https://docs.snyk.io/developer-tools/integrations/scm-integrations/application-context-for-scm-integrations) catalog for your SCM integrations.
