...
{% hint style="info" %}
Snyk recommends applying the tags through the API in order to automate the process. For more information, see the endpoint [Add a tag to a project](https://docs.snyk.io/developer-tools/snyk-api/reference/projects-v1#org-orgid-project-projectid-tags).
{% endhint %}
...
See the [Project Update documentation](https://docs.snyk.io/developer-tools/snyk-api/reference/projects-v1#org-orgid-project-projectid).
