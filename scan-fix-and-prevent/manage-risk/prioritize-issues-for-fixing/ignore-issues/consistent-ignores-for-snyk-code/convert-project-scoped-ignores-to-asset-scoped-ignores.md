...
* [API Endpoint](https://docs.snyk.io/developer-tools/snyk-api/reference/ignores-v1): `GET /v1/org/{org_id}/project/{project_id}/ignores`
...
* [API Endpoint:](https://docs.snyk.io/developer-tools/snyk-api/reference/ignores-v1) `DELETE /v1/org/{org_id}/project/{project_id}/ignore/{project_scoped_id}`
