...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------- |
| Ignore by policy (add ignore commands to your security policies) For an IDE and the CLI, the testing must be done in the relevant Organization for the policies to be used.                                   | <p>Open Source: ✅</p><p>Container: ✅</p><p>Code: ✅</p> | <p>Open Source: ✅</p><p>Container: ❌</p><p>Code: ✅</p>  |
| Ignore by UI or API                                                                                                                                                                                                   | <p>Open Source: ✅</p><p>Container: ✅</p><p>Code: ✅</p> | <p>Open Source: ✅</p><p>Container: ❌</p><p>Code: ✅ </p> |
