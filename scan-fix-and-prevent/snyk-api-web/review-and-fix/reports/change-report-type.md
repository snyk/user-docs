...
<figure><img src="../../../../.gitbook/assets/change-report-type-report-list.png" alt="Screenshot showing the list of available report types including Standard, Executive Summary, PCI-DSS, OWASP Top 10, ISO 27001, and HIPAA"></figure>

Visit [Report types](report-types.md) to learn more about all the report types.

To learn how to generate a target scan report, visit [Generate a scan report](generate-scan-report.md).
