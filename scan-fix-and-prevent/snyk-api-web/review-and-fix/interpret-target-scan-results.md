...
<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-overview.png" alt="Target scan results page showing Overview, Findings, and Reports sections"></figure>
...
<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-risk-section.png" alt="Risk section displaying vulnerability counts and compliance tags"></figure>
...
<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-status-section-1.png" alt="Status section showing scan timing, duration, and status"></figure>

<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-status-section-2.png" alt="Status section showing login success and crawling report download option"></figure>

The **Settings** section shows the settings that were used during the scan.

<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-settings-section.png" alt="Settings section displaying scan configuration used"></figure>
...
<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-details-section.png" alt="Details section showing progress bars for fingerprinter, crawler, and scanner"></figure>
...
<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-findings-section.png" alt="Findings section displaying list of vulnerabilities found"></figure>
...
<figure><img src="../../../.gitbook/assets/interpret-target-scan-results-reports-dropdown.png" alt="Reports dropdown showing available report options"></figure>
