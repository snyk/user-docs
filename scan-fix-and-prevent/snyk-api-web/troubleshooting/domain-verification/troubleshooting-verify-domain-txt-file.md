...
To run full-fledged scans, you must verify domain ownership. Visit [Verify domain ownership](../../configure-targets/verify-domain-ownership/verify-domain-ownership.md) to learn why verification is required.
...
| A WAF is blocking access to the file. | Add Snyk API & Web IPs to the WAF's allowlist. Visit [Configure IPs in WAFs](../../start-scanning/scan-access-and-connectivity/configure-ips-in-wafs.md). |
