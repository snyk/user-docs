...
<figure><img src="../../../../.gitbook/assets/integrate-snyk-api-web-with-gitlab-cicd_image1.png" alt="GitLab Settings menu with CI/CD option"></figure>

1. Find the **Variables** section and expand it.

<figure><img src="../../../../.gitbook/assets/integrate-snyk-api-web-with-gitlab-cicd_image2.png" alt="GitLab CI/CD Variables section"></figure>

1. Click **Add variable** and create an entry for your Snyk API & Web **API Key** (for example, **PROBELY_API_KEY**).

<figure><img src="../../../../.gitbook/assets/integrate-snyk-api-web-with-gitlab-cicd_image3.png" alt="Adding API Key variable"></figure>

<figure><img src="../../../../.gitbook/assets/integrate-snyk-api-web-with-gitlab-cicd_image4.jpg" alt="API Key variable configuration"></figure>

1. Click **Add variable** again to create a second entry for your **target ID** (for example, **TARGET_ID**).
...
<figure><img src="../../../../.gitbook/assets/integrate-snyk-api-web-with-gitlab-cicd_image5.png" alt="Ephemeral environment scanning workflow"></figure>
...
<figure><img src="../../../../.gitbook/assets/integrate-snyk-api-web-with-gitlab-cicd_image6.png" alt="GitLab pipeline running"></figure>

Once the scan is complete, you can view the detailed findings in your Snyk API & Web dashboard.

<figure><img src="../../../../.gitbook/assets/integrate-snyk-api-web-with-gitlab-cicd_image7.png" alt="Scan results in Snyk API & Web dashboard"></figure>
