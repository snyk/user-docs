...
1.  CSS selector for the TOTP input field: This selector depends on whether your site uses a single input field or multiple fields for the authenticator code.
   ...
   * Single input field:
      ...
      <figure><img src="../../../.gitbook/assets/configure-two-factor-authentication-totp-single-field.png" alt="Single TOTP input field"></figure>
   ...
   * Multiple input fields:
      ...
      <figure><img  src="../../../.gitbook/assets/configure-two-factor-authentication-totp-multiple-fields.png" alt="Multiple TOTP input fields" ></figure>
...
<figure><img src="../../../.gitbook/assets/configure-two-factor-authentication-totp-login-form.png" alt="TOTP configuration for Login Form"></figure>
...
<figure><img src="../../../.gitbook/assets/configure-two-factor-authentication-totp-login-sequence.png" alt="TOTP configuration for Login Sequence"></figure>
...
<figure><img src="../../../.gitbook/assets/configure-two-factor-authentication-otp-login-form.png" alt="Alternative OTP configuration for Login Form"></figure>
...
<figure><img src="../../../.gitbook/assets/configure-two-factor-authentication-otp-login-sequence.png" alt="Alternative OTP configuration for Login Sequence"></figure>
...
<figure><img src="../../../.gitbook/assets/configure-two-factor-authentication-otp-api-url.png" alt="Unique 2FA Configuration URL in target settings"></figure>
