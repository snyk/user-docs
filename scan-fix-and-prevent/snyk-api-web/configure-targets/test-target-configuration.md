...
<figure><img src="../../.gitbook/assets/test-target-configuration-results.png" alt="Test configuration results showing connectivity check, WAF detection, authentication validation, and extra hosts discovery"></figure> | <figure><img src="../../.gitbook/assets/test-target-configuration-error-example.png" alt="Test configuration error example with call to action to resolve the issue"></figure>
---|---
