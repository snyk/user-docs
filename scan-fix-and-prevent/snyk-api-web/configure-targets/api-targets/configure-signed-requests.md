...
<figure><img src="../../../.gitbook/assets/configure-signed-requests-settings.png" alt="Signature settings page showing signature type dropdown and configuration fields"></figure>
