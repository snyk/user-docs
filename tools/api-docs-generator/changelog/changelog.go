...
func UpdateChangelog(ctx context.Context, cfg config.Config, changeLogFileName, endVersion string) error {
	...
	nextVersion := versions.GetLatestGAVersion(allVersions)
