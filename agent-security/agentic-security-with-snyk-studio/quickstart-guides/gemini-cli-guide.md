...
<figure><img src="../../.gitbook/assets/image (25).png" alt="Gemini extensions install in the CLI"><figcaption><p>Example of using the Gemini install command in your terminal</p></figcaption></figure>
