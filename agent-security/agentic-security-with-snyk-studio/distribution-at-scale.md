...
{% hint style="info" %}
This guide covers distributing Snyk Studio on its own. To deploy Snyk Studio alongside other Agentic Development Security (ADS) products at scale, contact your Snyk account team for the combined deployment documentation.
{% endhint %}
...
Snyk recommends using one of the following AI development environments (ADEs) because they support the preferred hooks-based approach:
...
You need to keep the Snyk CLI on the latest version using MDM, which depends on your [chosen installation method](https://docs.snyk.io/developer-tools/snyk-cli/install-the-snyk-cli).
...
* If you are deploying alongside Cursor, Windsurf, Antigravity, VS Code, Gemini CLI, or Claude CLI, [install a specific CLI version](https://docs.snyk.io/developer-tools/snyk-cli/install-the-snyk-cli) and run `snyk mcp config --tool=[ade_name]` where `[ade_name]` is one of the following:
  * `cursor`
  * `windsurf`
  * `antigravity`
  * `visual studio code`
...
*   This guide does not cover fine-grained controls for deploying alongside other coding assistants.
    ...
    1. [Install a specific CLI version](https://docs.snyk.io/developer-tools/snyk-cli/install-the-snyk-cli).
...
<summary><strong>No</strong>, do not enable any directives.</summary>
...
<summary><strong>Yes</strong>, allow developers to modify directive settings.</summary>

* To modify directives on developer machines, update your MDM playbook to:
  * Overwrite directive files using the helper file timestamp. The script can check whether a developer already has directives deployed, making no changes to the directive file contents.
...
<summary><strong>No</strong>, do not allow developers to modify directive settings.</summary>
...
* The company uses Jamf as an MDM tool.
* Yes, auto-update Snyk CLI/MCP versions.
...
3.  Configure the script with the following attributes:
    ...
    <figure><img src="https://2912686697-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FN5N885PkllOWeBmgm3Bp%2Fuploads%2FMcypzw5ZBgzNVp8GtdNl%2F2026-01-21_16-14-45.png?alt=media&#x26;token=3bccacfb-a3de-4c3b-8054-723078140bd7" alt="Script attributes configuration in Jamf"><figcaption><p>Script attributes configuration in Jamf</p></figcaption></figure>
...
4. Navigate to the **Options** > **Scripts**:
   1.  Click **Configure**.
       ...
       <figure><img src="https://2912686697-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FN5N885PkllOWeBmgm3Bp%2Fuploads%2F2PDfLfpjMylAob2fIt14%2F2026-01-21_16-21-18.png?alt=media&#x26;token=cf61bebd-4b21-4c8d-bc66-12e5f91aeb55" alt="Configure the Snyk Studio Deployment script"><figcaption><p>Configure the Snyk Studio Deployment script</p></figcaption></figure>
...
6. Click **Save**.
7. To make the policy available, navigate to the **Self Service** tab:

<figure><img src="https://2912686697-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FN5N885PkllOWeBmgm3Bp%2Fuploads%2Fw1BT0XyKnoIIYeE6hGPX%2F2026-01-21_20-17-39.png?alt=media&#x26;token=ff3b6278-9d15-43ec-94f2-ce24bda0083c" alt="Optional Self Service setting in Jamf"><figcaption><p>Optional Self Service setting in Jamf</p></figcaption></figure>
...
2. Ask initial users to open Cursor or Windsurf to test functionality:
...
<summary>5. Roll out to all users</summary>
