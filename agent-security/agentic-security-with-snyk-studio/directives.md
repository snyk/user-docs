...
3. Ensure the [Snyk MCP server](getting-started-with-snyk-studio.md#configure-the-snyk-mcp-server) is configured, and you have an authenticated Snyk account.
