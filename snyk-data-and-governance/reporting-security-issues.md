...
Snyk requests that you report vulnerabilities in a Snyk service according to the process explained on this page.
...
If you believe you have found a security vulnerability in any Snyk services, let Snyk know right away. Snyk investigates all legitimate reports and strives to fix the problem quickly. Before reporting, though, review the [Snyk Responsible Disclosure Policy](reporting-security-issues.md#snyk-responsible-disclosure-policy).

Use the [Snyk Vulnerability Disclosure Program on Intigriti](https://app.intigriti.com/company/programs/snyk/snykvdp/detail) to report vulnerabilities affecting Snyk products. Do not contact Snyk employees directly or through other channels about a security report.
...
Snyk investigates vulnerabilities reported in Snyk services and takes necessary action. Snyk asks that when you report a vulnerability in a Snyk service to Snyk, you do the following:
