...
nav_context: classic
description: >-
  How to start using Snyk, including supported browsers, prerequisites, and your
...
* [Safari](https://www.apple.com/safari/) (except for [Opening Fix PR](https://docs.snyk.io/scan-fix-and-prevent/fix/snyk-pull-or-merge-requests))
...
You can add an integration to Snyk manually at any point from the Snyk Web UI. To do this, navigate to **Integrations** > **Source Control**. For more information, see [Integrate with Snyk](https://docs.snyk.io/developer-tools/integrations/integrate-with-snyk).
...
{% hint style="info" %}
For information on when to use an API token and when to use a service account token, available to Enterprise plan users only, visit [Authentication for API](https://docs.snyk.io/developer-tools/snyk-api/authentication-for-api).
{% endhint %}
...
For more information, see [Snyk Essentials](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-essentials).
...
* Open-source libraries: see [Snyk Open Source](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-open-source).
* Application code: see [Snyk Code](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-code).
* Hard-coded secrets, credentials, and API keys: see [Snyk Secrets](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-secrets).
* Container images: see [Snyk Container](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-container/scan-container-images).
* Infrastructure as Code (IaC), Kubernetes, Helm and Terraform configuration files and cloud misconfigurations: see [Snyk IaC](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac).
