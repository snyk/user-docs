...
* Configure the integration and populate all mandatory fields, including the PAT details. For more details, see the [Integrate GitHub using Snyk Essentials](https://docs.snyk.io/developer-tools/integrations/scm-integrations/group-level-integrations/github-for-snyk-essentials#github-integrate-using-snyk-apprisk) page.
...
* Open **Integrations**
* Search and select the GitHub integration
* Configure the integration and populate all mandatory fields, including the PAT details. For more details, see the [GitHub integration settings](https://docs.snyk.io/developer-tools/integrations/scm-integrations/organization-level-integrations/github#github-integration-settings) page.
