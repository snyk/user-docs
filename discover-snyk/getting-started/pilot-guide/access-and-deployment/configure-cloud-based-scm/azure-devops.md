...
<figure><img src="../../../../.gitbook/assets/configure-group-level-integration.png" alt="Configuring the Azure DevOps integration at the Group level"><figcaption></figcaption></figure>

* Search and select the Azure DevOps integration
* Configure the integration and populate all mandatory fields, including the PAT details. For more details, see the [Integrate Azure DevOps using Snyk Essentials](https://docs.snyk.io/developer-tools/integrations/scm-integrations/group-level-integrations/azure-devops-for-snyk-essentials#azure-devops-integrate-using-snyk-apprisk) page.
...
* Open **Integrations**
* Search and select the Azure DevOps integration
* Configure the integration and populate all mandatory fields, including the PAT details. For more details, see the [Azure DevOps integration settings](https://docs.snyk.io/developer-tools/integrations/scm-integrations/organization-level-integrations/azure-repositories-tfs#integrate-using-the-snyk-web-ui) page.

<figure><img src="../../../../.gitbook/assets/configure-organization-level-integration.png" alt="Configuring the Azure DevOps integration at the Organization level"><figcaption></figcaption></figure>
