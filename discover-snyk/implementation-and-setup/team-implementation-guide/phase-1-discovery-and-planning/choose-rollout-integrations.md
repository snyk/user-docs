...
For more details, see [Git repositories (SCMs)](https://docs.snyk.io/developer-tools/integrations/scm-integrations/organization-level-integrations).

{% hint style="info" %}
If you have a non-cloud-facing or your own instance of a Git SCM:

* Consider deploying a [Snyk Broker](https://docs.snyk.io/platform-administration/snyk-broker/snyk-broker) for Snyk to communicate with your repositories, which would also require a Snyk Enterprise Plan.
...
For more details, see [Snyk CI/CD integrations](https://docs.snyk.io/developer-tools/integrations/snyk-ci-cd-integrations).
...
For more details, see [Use Snyk in your IDE](https://docs.snyk.io/developer-tools/integrations/snyk-ide-plugins-and-extensions).
