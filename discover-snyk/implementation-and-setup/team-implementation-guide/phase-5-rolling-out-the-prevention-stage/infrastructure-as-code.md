...
For instructions on how to implement Snyk per IaC type in the Snyk CLI, see [Snyk CLI for IaC](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/scan-and-maintain-projects-using-the-cli/snyk-cli-for-iac).
