...
* **Through the** [**API**](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-apps/tool-snyk-api-import): Use the `sourceOrgId` parameter in the `Create a new organization` endpoint.
