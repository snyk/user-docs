...
The company name you enter here will be used to create the [Tenant](https://docs.snyk.io/platform-administration/snyk-hierarchy/tenant), the top-level instance you'll see in the Snyk Platform. It is a required field and has a 60-character limit.
...
1. **Single Sign-On** - use your company's existing identity management system, see [Single Sign-On (SSO) for authentication to Snyk](https://docs.snyk.io/platform-administration/user-management/single-sign-on-sso-for-authentication-to-snyk) for more details.
2. **Third-party authentication** - Snyk supports a list of third-party identity providers; see [Authentication for third-party tools](https://docs.snyk.io/developer-tools/authentication-for-third-party-tools) for more details. This method is only available for the United States region.
...
* Linking the plan to an existing [Tenant](https://docs.snyk.io/platform-administration/snyk-hierarchy/tenant).\
...
* Starting fresh with a new [Tenant](https://docs.snyk.io/platform-administration/snyk-hierarchy/tenant) linked to your user.\
