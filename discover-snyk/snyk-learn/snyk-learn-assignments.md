...
<div align="left"><figure><img src="../.gitbook/assets/assignments-section-snyk-learn-home-page.png" alt="Assignments section on Snyk Learn home page"><figcaption><p>Assignments section on Snyk Learn home page</p></figcaption></figure></div>

2. Select an Organization.

<figure><img src="../.gitbook/assets/select-organization-assignments-dashboard-page.png" alt="Select an Organization in the Assignments Dashboard page"><figcaption><p>Select an Organization in the Assignments Dashboard page</p></figcaption></figure>

3. Click **Create new assignments**.

<figure><img src="../.gitbook/assets/creating-new-assignments-button-assignments-dashboard-page.png" alt="Creating new assignments button on the Assignments Dashboard page"><figcaption><p>Creating new assignments button on the Assignments Dashboard page</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/select-organization.png" alt="Select an Organization"><figcaption><p>Select an Organization</p></figcaption></figure>

2. Select users

<figure><img src="../.gitbook/assets/select-users-create-assignments.png" alt="Select users to create assignments for"><figcaption><p>Select users to create assignments for</p></figcaption></figure>

3. Select assignment type.

<figure><img src="../.gitbook/assets/select-assignment-type.png" alt="Select the assignment type"><figcaption><p>Select the assignment type</p></figcaption></figure>

4. Select the content to assign.

<figure><img src="../.gitbook/assets/select-content-assign.png" alt="Select content to assign"><figcaption><p>Select content to assign</p></figcaption></figure>

5. Optionally set the assignment due date. This date defines the date by which the assignment needs to be completed.

<figure><img src="../.gitbook/assets/optionally-reset-user-learning-progress.png" alt="Option to reset user learning progress"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/optionally-reset-user-learning-progress-2.png" alt="Optionally reset user learning progress"><figcaption><p>Optionally reset user learning progress</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/send-custom-notification-emails.png" alt="Send custom notification emails"><figcaption><p>Send custom notification emails</p></figcaption></figure>

8. Review the assignment details and click **Submit**.

<figure><img src="../.gitbook/assets/review-submit-assignments.png" alt="Review and submit assignments"><figcaption><p>Review and submit assignments</p></figcaption></figure>
