...
nav_context: classic
description: >-
  How to scan your code with Snyk manually and automatically using the Snyk CLI,
  web UI, API, and PR Checks
---
...
A scan runs when you import a Snyk Project (see [Import a Project to scan and identify issues](../getting-started/#import-a-project-to-scan-and-identify-issues) or click **Retest now** on a Project). Snyk then automatically runs periodic scans on the imported Project to check whether your code is affected by newly disclosed vulnerabilities.
