...
For C/C++, Snyk Code supports the following template engines:
...
* License scanning
* Reports
* Test your app's SBOM and packages using `pkg:generic` or `pkg:conan` PURLs through [SBOM test](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/commands/sbom-test) CLI command.
...
For more information about command-line options, visit [Options for scanning with `snyk test --unmanaged`](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/commands/test#unmanaged) or [`snyk monitor --unmanaged`](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/commands/monitor#unmanaged).
