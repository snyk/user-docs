...
nav_context: classic
description: >-
  Snyk support for C and C++ with Snyk Code and Snyk Open Source, including CLI
...
For an overview of the supported security rules, visit [C/C++ rules](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-code/snyk-code-security-rules/c-c++-rules).
...
* License scanning
* Reports
* Test your app's SBOM and packages using `pkg:generic` or `pkg:conan` PURLs through [SBOM test](https://docs.snyk.io/developer-tools/snyk-cli/snyk-cli/commands/sbom-test) CLI command.
...
To check compliance for open source licenses, visit [Snyk License Compliance Management.](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-open-source/scan-open-source-libraries-and-licenses/snyk-license-compliance-management)
...
To explore C/C++ vulnerabilities, you can search the [Snyk Vulnerability Database](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-open-source/manage-vulnerabilities/snyk-vulnerability-database). Snyk tests your code against this database. Snyk updates the database periodically with the latest source code from online sources.
...
For more information about command-line options, visit [Options for scanning with `snyk test --unmanaged`](https://docs.snyk.io/developer-tools/snyk-cli/snyk-cli/commands/test#unmanaged) or [`snyk monitor --unmanaged`](https://docs.snyk.io/developer-tools/snyk-cli/snyk-cli/commands/monitor#unmanaged).
...
For C++, if you know the open-source packages and versions included in the application but lack the source code, use the [List issues for a package](https://docs.snyk.io/developer-tools/snyk-api/reference/issues#orgs-org_id-packages-purl-issues) endpoint to analyze the application.
