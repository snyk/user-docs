...
* License scanning
* Reports
* Test your app's SBOM and packages using `pkg:npm` PURLs, using [SBOM test](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/commands/sbom-test) command.
...
For all Snyk plans, where a production integration does not exist, use the [`snyk monitor`](https://app.gitbook.com/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/commands/monitor) CLI command to take a snapshot and monitor what is being pushed to production.
