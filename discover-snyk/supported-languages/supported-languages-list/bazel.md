...
2. Send the Dep Graph JSON object as a POST request to the Test Dep Graph endpoint, along with your [auth token](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/IEEjSXQQu36y0vmFV8zf/snyk-api/authentication-for-api), as part of a Bazel test rule.
