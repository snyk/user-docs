...
* From September 14, 2026, Snyk detects secrets in files committed to the repository even when a `.gitignore` rule matches them. Visit [Snyk Code](https://docs.snyk.io/scan-with-snyk/snyk-code) for more details.
