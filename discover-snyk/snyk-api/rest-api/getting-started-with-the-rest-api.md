...
You need `curl` and access to a Snyk Organization that has Projects.
...
4. Navigate to your personal [General Account Settings](https://app.snyk.io/account/) and copy your **API Token**. For instructions, see [Authentication for API](https://docs.snyk.io/developer-tools/snyk-api/authentication-for-api).
