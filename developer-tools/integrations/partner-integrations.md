...
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Akamai](https://snyk.io/blog/snyk-akamai-integration-api-discovery-testing/)                                                 | Integrate Akamai with the Snyk API & Web to discover and scan your APIs. See the [How to scan an Akamai connection for Asset Discovery](https://app.gitbook.com/s/BJO0IZx7zB6bOkotxQP2/scan-with-snyk/snyk-api-web/discover-new-targets/scan-akamai-connection-asset-discovery) page for more details. |
...
| Integration                                                                                                                                       | Description                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Cline](https://app.gitbook.com/s/N5N885PkllOWeBmgm3Bp/agentic-security-with-snyk-studio/quickstart-guides/cline-guide)                           | Snyk Studio integrates with the Cline AI coding agent to perform security scanning and enforce "Secure at Inception" rules on code, dependencies, and configurations, enabling automated vulnerability identification and fixing during the agentic development workflow. |
| [Continue](https://www.continue.dev/)                                                                                                             | Scans custom AI code assistants for vulnerabilities with Snyk using MCP.                                                                                                                                                                                                  |
| [Cursor](https://app.gitbook.com/s/N5N885PkllOWeBmgm3Bp/agentic-security-with-snyk-studio/quickstart-guides/cursor-guide)                         | Add the Snyk MCP server to Cursor to secure code generated with agentic workflows through an LLM.                                                                                                                                                                         |
| [Devin](https://app.gitbook.com/s/N5N885PkllOWeBmgm3Bp/agentic-security-with-snyk-studio/quickstart-guides/devin-guide)                           | Secure LLM-generated code in Devin using Snyk Studio (including Snyk's MCP server). Authentication will be requested upon first use.                                                                                                                                      |
| [Factory](https://app.gitbook.com/s/N5N885PkllOWeBmgm3Bp/agentic-security-with-snyk-studio/quickstart-guides/factory-guide)                       | Secure LLM-generated code from agentic workflows using Snyk Studio and the MCP server within Factory. Authentication required on first use.                                                                                                                               |
| [Factory Terminal](https://app.gitbook.com/s/N5N885PkllOWeBmgm3Bp/agentic-security-with-snyk-studio/quickstart-guides/factory-terminal-ide-guide) | Secure LLM-generated code (via agentic workflows) using Snyk Studio (with MCP server) in Factory Terminal/IDE. Install Snyk Studio directly.                                                                                                                              |
...
| [Docker Hub](../snyk-ci-cd-integrations/github-actions-for-snyk-setup-and-checking-for-vulnerabilities/snyk-docker-action.md) | Snyk integrates with Docker Hub to enable you to import snapshots of your projects to our UI and then test and monitor image layers.                                                                                                                                                                                                                                    |
| [Pulumi](https://www.pulumi.com/docs/iac/using-pulumi/crossguard/snyk-policy/)                                                | Pulumi, an open-source tool that allows developers to build code in multiple languages like JavaScript, TypeScript, Python, and Go, to create all that is required to configure the [Kubernetes integration in Snyk Container](https://app.gitbook.com/s/BJO0IZx7zB6bOkotxQP2/scan-with-snyk/snyk-container/kubernetes-integration/overview-of-kubernetes-integration). |
...
| Integration                                                                                          | Description                                                                                                                                                                                |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Bitbucket Cloud App](../scm-integrations/organization-level-integrations/bitbucket-cloud-app.md)    | Find, prioritize and fix security vulnerabilities in your code for free without leaving Bitbucket Cloud.                                                                                   |
| [Bitbucket Pipelines](../snyk-ci-cd-integrations/bitbucket-pipelines-integration-using-a-snyk-pipe/) | <p>Fix quickly and early with actionable remediation<br>Scan builds with Bitbucket Pipelines<br>Fix quickly to reduce exposure</p>                                                         |
| [CircleCI](../snyk-ci-cd-integrations/circleci-integration-using-a-snyk-orb.md)                      | CircleCI enables users to easily create CI/CD workflows using a group of ready-to-use commands (Orbs) that can be added to your configuration file.                                        |
...
| Integration                                                             | Description                                                                                                                       |
| ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| [Bright](https://docs.brightsec.com/docs/integrations-snyk)             | Validates SAST issues, reducing false positives and improving the reliability of vulnerability assessments.                       |
...
| Integration                                                                                                   | Description                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Hashicorp (Terraform)](../snyk-ci-cd-integrations/terraform-cloud-integration-for-snyk-iac-using-run-tasks/) | The Snyk integration with HashiCorp’s Terraform Cloud allows users to find and fix security misconfigurations in their cloud infrastructure as part of their SDLC before they reach production. |
