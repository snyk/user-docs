...
You can use a common [`.snyk` policy file](https://docs.snyk.io/scan-fix-and-prevent/prevent/policies/the-.snyk-file) if you maintain ignores and patches in one place to be applied for all detected workspaces by providing the policy path as follows:
