...
**More information**: [Retrieve audit logs of user-initiated activity by API for an Org or Group](https://docs.snyk.io/platform-administration/user-management/user-management-with-the-api/retrieve-audit-logs-of-user-initiated-activity-by-api-for-an-org-or-group);\
...
[Snyk IaC](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac) (Use: View an inventory of IaC and cloud resources generated from your IaC files)
...
**More information:** [Project collections groupings](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects/project-collections-groupings)
...
**More information:** [Use Custom Base Image Recommendations](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-container/use-snyk-container/use-custom-base-image-recommendations)

### [Create a Custom Base Image from an existing container project](../reference/custom-base-images.md#custom_base_images)

**More information:** [Use Custom Base Image Recommendations](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-container/use-snyk-container/use-custom-base-image-recommendations), section [Mark the created Project as a custom base image](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-container/use-snyk-container/use-custom-base-image-recommendations#mark-the-created-project-as-a-custom-base-image);\
[Versioning schema for custom base images](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-container/use-snyk-container/use-custom-base-image-recommendations/versioning-schema-for-custom-base-images)
...
**More information**: [Project tags](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects/project-tags)
...
**More information:** [Update member roles using the API](https://docs.snyk.io/platform-administration/user-management/user-management-with-the-api/update-member-roles-using-the-api);\
[Manage service accounts using the Snyk API](https://docs.snyk.io/platform-administration/service-accounts/manage-service-accounts-using-the-snyk-api)
...
**More information:** [Remove members from Groups and Orgs using the API](https://docs.snyk.io/platform-administration/user-management/user-management-with-the-api/remove-members-from-groups-and-orgs-using-the-api);\
...
**More information:** [Use a remote IaC custom rules bundle](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac/current-iac-custom-rules/use-iac-custom-rules-with-cli/use-a-remote-iac-custom-rules-bundle)
...
**More information:** [Use a remote IaC custom rules bundle](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac/current-iac-custom-rules/use-iac-custom-rules-with-cli/use-a-remote-iac-custom-rules-bundle), [IaC custom rules within a pipeline](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac/current-iac-custom-rules/iac-custom-rules-within-a-pipeline);[Use a remote IaC custom rules bundle](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac/current-iac-custom-rules/use-iac-custom-rules-with-cli/use-a-remote-iac-custom-rules-bundle)
...
For information on when and how you can use Import targets, see [Gain visibility by importing repositories](https://docs.snyk.io/implementation-guides/enterprise-implementation-guide/phase-3-gain-visibility) in the Enterprise implementation guide.
...
**More information:** [Obtain the required tokens for setup](https://docs.snyk.io/platform-administration/snyk-broker/classic-broker/prepare-snyk-broker-for-deployment/obtain-the-tokens-required-to-set-up-snyk-broker);\
...
**More information:** [Prepare Snyk Broker for deployment](https://docs.snyk.io/platform-administration/snyk-broker/classic-broker/prepare-snyk-broker-for-deployment);\
[Obtain the required tokens for setup](https://docs.snyk.io/platform-administration/snyk-broker/classic-broker/prepare-snyk-broker-for-deployment/obtain-the-tokens-required-to-set-up-snyk-broker);\
...
[Guidance for Snyk for C++ page, Alternate testing options section](https://docs.snyk.io/supported-languages/supported-languages-list/c-c++#cli-options);\
...
Additional information: [Reachability](https://docs.snyk.io/scan-fix-and-prevent/fix/prioritize-issues-for-fixing/reachability-analysis)
...
**More information:** [Dep Graph API (Bazel)](https://docs.snyk.io/supported-languages/supported-languages-list/bazel#dep-graph-api)
...
**More information:** [Provision users to Organizations using the AP](https://docs.snyk.io/platform-administration/user-management/user-management-with-the-api/provision-users-to-organizations-using-the-api):\
...
**More information:** [Provision users to Organizations using the API](https://docs.snyk.io/platform-administration/user-management/user-management-with-the-api/provision-users-to-organizations-using-the-api)
...
**More information:** [User role management](https://docs.snyk.io/platform-administration/user-management/user-role-management)

### [Remove a member from the organization](../reference/organizations-v1.md#org-orgid-members-userid-1)

**More information:** [Remove members from Groups and Orgs using the API](https://docs.snyk.io/platform-administration/user-management/user-management-with-the-api/remove-members-from-groups-and-orgs-using-the-api);\
[User role management](https://docs.snyk.io/platform-administration/user-management/user-role-management)

### [Update a member's role in the organization](../reference/organizations-v1.md#org-orgid-members-update-userid)

**More information:** [User role management](https://docs.snyk.io/platform-administration/user-management/user-role-management); [Update member roles using the API](https://docs.snyk.io/platform-administration/user-management/user-management-with-the-api/update-member-roles-using-the-api)
...
**More information:** [Project attributes](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects/project-attributes)
...
[Snyk Projects](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects);\
[Project information](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects/project-information);\
[Project attributes](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects/project-attributes);\
[Scenario: Find all Projects affected by a vulnerability](scenarios-for-using-the-snyk-api.md#find-all-projects-affected-by-a-vulnerability);\
...
**More information:** [View and edit Project settings](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects/view-and-edit-project-settings);\
[Start scanning](https://docs.snyk.io/getting-started-guides/start-scanning) (Use: Set test frequency)
...
**More information:** [Create and manage a custom PR template using the API](https://docs.snyk.io/scan-fix-and-prevent/fix/snyk-pull-or-merge-requests/customize-pr-templates/apply-a-custom-pr-template#create-and-manage-a-custom-pr-template-using-the-api)
...
**More information:** [Dependencies and licenses](https://docs.snyk.io/scan-fix-and-prevent/prevent/dependencies-and-licenses)
...
To get a list of issues that have been fixed, use the endpoint [Get list of latest issues](../reference/reporting-api-v1.md#reporting-issues-latest) and filter by `“isFixed”: true` in the request body. This endpoint also provides a [list of all IaC issues](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac/view-snyk-iac-issue-reports#api-access-to-iac-issues).

**More information:** [Priority score](https://docs.snyk.io/scan-fix-and-prevent/fix/prioritize-issues-for-fixing/priority-score);\
[View Snyk IaC issue reports](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac/view-snyk-iac-issue-reports);\
[Scenario: Retrieve a Project snapshot for every Project in a given Group](scenarios-for-using-the-snyk-api.md#retrieve-a-project-snapshot-for-every-project-in-a-given-group);\
...
**More information:** [Rust](https://docs.snyk.io/supported-languages/supported-languages-list/rust); [SBOM test endpoints](../using-specific-snyk-apis/sbom-apis/rest-api-endpoint-test-an-sbom-document-for-vulnerabilities.md)
...
**More information:** [Enable Snyk Code](https://docs.snyk.io/implementation-guides/enterprise-implementation-guide/create-a-template-organization/connect-your-development-tools#enable-snyk-code)

### [Retrieves the SAST settings for an org](../reference/sastsettings.md#orgs-org_id-settings-sast-1)

## ServiceAccounts

**More information:** [Manage service accounts using the Snyk API](https://docs.snyk.io/platform-administration/service-accounts/manage-service-accounts-using-the-snyk-api); [Choose a service account type to use with Snyk APIs](https://docs.snyk.io/platform-administration/service-accounts/choose-a-service-account-type-to-use-with-snyk-apis)

### [Create a service account for an organization](../reference/serviceaccounts.md#orgs-org_id-service_accounts)

**More information:** [Service accounts using OAuth 2.0](https://docs.snyk.io/platform-administration/service-accounts/service-accounts-using-oauth-2.0);\
[Manage service accounts using the Snyk API](https://docs.snyk.io/platform-administration/service-accounts/manage-service-accounts-using-the-snyk-api)

### [Get a list of organization service accounts](../reference/serviceaccounts.md#orgs-org_id-service_accounts-1)

**More information:** [Manage service accounts using the Snyk API](https://docs.snyk.io/platform-administration/service-accounts/manage-service-accounts-using-the-snyk-api)
...
**More information:** [Target definition on the Snyk Projects page](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects#target);\
...
[Start scanning](https://docs.snyk.io/getting-started-guides/start-scanning);\
[Scan open-source libraries and licenses](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-open-source/scan-open-source-libraries-and-licenses)
...
**More information:** [Dep Graph API](https://docs.snyk.io/supported-languages/supported-languages-list/bazel#dep-graph-api) (Bazel);\
