...
1. Log in to the Snyk Web UI and retrieve your Organization ID (UUID format), Project ID (UUID), and API key.\
   If you need help in finding these values, see [Organization general settings](https://docs.snyk.io/platform-administration/snyk-hierarchy/organizations/organization-general-settings), [View and edit Project settings](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects/view-and-edit-project-settings), and [Authentication for API](../../authentication-for-api/).
