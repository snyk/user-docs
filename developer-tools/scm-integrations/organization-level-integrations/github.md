...
* Internet-accessible repositories.\
  If your repositories are not internet-accessible, you must use [Snyk Broker](https://docs.snyk.io/platform-administration/snyk-broker/snyk-broker).
...
You cannot use the GitHub integration with a Snyk [Service Account](https://docs.snyk.io/platform-administration/service-accounts/service-accounts), as the GitHub integration is associated with your user account, not with the Snyk Organization.
...
To connect your GitHub repositories to Snyk for scanning, you need to set up the integration and then import Projects. For details, see [Getting started](https://docs.snyk.io/getting-started-guides/getting-started).
...
* Pull requests:
  * [Opening fix and upgrade pull requests from a fixed GitHub account](https://docs.snyk.io/scan-fix-and-prevent/fix/snyk-pull-or-merge-requests/opening-fix-and-upgrade-pull-requests-from-a-fixed-github-account)
  * [Automatic fix PRs](github.md#project-monitoring-and-automatic-fix-pull-requests)
  * [Automatic dependency upgrade PRs](https://docs.snyk.io/scan-fix-and-prevent/fix/snyk-pull-or-merge-requests/enable-automatic-upgrade-prs-for-new-dependency-upgrades)
  * [Pull request assignees](github.md#pr-assignment)
  * [Snyk vulnerability patches](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-open-source/manage-vulnerabilities/snyk-patches-to-fix-vulnerabilities)
* Pull request status checks ([PR Checks](https://docs.snyk.io/scan-fix-and-prevent/prevent/pull-request-checks))
  * [Open Source security and licenses](https://docs.snyk.io/scan-fix-and-prevent/prevent/pull-request-checks/configure-pull-request-checks#configure-pr-checks-at-the-integration-level)
  * [Code analysis](https://docs.snyk.io/scan-fix-and-prevent/prevent/pull-request-checks/configure-pull-request-checks#configure-pr-checks-at-the-integration-level)
* Dockerfiles
  * [Scan your Dockerfile](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-container/scan-your-dockerfile)
  * [Fix vulnerable base images in your Dockerfile](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-container/scan-your-dockerfile/fix-vulnerable-base-images-in-your-dockerfile)
...
Scroll down to the **Automatic fix PRs** section and set the options. For definitions, see [Configure automatic fix PRs at the integration level](https://docs.snyk.io/scan-fix-and-prevent/fix/snyk-pull-or-merge-requests/enable-automatic-backlog-prs-for-previously-known-vulnerabilities#configure-automatic-fix-prs-at-the-integration-level).
...
For availability with Snyk Broker, see the [Commit signing](https://docs.snyk.io/platform-administration/snyk-broker/snyk-broker-commit-signing) page in the Broker docs.
{% endhint %}
...
{% hint style="info" %}
A Snyk Organization administrator can [designate a specific GitHub account to use for opening fix and upgrade PRs](https://docs.snyk.io/scan-fix-and-prevent/fix/snyk-pull-or-merge-requests/opening-fix-and-upgrade-pull-requests-from-a-fixed-github-account).
...
You can designate a specific GitHub account to open fix and upgrade pull requests, and enable the [Pull Request Experience](https://docs.snyk.io/scan-fix-and-prevent/prevent/pull-request-checks/pull-request-experience).
...
<figure><img src="../../.gitbook/assets/pat_config.png" alt="Set an account to open Snyk PRs and to enable the Pull Request Experience"><figcaption><p>Set an account to open Snyk PRs and to enable the Pull Request Experience</p></figcaption></figure>
