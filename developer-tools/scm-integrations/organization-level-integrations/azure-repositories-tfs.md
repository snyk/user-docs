...
* [Snyk Organization Admin](https://docs.snyk.io/platform-administration/user-management/pre-defined-roles) user role.
...
{% hint style="info" %}
The Azure Repository integration works like the other [Snyk SCM integrations](./). To continue to monitor, fix, and manage your Projects, see the [Projects](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects) documentation.
{% endhint %}
