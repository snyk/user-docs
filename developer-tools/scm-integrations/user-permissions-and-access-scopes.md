...
| <p><strong>Snyk Group Level Integrations:</strong><br>Required for Inventory and <a href="https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-essentials">Essentials</a></p> |                               <p><code>read:repository:bitbucket</code></p><p><code>read:user:bitbucket</code><br><code>read:workspace:bitbucket</code></p>                              |
...
* A [Snyk Organization Admin](https://docs.snyk.io/platform-administration/user-management/pre-defined-roles).
