...
You can use the [CLI](../../overview.md) `snyk iac test` command to address known configuration issues.
...
{% hint style="info" %}
Using [Custom rules](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac/current-iac-custom-rules) and the Share Results functionality together is not currently supported.
