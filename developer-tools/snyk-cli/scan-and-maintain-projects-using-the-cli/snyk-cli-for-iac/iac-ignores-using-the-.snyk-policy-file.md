...
The `.snyk` file has some limitations for IaC Projects. See [The `.snyk` file](https://app.gitbook.com/s/BJO0IZx7zB6bOkotxQP2/prevent/policies/the-.snyk-file) for standard functionality.
