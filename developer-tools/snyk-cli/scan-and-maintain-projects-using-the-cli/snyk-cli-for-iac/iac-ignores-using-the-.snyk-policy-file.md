...
The `.snyk` file has some limitations for IaC Projects. See [The `.snyk` file](https://docs.snyk.io/scan-fix-and-prevent/prevent/policies/the-.snyk-file) for standard functionality.
