...
The `.snyk` file has some limitations for IaC Projects. See [The `.snyk` file](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/BJO0IZx7zB6bOkotxQP2/manage-risk/policies/the-.snyk-file) for standard functionality.
