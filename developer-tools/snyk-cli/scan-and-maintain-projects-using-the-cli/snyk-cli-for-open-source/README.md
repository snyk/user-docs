...
* The method of scanning, using the [Snyk CLI](../../overview.md), or importing a Project using a [Git repository integration](../../../scm-integrations/organization-level-integrations/)
