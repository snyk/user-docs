...
* The issue type
* The [severity rating](https://docs.snyk.io/scan-fix-and-prevent/fix/prioritize-issues-for-fixing/severity-levels) for the issue
...
License issues are determined by the [license policy](https://docs.snyk.io/scan-fix-and-prevent/prevent/policies/license-policies) of your Snyk Organization. License issues contain the following information:
...
* **Local Snyk Policy**: Information about whether this scan was performed on an Open Source Project. For more information, see [The .snyk file](https://docs.snyk.io/scan-fix-and-prevent/prevent/policies/the-.snyk-file).
