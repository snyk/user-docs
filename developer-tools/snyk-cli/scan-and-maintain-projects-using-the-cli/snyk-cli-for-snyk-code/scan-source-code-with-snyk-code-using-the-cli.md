...
* Manually creating a `.snyk` file in the tested folder. See [Excluding directories and files from the import process](https://app.gitbook.com/s/BJO0IZx7zB6bOkotxQP2/scan-with-snyk/snyk-projects/import-project-repository/exclude-directories-and-files-from-project-import).
...
<figure><img src="../../../.gitbook/assets/snyk-code-test-results-report-option.png" alt="Snyk code test results with --report option"><figcaption><p>Snyk code test results with --report option</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/code-analysis-projects-grouped-branch.png" alt="Code analysis Projects grouped by branch"><figcaption><p>Code analysis Projects grouped by branch</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/ignoring-issues-web-ui.png" alt="Ignoring issues in the Web UI"><figcaption><p>Ignoring issues in the Web UI</p></figcaption></figure>
