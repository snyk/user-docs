...
You can [change your **Preferred Organization**](https://docs.snyk.io/platform-administration/snyk-hierarchy/organizations/create-and-delete-organizations) or set another Organization for the CLI tests via the CLI.
