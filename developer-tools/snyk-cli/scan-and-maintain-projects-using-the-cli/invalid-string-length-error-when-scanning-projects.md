...
* If you require the JSON output, try increasing the severity threshold using the `--severity-threshold=<SEVERITY_LEVEL>` option. This reduces the number of less critical vulnerabilities reported and reduces the size of the JSON file output.
