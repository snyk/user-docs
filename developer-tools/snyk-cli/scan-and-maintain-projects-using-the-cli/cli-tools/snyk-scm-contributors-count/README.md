...
1. Export the [Snyk API token](https://docs.snyk.io/getting-started-guides/getting-started#obtain-and-use-your-snyk-api-token). You can find the token in the Snyk Web UI under the account **Settings**.
