...
<figure><img src="../../.gitbook/assets/choose-reference-branch-folder.png" alt="Choose the reference branch or folder"><figcaption><p>Choose the reference branch or folder</p></figcaption></figure>
