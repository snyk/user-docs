...
<figure><img src="../../.gitbook/assets/starting-workspace-scan.png" alt="Starting workspace scan"><figcaption><p>Starting workspace scan</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/eclipse-problems-tab.png" alt="Eclipse Problems tab"><figcaption><p>Eclipse Problems tab</p></figcaption></figure>

In addition, starting with version 3+, Snyk provides a custom UI in the Snyk Tab, that displays issue details:

<figure><img src="../../.gitbook/assets/issue-details-eclipse-plugin.png" alt="Issue details in Eclipse plugin"><figcaption><p>Issue details in Eclipse plugin</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/severity-filters-view-menu.png" alt="Severity filters in the View menu"><figcaption><p>Severity filters in the View menu</p></figcaption></figure>

## Issue View Options

[Code Consistent Ignores](https://docs.snyk.io/scan-fix-and-prevent/fix/prioritize-issues-for-fixing/ignore-issues/consistent-ignores-for-snyk-code) filters issues to help teams focus on critical tasks. After you create an ignore, Snyk applies it to all tests and branches.

{% hint style="info" %}
These filters do not apply if you disable **Code Consistent Ignores** for the Organization.
{% endhint %}

<figure><img src="../../.gitbook/assets/issue-view-options-alongside-net-new-filter-view-menu.png" alt="Issue View Options alongside the Net New filter in the View menu"><figcaption><p>Issue View Options alongside the Net New filter in the View menu</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/net-new-issues-filter-enabled-after-clicking-total-new.png" alt="Net new issues filter enabled after clicking on the total/new issues toggle"><figcaption><p>Net new issues filter enabled after clicking on the total/new issues toggle</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/activate-net-new-issues-dot-menu-snyk-view.png" alt="Activate Net new issues in the dot menu of the Snyk View"><figcaption><p>Activate Net new issues in the dot menu of the Snyk View</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/new-issues-introduced-newly-created-branch.png" alt="No new issues introduced in a newly created branch"><figcaption><p>No new issues introduced in a newly created branch</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/changing-reference-branch-reference-directory-calculation.png" alt="Changing reference branch or reference directory for calculation net new issues"><figcaption><p>Changing reference branch or reference directory for calculation net new issues</p></figcaption></figure>
