...
{% hint style="warning" %}
Before authenticating, ensure you have set your region properly. For details, see [IDEs URLs](https://app.gitbook.com/s/ELvljsaLKPkSpffOkmsQ/regional-hosting-and-data-residency#ides-urls).
{% endhint %}
...
1.  After the extension is installed, click the **Snyk Icon** in the navigation bar, then click **Connect & Trust Workspace**:
    ...
    <figure><img src="../../.gitbook/assets/SCR-20240821-qmuv.png" alt="Connect and trust workspace" width="359"><figcaption><p>Connect and trust workspace</p></figcaption></figure>
...
1.  Click the **Snyk Icon** in the navigation bar, then click the **Settings** icon, find **Authentication Method**, and change it to **Personal Access Token**.
    ...
    <figure><img src="../../.gitbook/assets/image (329).png" alt="Authenticating the Visual Studio Code extension with a Personal Access Token"><figcaption></figcaption></figure>
...
3.  Run the `Snyk: Set Token` command and paste the token in the text field.
    ...
    <figure><img src="../../.gitbook/assets/image (324).png" alt="Personal Access Token entered in the extension settings"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/SCR-20240821-tarb.png" alt="Change authentication method"><figcaption><p>Change authentication method</p></figcaption></figure>

2. Press **Connect & Trust Workspace**.
3.  Click **Authenticate** in the web browser window that opens.

    <figure><img src="../../.gitbook/assets/steps-authenticate-using-snyk-api-token.png" alt="Authenticating the Visual Studio Code extension with a Snyk API token"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/set-token-manually.png" alt="Set token manually"><figcaption><p>Set token manually</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/logging-out-command.png" alt="Snyk: Log out"><figcaption><p>Snyk: Log out</p></figcaption></figure>
