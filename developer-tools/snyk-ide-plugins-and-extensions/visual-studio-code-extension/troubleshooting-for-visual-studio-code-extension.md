...
<figure><img src="../../.gitbook/assets/logs-use-obtain-more-information.png" alt="Logs to use to obtain more information" width="375"><figcaption><p>Logs to use to obtain more information</p></figcaption></figure>
