...
* **Additional parameters**: Set additional `snyk test` [CLI options](../../snyk-cli/cli-commands-and-options-summary.md) for Open Source scanning. For **unmanaged** [**C/C++**](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/L7HyJj9FsK1W4pNt8Gzl/supported-languages/supported-languages-list/c-c++) **scanning**, use the CLI option `--unmanaged` to find vulnerabilities in open-source packages. This option works only for unmanaged C/C++ scanning. Additional parameters do not apply to Snyk Code or IaC.
