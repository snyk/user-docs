...
* You can now add the Snyk MCP server to [Goose CLI](integrations/developer-guardrails-for-agentic-workflows/quickstart-guides-for-mcp/goose-cli-guide.md) to secure code generated with agentic workflows through an LLM.&#x20;
