...
Provisioning is enabled for these [three regions](../working-with-snyk/regional-hosting-and-data-residency.md#available-snyk-regions). Each of these regions is running at least one instance of the Snyk Platform:
