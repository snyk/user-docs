...
To understand more about roles and permissions within Snyk, see [Managing permissions](../../../snyk-admin/manage-permissions-and-roles/managing-permissions.md).

See also [Member Roles](../../../snyk-admin/manage-permissions-and-roles/member-roles.md) and [Roles in Custom SSO](../../../snyk-admin/manage-permissions-and-roles/member-roles.md#roles-in-custom-sso).
...
* **role**:
  ...
  * Custom Role can also be used for **{role}** and should use the normalized name. See [Roles in SSO](../../../snyk-admin/manage-permissions-and-roles/member-roles.md#roles-in-custom-sso) for more details.
