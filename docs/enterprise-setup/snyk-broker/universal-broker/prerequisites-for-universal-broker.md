...
* Network access that is allowed by any firewalls installed on your network: outbound TLS (443) to `https://broker.snyk.io` and `https://api.snyk.io` or your [regional Broker URL](../../../snyk-data-and-governance/regional-hosting-and-data-residency.md#broker-server-urls).
* A Snyk account and your personal Snyk API token; you cannot use a service account.
  * See [Obtain and use your Snyk API token](../../../discover-snyk/getting-started/#obtain-and-use-your-snyk-api-token) for instructions on finding your SNYK\_TOKEN.
...
* Docker installed and configured to pull images from Docker Hub in order to install with Docker.
