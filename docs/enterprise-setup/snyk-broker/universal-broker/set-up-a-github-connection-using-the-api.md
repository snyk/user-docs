...
This returns DEPLOYMENT\_ID (data.id), for example:
...
You can create a maximum of ten credentials in one call by dding more objects in attributes. These objects can be of different types.
