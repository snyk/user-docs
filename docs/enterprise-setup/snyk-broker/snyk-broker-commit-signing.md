...
{% hint style="info" %}
Snyk Broker commit signing is in [Closed Beta](../../more-info/snyk-feature-release-process.md#closed-beta) and is available only by invitation from Snyk. For more information, contact your Snyk team.
{% endhint %}
