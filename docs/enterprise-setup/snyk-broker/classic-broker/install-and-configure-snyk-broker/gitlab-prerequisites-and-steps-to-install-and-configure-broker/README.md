...
Ensure that the GitLab permissions are correct for integration with Snyk. For details, see [Snyk GitLab integration](../../../../../scm-integrations/snyk-scm-integrations/gitlab.md).
