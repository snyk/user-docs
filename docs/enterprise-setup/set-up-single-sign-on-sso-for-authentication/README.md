...
<figure><img src="../../.gitbook/assets/image (2) (4).png" alt="Use SSO for Snyk"><figcaption><p>Use SSO for Snyk</p></figcaption></figure>
...
2. The identity provider communicates this authentication to Snyk servers, sending relevant data to Snyktoo create each user.
