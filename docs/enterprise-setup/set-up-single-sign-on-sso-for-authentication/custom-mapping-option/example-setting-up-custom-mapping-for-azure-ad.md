...
3.  Create an app role with details as needed.\
    ...
    <figure><img src="../../../.gitbook/assets/image (2) (4) (1).png" alt="Create app role with details"><figcaption><p>Create app role with details</p></figcaption></figure>
...
7.  Repeat for all required groups and roles that should be assigned. Then verify that the list looks similar to this.
    ...
    <figure><img src="../../../.gitbook/assets/image (6) (1) (2).png" alt="Users and group list"><figcaption><p>Users and group list</p></figcaption></figure>
