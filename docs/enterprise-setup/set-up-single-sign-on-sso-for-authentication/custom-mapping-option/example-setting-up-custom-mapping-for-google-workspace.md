...
The following shows how to use the [Custom Mapping Option](../../using-single-sign-on-sso-for-authentication/custom-mapping-option/) for custom mapping of roles for a Google Workspace custom SAML connection.
