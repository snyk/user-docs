...
In contrast, while creating an **Organization service account,** you can choose Org level roles, including custom [member roles](../../snyk-admin/manage-permissions-and-roles/manage-user-roles.md) that you have set up for your Organizations.
