...
See the [introduction to Snyk Projects](../snyk-admin/snyk-projects/) for more details. Before you add Projects to Snyk, you wlll define a Project import strategy.
