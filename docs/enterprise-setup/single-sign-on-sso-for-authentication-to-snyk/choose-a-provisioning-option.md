...
You can provision user accounts with customized rules using the [Custom Mapping Option](../../enterprise-configuration/single-sign-on-sso-for-authentication-to-snyk/custom-mapping/).
