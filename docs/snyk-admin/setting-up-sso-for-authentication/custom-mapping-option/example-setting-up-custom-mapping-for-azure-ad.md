...
5.  Configure Attribute: expand the **Claim conditions**.\
    ...
    <figure><img src="../../../.gitbook/assets/Name-Claim-conditions-section (1) (1) (1) (1) (1) (1) (1) (1) (1).png" alt="Enter the Name and expand Claim conditions"><figcaption><p>Enter the Name and expand Claim conditions</p></figcaption></figure>
...
7.  Specify the scoped groups; in the example choose **Select groups**, search for SSO, and **Select** the groups found.\
    ...
    <figure><img src="../../../.gitbook/assets/scoped-groups (1) (1).png" alt="Select the groups found"><figcaption><p>Select the groups found</p></figcaption></figure>
...
1.  In your app registration menu, select the name of your Enterprise Application.
    ...
    <figure><img src="../../../.gitbook/assets/image (59).png" alt="App registration, select name of Enterprise Application"><figcaption><p>App registration, select name of Enterprise Application</p></figcaption></figure>
2.  Select **App roles**, then **Create app role**.

    <figure><img src="../../../.gitbook/assets/image (1) (1) (2).png" alt="Select App roles, Create app role"><figcaption><p>Select App roles, Create app role</p></figcaption></figure>
...
4.  In Azure AD, select your Enterprise Application.
    ...
    <figure><img src="../../../.gitbook/assets/image (3) (2) (1) (1) (1) (1).png" alt="Select Enterprise Application in Azure AD"><figcaption><p>Select Enterprise Application in Azure AD</p></figcaption></figure>
...
7.  Repeat for all required groups and roles that should be assigned. Then verify that the list looks similar to this.
    ...
    <figure><img src="../../../.gitbook/assets/image (6) (1) (1) (2) (1) (1).png" alt="Users and group list"><figcaption><p>Users and group list</p></figcaption></figure>
