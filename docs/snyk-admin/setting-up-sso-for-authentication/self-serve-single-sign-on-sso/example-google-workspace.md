...
1.  Go to **Apps** and then click **Web and mobile apps**.
    ...
    <figure><img src="../../../.gitbook/assets/1 (1) (2) (1) (1) (1).png" alt="Open Web and Mobile apps"><figcaption><p>Open Web and Mobile apps</p></figcaption></figure>
...
5.  Navigate to the Snyk portal, login and from the drop down at the top left select **GROUP OVERVIEW** and then the cog wheel (top right corner) to get to your group settings.
    ...
    <figure><img src="../../../.gitbook/assets/1 (1) (1) (1) (1) (1) (1) (1).png" alt="Open group view in Snyk"><figcaption><p>Open group view in Snyk</p></figcaption></figure>
