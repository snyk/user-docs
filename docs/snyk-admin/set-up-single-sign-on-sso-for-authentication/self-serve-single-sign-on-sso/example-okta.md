...
3.  Navigate to [Okta](https://www.okta.com/se/login/), open the application menu, and click on **Create App Integration.**
    ...
    <figure><img src="../../../.gitbook/assets/1 (4) (1) (1) (1).png" alt="Okta Applications main page"><figcaption><p>Okta Applications main page</p></figcaption></figure>
...
8.  Go back to the previous page and go to the **Assignments** tab. Click on **Assign** and choose users, groups, or both according to your needs.
    ...
    <figure><img src="../../../.gitbook/assets/7 (1) (1) (1) (1).png" alt="Assign the SSO application"><figcaption><p>Assign the SSO application</p></figcaption></figure>
