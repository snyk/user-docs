...
When such additional parameters are required, they are indicated in this section, but when you are setting up a Broker Client for a specific SCM, use also the section that is specific to that SCM. For more information, see [Snyk Broker integration setups](../../../set-up-snyk-broker/snyk-broker-set-up-examples/).
{% endhint %}
...
* [GitHub](../../../set-up-snyk-broker/snyk-broker-set-up-examples/broker-example-set-up-snyk-broker-with-github.md)
* [GitHub Enterprise](../../../set-up-snyk-broker/snyk-broker-set-up-examples/setup-broker-with-github-enterprise.md)
* [Gitlab](../../../set-up-snyk-broker/snyk-broker-set-up-examples/setup-broker-with-gitlab.md)
* [Bitbucket Server/Data Center](../../../set-up-snyk-broker/snyk-broker-set-up-examples/data-center.md)
* [Azure Repos](../../../set-up-snyk-broker/snyk-broker-set-up-examples/setup-broker-with-azure-repos.md)
...
* `-e <SCM_domain>=` is your SCM domain name without http/https, for example, `snyk.git.com`. For each SCM,. Use the following parameter:
  ...
  * **GitHub Enterprise**: `-e GITHUB`\
    For [GitHub Enterprise](../../../set-up-snyk-broker/snyk-broker-set-up-examples/setup-broker-with-github-enterprise.md) also add the following parameters: also\
  ...
  * **Azure Repos**: `-e AZURE_REPOS_HOST`\
    For [Azure Repos](../../../set-up-snyk-broker/snyk-broker-set-up-examples/setup-broker-with-azure-repos.md) add the following paramete alsor:\
    `-e AZURE_REPOS_ORG=<azure_repo_org_name> \`
  * **Bitbucket Server/Data Center**: `-e BITBUCKET`\
    For [Bitbucket Server/Data Center](../../../set-up-snyk-broker/snyk-broker-set-up-examples/data-center.md) add the following parameter also:\
