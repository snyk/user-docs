...
As an alternative to using the Docker run command shown on the [setup page](set-up-snyk-broker-with-artifactory-registry.md), you can build your own Docker image and override relevant environment variables:
...
As an alternative to using the Docker run command shown on the [setup page](set-up-snyk-broker-with-nexus-plugins.md), you can build your own Docker image and override relevant environment variables:
