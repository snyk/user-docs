...
* The Snyk Group to which the Organizations belong should have [Single Sign On (SSO) configured](../../enterprise-configurations/using-single-sign-on-sso-for-authentication/).
