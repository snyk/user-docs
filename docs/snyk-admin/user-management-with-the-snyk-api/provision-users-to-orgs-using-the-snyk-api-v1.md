...
{% hint style="info" %}
Enterprise plan users can define their own customized [member roles](../user-roles-and-permissions/user-role-management.md) and can use `rolePublicId` for assignment.\
\
