...
* Predefined [Project attributes](../introduction-to-snyk-projects/project-attributes.md) and any additional [Project tag](../introduction-to-snyk-projects/project-tags.md) metadata.
