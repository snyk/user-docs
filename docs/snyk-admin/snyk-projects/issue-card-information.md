...
* [Ignore the issue](../../scan-using-snyk/find-and-manage-priority-issues/ignore-issues/): if you do not need to take action on an issue, or it does not need to appear on your reports, you can ignore it.
