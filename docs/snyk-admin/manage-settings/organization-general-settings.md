...
See **Configure Ignore settings** in the [Ignore issues](../../manage-risk/priorities-for-fixing-issues/ignore-issues.md#configure-ignore-settings) documentation for more details.
