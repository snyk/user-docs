...
* **Ignores**: Define Organization-wide ignore settings. You can choose from the following options:
  ...
  * **Require reason for each ignore**
    ...
    * `Not required`
    * See [Configure Ignore settings](../../manage-risk/priorities-for-fixing-issues/ignore-issues.md#configure-ignore-settings) in the Ignore issues documentation for more details.
