...
* **Ignores**: Define Organization-wide ignore settings. You can choose from the following options:
  ...
  * **Require reason for each ignore**
    ...
    * `Not required`
    * See [Configure Ignore settings](../../scan-using-snyk/prioritize-your-issues/ignore-issues/#configure-ignore-settings) in the Ignore issues documentation for more details.
