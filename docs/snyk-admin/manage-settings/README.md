...
* &#x20;**SSO**: See [Self-Serve Single Sign-On (SSO)](../../enterprise-configurations/using-single-sign-on-sso-for-authentication/self-serve-single-sign-on-sso/) for details.
* **Member Roles**: See [Manage Member Roles](../manage-permissions-and-roles/manage-member-roles.md) for details.
* **Service Accounts**: See [Service accounts](../../enterprise-configurations/service-accounts/) for details.
