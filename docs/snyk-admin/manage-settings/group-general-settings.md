...
{% hint style="warning" %}
Changing this setting will not affect the default test frequency of [Snyk Infrastructure as Code](../../scan-cloud-configurations/snyk-infrastructure-as-code/) or [Snyk Code](../../scan-applications/snyk-code/) Projects. The default for both of these is weekly.
{% endhint %}
