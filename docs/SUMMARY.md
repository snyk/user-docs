...
* [Snyk admin](user-and-group-management/README.md)
  ...
  * [Setting up Single Sign-On (SSO) for authentication](user-and-group-management/setting-up-sso-for-authentication/README.md)
    ...
    * [Self Serve Single Sign-On (SSO)](user-and-group-management/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/README.md)
      * [Example: Okta SAML Application](user-and-group-management/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/self-serve-single-sign-on-sso.md)
  ...
  * [Git repository and CI/CD integrations: comparisons](user-and-group-management/git-repository-and-ci-cd-integrations-comparisons/README.md)
    * [Identity Provider (IdP) migration](user-and-group-management/git-repository-and-ci-cd-integrations-comparisons/identity-provider-idp-migration.md)
