...
* [Getting started](getting-started/README.md)
  ...
  * [Running scans](getting-started/running-tests/README.md)
...
* [Scan applications](scan-applications/README.md)
  ...
  * [Snyk Open Source](scan-application-code/snyk-open-source/README.md)
    ...
    * [Start using Snyk Open Source](scan-application-code/snyk-open-source/getting-started-snyk-open-source.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Start using Snyk Code](scan-application-code/snyk-code/getting-started-with-snyk-code/README.md)
    ...
    * [Security rules used by Snyk Code](scan-applications/snyk-code/security-rules-used-by-snyk-code/README.md)
      ...
      * [Scala rules](scan-applications/snyk-code/security-rules-used-by-snyk-code/scala-beta-rules.md)
      * [Swift rules](scan-applications/snyk-code/security-rules-used-by-snyk-code/swift-beta-rules.md)
  ...
  * [Snyk Container](scan-applications/snyk-container/README.md)
    * [Start using Snyk Container](scan-containers/getting-started-with-snyk-container.md)
    ...
    * [Integrate with Kubernetes](scan-applications/snyk-container/integrate-with-kubernetes/README.md)
      * [Overview of the Kubernetes integration](scan-applications/snyk-container/integrate-with-kubernetes/overview-of-the-kubernetes-integration/README.md)
        * [Supported workloads, container registries, languages, and operating systems](scan-applications/snyk-container/integrate-with-kubernetes/overview-of-the-kubernetes-integration/supported-workloads-container-registries-languages-and-operating-systems.md)
        * [Enable the Kubernetes integration](scan-applications/snyk-container/integrate-with-kubernetes/overview-of-the-kubernetes-integration/viewing-your-kubernetes-integration-settings.md)
        * [Disable the Kubernetes integration](scan-applications/snyk-container/integrate-with-kubernetes/overview-of-the-kubernetes-integration/disable-the-kubernetes-integration.md)
        * [How the Snyk Controller handles your data](scan-applications/snyk-container/integrate-with-kubernetes/overview-of-the-kubernetes-integration/how-snyk-controller-handles-your-data.md)
      * [Install the Snyk Controller](scan-applications/snyk-container/integrate-with-kubernetes/use-the-snyk-controller/README.md)
        * [Install the Snyk Controller with Helm (Azure and Google Cloud Platform)](scan-applications/snyk-container/integrate-with-kubernetes/use-the-snyk-controller/install-the-snyk-controller-with-helm-azure-and-google-cloud-platform.md)
        * [Optional installation steps for the Snyk Controller with Helm](scan-applications/snyk-container/integrate-with-kubernetes/use-the-snyk-controller/optional-installation-steps-for-snyk-controller-with-helm.md)
        * [Authenticate to private container registries](scan-applications/snyk-container/integrate-with-kubernetes/use-the-snyk-controller/authenticate-to-private-container-registries.md)
        * [Install the Snyk Controller on Amazon Elastic Kubernetes Service (Amazon EKS)](scan-applications/snyk-container/integrate-with-kubernetes/use-the-snyk-controller/install-the-snyk-controller-on-amazon-elastic-kubernetes-service-amazon-eks.md)
        * [Install the Snyk Controller with OpenShift 4 and OperatorHub](scan-applications/snyk-container/integrate-with-kubernetes/use-the-snyk-controller/install-the-snyk-controller-with-openshift-4-and-operatorhub.md)
      * [Manually import Kubernetes workload projects](scan-applications/snyk-container/integrate-with-kubernetes/manually-import-kubernetes-workload-projects.md)
      * [Automatically import and delete Kubernetes workload projects](scan-applications/snyk-container/integrate-with-kubernetes/automatically-import-and-delete-kubernetes-workload-projects.md)
      * [Integrate with Sysdig](scan-applications/snyk-container/integrate-with-kubernetes/integrate-with-sysdig.md)
      * [Annotated import](scan-applications/snyk-container/integrate-with-kubernetes/annotated-import.md)
      * [Navigate the Kubernetes integration UI](scan-applications/snyk-container/integrate-with-kubernetes/navigate-the-kubernetes-integration-ui/README.md)
        * [View Project details and scan results](scan-applications/snyk-container/integrate-with-kubernetes/navigate-the-kubernetes-integration-ui/view-project-details-and-scan-results.md)
        * [Snyk Priority Score and Kubernetes](scan-applications/snyk-container/integrate-with-kubernetes/navigate-the-kubernetes-integration-ui/snyk-priority-score-and-kubernetes.md)
      * [Kubernetes integration FAQ](scan-applications/snyk-container/integrate-with-kubernetes/kubernetes-integration-faq.md)
...
* [Scan infrastructure](scan-infrastructure/README.md)
  ...
  * [Getting started with current IaC](scan-infrastructure/getting-started-with-snyk-iac/README.md)
  ...
  * [Snyk CLI for IaC](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/README.md)
