...
* [Manage issues](manage-issues/README.md)
  ...
  * [Reports](manage-issues/snyk-reports/README.md)
    * [Reports overview](manage-issues/reports/reports-overview.md)
    * [General actions](manage-issues/reports/general-actions.md)
    * [Summary tab](manage-issues/reports/summary-tab.md)
    * [Issues tab](manage-issues/reports/issues-tab.md)
    * [Dependencies tab](manage-issues/reports/dependencies-tab.md)
    * [Licenses tab](manage-issues/reports/licenses-tab.md)
    * [Next Gen Reporting](manage-issues/reports/next-gen-reporting/README.md)
      ...
      * [Troubleshooting Snyk Reports](manage-issues/reports/next-gen-reporting/troubleshooting-snyk-reports.md)
...
* [Snyk admin](snyk-admin/README.md)
  ...
  * [Snyk Broker](snyk-admin/snyk-broker/README.md)
    ...
    * [Install and configure Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/README.md)
      * [Install and configure Broker using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/README.md)
        * [GitHub - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/broker-example-set-up-snyk-broker-with-github.md)
        * [GitHub - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/github-environment-variables-for-snyk-broker.md)
        * [GitHub Enterprise - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/setup-broker-with-github-enterprise.md)
        * [GitHub Enterprise - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/github-enterprise-environment-variables-for-snyk-broker.md)
        * [Bitbucket Server/Data Center - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/data-center.md)
        * [Bitbucket Server/Data Center - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/bitbucket-server-data-center-environment-variables-for-snyk-broker.md)
        * [GitLab - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/setup-broker-with-gitlab.md)
        * [GitLab - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/gitlab-environment-variables-for-snyk-broker.md)
        * [Azure Repos - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/setup-broker-with-azure-repos.md)
        * [Azure Repos - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/azure-repos-environment-variables-for-snyk-broker.md)
        * [Artifactory Repository - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/set-up-snyk-broker-with-artifactory-repository.md)
        * [Artifactory Repository - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/artifactory-repository-environment-variables-for-snyk-broker.md)
        * [Nexus Repository - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/set-up-snyk-broker-with-nexus-repository-manager.md)
        * [Nexus Repository - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/nexus-repository-environment-variables-for-snyk-broker.md)
        * [Jira - install and configure using Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/setup-broker-with-jira.md)
        * [Jira - environment variables for Snyk Broker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/jira-environment-variables-for-snyk-broker.md)
        * [Derived Docker images for Broker Client integrations and Container Registry Agent](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/derived-docker-images-for-broker-client-integrations-and-container-registry-agent.md)
        * [Advanced configuration for Snyk Broker Docker installation](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/README.md)
          * [Changing the auth method with Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/changing-the-auth-method-with-docker.md)
          * [Credential pooling with Docker and Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/credential-pooling-with-docker-and-helm.md)
          * [HTTPS for Broker Client with Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/https-for-broker-client-with-docker.md)
          * [Backend requests with an internal certificate for Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/backend-requests-with-an-internal-certificate-for-docker.md)
          * [Proxy support with Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/proxy-support-with-docker.md)
          * [Disable certificate verification with Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/disable-certificate-verification-with-docker.md)
          * [Adding custom allowlist for Docker installation](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/adding-custom-allowlist-for-docker-installation.md)
          * [Custom approved-listing filter with Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/custom-approved-listing-filter-with-docker.md)
          * [Mounting secrets with Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/mounting-secrets-with-docker.md)
          * [Snyk Code - Clone capability with Broker for Docker](snyk-admin/snyk-broker/install-and-configure-snyk-broker/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation/snyk-code-clone-capability-with-broker-for-docker.md)
      ...
      * [Snyk Broker - Client integration setups with Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/snyk-broker-client-integration-setups-with-helm.md)
      * [githhub.com - install and configure using Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/githhub.com-install-and-configure-using-helm.md)
      * [GitHub Enterprise - install and configure using Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/github-enterprise-install-and-configure-using-helm.md)
      * [Bitbucket Server/Data Center - install and configure using Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/bitbucket-server-data-center-install-and-configure-using-helm.md)
      * [GitLab - install and configure using Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/gitlab-install-and-configure-using-helm.md)
      * [Azure Repos - install and configure and configure using Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/azure-repos-install-and-configure-and-configure-using-helm.md)
      * [Nexus Repository - install and configure using Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/nexus-repository-install-and-configure-using-helm.md)
      ...
      * [Jira - install and configure using Helm](snyk-admin/snyk-broker/install-and-configure-snyk-broker/jira-install-and-configure-using-helm.md)
