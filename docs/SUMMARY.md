...
* [Scan applications](scan-applications/README.md)
  * [Supported languages and frameworks](scan-application-code/supported-languages-and-frameworks/README.md)
    ...
    * [Working with Snyk in your environment](scan-application-code/supported-languages-and-frameworks/working-with-snyk-in-your-environment/README.md)
      * [Best practices for .NET](scan-application-code/supported-languages-and-frameworks/working-with-snyk-in-your-environment/best-practices-for-.net.md)
      * [Best practices for C/C++](scan-application-code/supported-languages-and-frameworks/working-with-snyk-in-your-environment/best-practices-for-c-c++.md)
      * [Best practices for Java and Kotlin](scan-application-code/supported-languages-and-frameworks/working-with-snyk-in-your-environment/snyk-for-java-developers.md)
    ...
    * [.NET](scan-application-code/supported-languages-and-frameworks/.net.md)
    * [C/C++](scan-application-code/supported-languages-and-frameworks/c-c++.md)
    * [Java and Kotlin](scan-application-code/supported-languages-and-frameworks/java-and-kotlin.md)
    * [JavaScript](scan-application-code/supported-languages-and-frameworks/javascript.md)
  ...
  * [Snyk Open Source](scan-application-code/snyk-open-source/README.md)
    ...
    * [Starting to fix vulnerabilities](scan-application-code/snyk-open-source/starting-to-fix-vulnerabilities/README.md)
      ...
      * [Differences in Open Source vulnerability counts across environments](scan-application-code/snyk-open-source/starting-to-fix-vulnerabilities/differences-in-open-source-vulnerability-counts-across-environments.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Getting started with Snyk Code](scan-application-code/snyk-code/getting-started-with-snyk-code/README.md)
      ...
      * [Activating Snyk Code using the Web UI](scan-application-code/snyk-code/getting-started-with-snyk-code/activating-snyk-code-using-the-web-ui.md)
      * [Enabling the Snyk Code option in an Organization](scan-application-code/snyk-code/getting-started-with-snyk-code/enabling-the-snyk-code-option-in-an-organization.md)
      * [Integrating your Source Control System with your Snyk account](scan-application-code/snyk-code/getting-started-with-snyk-code/integrating-your-source-control-system-with-your-snyk-account.md)
      * [Importing repositories for Snyk Code testing](scan-application-code/snyk-code/getting-started-with-snyk-code/importing-repositories-for-snyk-code-testing.md)
    ...
    * [Security rules used by Snyk Code](scan-application-code/snyk-code/security-rules-used-by-snyk-code/README.md)
      * [Apex rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/apex-rules.md)
      * [C# and ASP.NET rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/c-and-asp.net-rules.md)
      * [C++ (Beta) rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/c++-beta-rules.md)
      ...
      * [Kotlin (Beta) rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/kotlin-beta-rules.md)
      * [PHP rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/php-rules.md)
      * [Python rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/python-rules.md)
      * [Ruby rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/ruby-rules.md)
      * [Scala (Beta) rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/scala-beta-rules.md)
      * [Swift (Beta) rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/swift-beta-rules.md)
      * [Visual Basic (Beta) rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/visual-basic-beta-rules.md)
      * [XML rules](scan-application-code/snyk-code/security-rules-used-by-snyk-code/xml-rules.md)
    ...
    * [Exploring and working with Snyk Code results in the Web UI](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/README.md)
      ...
      * [Exploring the Data flow and Fix analysis pages of an issue](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-data-flow-and-fix-analysis-pages-of-an-issue/README.md)
        * [Exploring the Data flow page](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-data-flow-and-fix-analysis-pages-of-an-issue/exploring-the-data-flow-page.md)
        * [Exploring the Fix analysis page](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-data-flow-and-fix-analysis-pages-of-an-issue/exploring-the-fix-analysis-page.md)
      ...
      * [Sharing your feedback on Snyk Code](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/sharing-your-feedback-with-snyk-code.md)
    * [Using Snyk Code from the CLI](scan-application-code/snyk-code/using-snyk-code-from-the-cli/README.md)
      * [Set the Snyk Organization for the CLI tests](scan-application-code/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/README.md)
        * [Setting the default Organization for all CLI tests](scan-application-code/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/setting-the-default-organization-for-all-cli-tests.md)
        * [Finding the Snyk ID and internal name of an Organization](scan-application-code/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/finding-the-snyk-id-and-internal-name-of-an-organization.md)
        * [Setting an Organization for a specific CLI test](scan-application-code/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/setting-an-organization-for-a-specific-cli-test.md)
      * [Testing your source code using the CLI](scan-application-code/snyk-code/using-snyk-code-from-the-cli/testing-your-source-code-using-the-cli.md)
      * [Publishing Snyk Code CLI results to a Snyk Project and ignoring CLI results (beta)](scan-application-code/snyk-code/using-snyk-code-from-the-cli/publishing-cli-results-to-a-snyk-project-and-ignoring-cli-results.md)
      * [Excluding directories and files from the Snyk Code CLI test](scan-application-code/snyk-code/using-snyk-code-from-the-cli/excluding-directories-and-files-from-the-snyk-code-cli-test.md)
      * [Understanding the Snyk Code CLI results](scan-application-code/snyk-code/using-snyk-code-from-the-cli/snyk-code-cli-results.md)
      * [Working with the Snyk Code CLI results](scan-application-code/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results/README.md)
        * [Displaying only discovered issues above a specific severity level](scan-application-code/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results/displaying-only-discovered-issues-above-a-specific-severity-level.md)
        * [Outputting the test results to JSON or SARIF format in the terminal](scan-application-code/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results/outputting-the-test-results-to-json-or-sarif-format-in-the-terminal.md)
        * [Exporting the test results to a JSON or SARIF file](scan-application-code/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results/exporting-the-test-results-to-a-json-or-sarif-file.md)
      * [Displaying the CLI results in an HTML format using the Snyk-to-HTML feature](scan-application-code/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/README.md)
        * [Installing the Snyk-to-Html tool](scan-application-code/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/installing-the-snyk-to-html-tool.md)
        * [Running the snyk-to-html command](scan-application-code/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/running-the-snyk-to-html-command.md)
        * [Viewing the HTML results](scan-application-code/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/viewing-the-html-results.md)
    ...
    * [Snyk Code Local Engine](scan-application-code/snyk-code/snyk-code-local-engine.md)
  ...
  * [Snyk Container](scan-application-code/snyk-container/README.md)
    * [Getting started with Snyk Container](scan-application-code/snyk-container/getting-started-with-snyk-container.md)
    * [How Snyk Container works](scan-application-code/snyk-container/how-snyk-container-works/README.md)
      * [Snyk Container - Supported operating system distributions](scan-application-code/snyk-container/how-snyk-container-works/supported-operating-system-distributions.md)
      ...
      * [Understanding the severity levels of detected Linux vulnerabilities](scan-application-code/snyk-container/how-snyk-container-works/understanding-linux-vulnerability-severity.md)
    * [Use Snyk Container](scan-application-code/snyk-container/use-snyk-container/README.md)
      * [Base image detection](scan-application-code/snyk-container/use-snyk-container/base-image-detection.md)
      * [Image layer information](scan-application-code/snyk-container/use-snyk-container/image-layer-information.md)
      * [Detecting application vulnerabilities in container images](scan-application-code/snyk-container/use-snyk-container/detecting-application-vulnerabilities-in-container-images.md)
      * [Analysis and fixes for your images from the Snyk Web UI](scan-application-code/snyk-container/use-snyk-container/analysis-and-remediation-for-your-images-from-the-snyk-app.md)
      * [Custom Base Image Recommendations](scan-application-code/snyk-container/use-snyk-container/custom-base-image-recommendations/README.md)
        * [Case study for Custom Base Image Recommendations](scan-application-code/snyk-container/use-snyk-container/custom-base-image-recommendations/case-study-for-custom-base-image-recommendations.md)
        * [Versioning Schema options](scan-application-code/snyk-container/use-snyk-container/custom-base-image-recommendations/versioning-schema-options.md)
        * [Custom Versioning Schema for Custom Base Images](scan-application-code/snyk-container/use-snyk-container/custom-base-image-recommendations/custom-versioning-schema-for-custom-base-images.md)
      * [Container Project grouping in Project tab](scan-application-code/snyk-container/use-snyk-container/container-project-grouping-in-project-tab.md)
    * [Snyk CLI for container security](scan-application-code/snyk-container/snyk-cli-for-container-security/README.md)
      * [Understanding Snyk Container CLI results](scan-application-code/snyk-container/snyk-cli-for-container-security/understanding-snyk-container-cli-results.md)
      * [Advanced Snyk Container CLI usage](scan-application-code/snyk-container/snyk-cli-for-container-security/advanced-snyk-container-cli-usage.md)
    * [Scan your Dockerfile](scan-application-code/snyk-container/scan-your-dockerfile/README.md)
      * [Prerequisites for Dockerfile analysis](scan-application-code/snyk-container/scan-your-dockerfile/prerequisites-for-dockerfile-analysis.md)
      * [Supported SCMs for Dockerfile analysis](scan-application-code/snyk-container/scan-your-dockerfile/supported-scms-for-dockerfile-analysis.md)
      * [Adding your Dockerfile and testing your base image](scan-application-code/snyk-container/scan-your-dockerfile/adding-your-dockerfile-and-testing-your-base-image.md)
      * [Detect vulnerable base images from Dockerfile](scan-application-code/snyk-container/scan-your-dockerfile/detect-vulnerable-bases-images-from-dockerfile.md)
      * [Automatically link between Dockerfile and images using labels](scan-application-code/snyk-container/scan-your-dockerfile/automatically-link-between-dockerfile-and-images-using-labels.md)
      * [Open pull requests to fix vulnerable base images in your Dockerfile](scan-application-code/snyk-container/scan-your-dockerfile/open-pull-requests-to-fix-vulnerable-base-images-in-your-dockerfile.md)
    * [Kubernetes integration](scan-application-code/snyk-container/kubernetes-integration/README.md)
      * [Kubernetes integration overview](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-overview/README.md)
        * [Kubernetes integration architecture diagram](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-overview/kubernetes-integration-architecture-diagram.md)
        * [How Snyk Controller handles your data](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-overview/how-snyk-controller-handles-your-data.md)
        * [Enable the Kubernetes integration](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-overview/viewing-your-kubernetes-integration-settings.md)
        * [Supported workloads, Container Registry, languages, OS for Kubernetes integration](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-overview/supported-container-registry.md)
        * [Disable the Kubernetes integration](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-overview/disable-the-kubernetes-integration.md)
      * [Snyk Controller installation](scan-application-code/snyk-container/kubernetes-integration/snyk-controller-installation/README.md)
        * [Prerequisites for Snyk Controller](scan-application-code/snyk-container/kubernetes-integration/snyk-controller-installation/prerequisites-for-snyk-controller.md)
        * [Install the Snyk controller with Helm (Azure and Google Cloud Platform)](scan-application-code/snyk-container/kubernetes-integration/snyk-controller-installation/install-the-snyk-controller-with-helm.md)
        * [Install the Snyk controller on Amazon Elastic Kubernetes Service (Amazon EKS)](scan-application-code/snyk-container/kubernetes-integration/snyk-controller-installation/install-the-snyk-controller-on-amazon-elastic-kubernetes-service-amazon-eks.md)
        * [Install the Snyk controller with OpenShift 4 and OperatorHub](scan-application-code/snyk-container/kubernetes-integration/snyk-controller-installation/install-the-snyk-controller-with-openshift-4-and-operatorhub.md)
        * [Optional installation steps for Snyk Controller with Helm](scan-application-code/snyk-container/kubernetes-integration/snyk-controller-installation/optional-installation-steps-for-snyk-controller-with-helm.md)
        * [Private container registry authentication](scan-application-code/snyk-container/kubernetes-integration/snyk-controller-installation/private-container-registry-authentication.md)
      * [Kubernetes integration features](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-features/README.md)
        * [Manually import Kubernetes workload project](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-features/adding-kubernetes-workloads-for-security-scanning.md)
        * [Automatic import/deletion of Kubernetes workloads projects](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-features/automatic-import-deletion-of-kubernetes-workloads-projects/README.md)
          * [Advanced use of automatic import/deletion](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-features/automatic-import-deletion-of-kubernetes-workloads-projects/advanced-use-of-automatic-import-deletion.md)
        * [Annotated import](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-features/annotated-import.md)
        * [Snyk Sysdig integration](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-features/snyk-sysdig-integration.md)
      * [Kubernetes integration UI explained](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-ui-explained/README.md)
        * [Viewing project details and test results](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-ui-explained/viewing-project-details-and-test-results.md)
        * [Snyk Priority Score and Kubernetes](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-ui-explained/snyk-priority-score-and-kubernetes.md)
      * [Kubernetes integration FAQ](scan-application-code/snyk-container/kubernetes-integration/kubernetes-integration-faq.md)
    * [Snyk Container for self-hosted container registries (with Broker)](scan-application-code/snyk-container/integrate-self-hosted-container-registries.md)
...
* [Scan infrastructure](scan-infrastructure/README.md)
  ...
  * [Snyk Infrastructure as Code](scan-infrastructure/snyk-infrastructure-as-code/README.md)
    * [Getting started with Snyk Infrastructure as Code (IaC)](scan-infrastructure/snyk-infrastructure-as-code/getting-started-snyk-iac.md)
    * [Using Snyk IaC with the Web UI](scan-infrastructure/snyk-infrastructure-as-code/using-snyk-iac-via-web.md)
    ...
    * [Snyk Infrastructure as Code with Broker for self-hosted Git](scan-infrastructure/snyk-infrastructure-as-code/snyk-infrastructure-as-code-with-broker-for-self-hosted-git.md)
    ...
    * [Jira integration for IaC](scan-infrastructure/snyk-infrastructure-as-code/jira-integration-for-iac.md)
    * [View Infrastructure as Code issue reports](scan-infrastructure/snyk-infrastructure-as-code/view-infrastructure-as-code-issue-reports.md)
  ...
  * [Snyk IaC+](scan-infrastructure/snyk-iac+/README.md)
    * [Key concepts in IaC+](scan-infrastructure/snyk-iac+/key-concepts-in-iac+.md)
    * [Getting started with IaC+ in the Web UI](scan-infrastructure/snyk-iac+/getting-started-with-iac+-in-the-web-ui.md)
    * [Test your IaC files with the Snyk CLI](scan-infrastructure/snyk-iac+/test-your-iac-files-with-the-snyk-cli.md)
    * [Adding cloud context to your IaC tests](scan-infrastructure/snyk-iac+/adding-cloud-context-to-your-iac-tests.md)
    ...
    * [Supported resources for Snyk cloud context](scan-infrastructure/snyk-iac+/supported-resources-for-snyk-cloud-context/README.md)
      * [Supported AWS resources for Snyk cloud context](scan-infrastructure/snyk-iac+/supported-resources-for-snyk-cloud-context/supported-aws-resources-for-snyk-cloud-context.md)
      * [Supported Azure resources for Snyk cloud context](scan-infrastructure/snyk-iac+/supported-resources-for-snyk-cloud-context/supported-azure-resources-for-snyk-cloud-context.md)
      * [Supported Google resources for Snyk cloud context](scan-infrastructure/snyk-iac+/supported-resources-for-snyk-cloud-context/supported-google-resources-for-snyk-cloud-context.md)
    ...
    * [Managing cloud and IaC+ rules](scan-infrastructure/snyk-iac+/managing-cloud-and-iac+-rules.md)
