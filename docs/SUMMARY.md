...
* [Snyk CLI](snyk-cli/README.md)
  ...
  * [CLI tools](snyk-cli/cli-tools/README.md)
    * [Displaying the CLI results in an HTML format using the Snyk-to-HTML feature](snyk-cli/cli-tools/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/README.md)
      * [Installing the Snyk-to-Html tool](snyk-cli/cli-tools/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/installing-the-snyk-to-html-tool.md)
      * [Running the snyk-to-html command](snyk-cli/cli-tools/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/running-the-snyk-to-html-command.md)
      * [Viewing the HTML results](snyk-cli/cli-tools/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/viewing-the-html-results.md)
    * [Tool: snyk-filter](snyk-cli/cli-tools/tool-snyk-filter.md)
