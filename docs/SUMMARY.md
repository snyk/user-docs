  ...
  * [Cloud platforms integrations](integrations/cloud-platforms-integrations/README.md)
    ...
    * [Google Cloud integration](integrations/cloud-platforms-integrations/google-cloud-integration/README.md)
      * [Google Cloud Integration: Web UI](integrations/cloud-platforms-integrations/google-cloud-integration/google-cloud-integration-web-ui/README.md)
        * [Step 1: Download service account IaC template (Web UI)](integrations/cloud-platforms-integrations/google-cloud-integration/google-cloud-integration-web-ui/step-1-download-service-account-iac-template-web-ui.md)
...
* [Scan cloud configurations](scan-cloud-configurations/README.md)
  ...
  * [Snyk IaC+](scan-cloud-configurations/snyk-iac+/README.md)
    ...
    * [Build your own IaC+ to cloud custom rules](scan-cloud-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/README.md)
      * [Create a Custom Rules Project](scan-cloud-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/create-a-custom-rules-project.md)
...
* [Snyk API](snyk-api/README.md)
  ...
  * [Snyk Tools](snyk-api/other-tools/README.md)
    ...
    * [Tool: snyk-delta](snyk-api/other-tools/tool-snyk-delta.md)
    * [Tool: snyk-filter](snyk-api/other-tools/tool-snyk-filter.md)
