    ...
    * [Snyk Broker - Code Agent](integrations/snyk-broker/snyk-broker-code-agent/README.md)
      ...
      * [Setting up the Code Agent – Broker Client deployment](integrations/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/README.md)
        ...
        * [Step 5: Setting up the Broker Client](integrations/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/README.md)
          ...
          * [Step 5.2a – Running the Broker Client without the code snippet display](integrations/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/step-5.2a-running-the-broker-client-without-the-code-snippet-display/README.md)
            * [Examples for running the Broker Client without the code snippets display](integrations/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/step-5.2a-running-the-broker-client-without-the-code-snippet-display/examples-for-running-the-broker-client-without-the-code-snippets-display.md)
            * [Setting up the Broker Client to work with a Proxy server](integrations/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/step-5.2a-running-the-broker-client-without-the-code-snippet-display/setting-up-the-broker-client-to-work-with-a-proxy-server.md)
          * [Step 5.2b – Running the Broker Client with the code snippets display](integrations/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/step-5.2b-running-the-broker-client-with-the-code-snippets-display/README.md)
            * [Examples for running the Broker Client with the code snippets display](integrations/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/step-5.2b-running-the-broker-client-with-the-code-snippets-display/examples-for-running-the-broker-client-with-the-code-snippets-display.md)
...
* [Snyk admin](snyk-admin/README.md)
  * [Managing authentication](snyk-admin/authentication/README.md)
    * [Authentication for third-party tools](snyk-admin/authentication/authentication-for-third-party-tools.md)
  * [Setting up Single Sign-On (SSO) for authentication](snyk-admin/setting-up-sso-for-authentication/README.md)
  ...
  * [Managing users & permissions](snyk-admin/managing-users-and-permissions/README.md)
    ...
    * [Manage users in your group](snyk-admin/managing-users-and-permissions/manage-users-in-your-organizations-1.md)
  ...
  * [Managing groups & organizations](snyk-admin/managing-groups-and-organizations/README.md)
    * [What’s a Snyk group?](snyk-admin/managing-groups-and-organizations/whats-a-snyk-group.md)
  ...
  * [Structure account for high application performance](snyk-admin/structure-account-for-high-application-performance/README.md)
    ...
    * [Service accounts](snyk-admin/structure-account-for-high-application-performance/service-accounts.md)
...
* [Snyk Container](products/snyk-container/README.md)
  ...
  * [Getting around the Snyk Container UI](products/snyk-container/getting-around-the-snyk-container-ui/README.md)
    ...
    * [Detecting application vulnerabilities in container images](products/snyk-container/getting-around-the-snyk-container-ui/detecting-application-vulnerabilities-in-container-images/README.md)
      * [Application vulnerability in Snyk Container and Snyk Open Source](products/snyk-container/getting-around-the-snyk-container-ui/detecting-application-vulnerabilities-in-container-images/application-vulnerability-in-snyk-container-and-snyk-open-source.md)
  ...
  * [Kubernetes integration](products/snyk-container/kubernetes-workload-and-image-scanning/README.md)
    ...
    * [Kubernetes integration features](products/snyk-container/kubernetes-workload-and-image-scanning/kubernetes-integration-features/README.md)
      ...
      * [Annotated import](products/snyk-container/kubernetes-workload-and-image-scanning/kubernetes-integration-features/annotated-import.md)
