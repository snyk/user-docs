...
* [Getting started](getting-started/README.md)
  ...
  * [Quickstart](getting-started/quickstart/README.md)
    * [Create or log in to a Snyk account](getting-started/quickstart/create-a-snyk-account.md)
...
* [Scan infrastructure](scan-infrastructure/README.md)
  * [Supported IaC languages, cloud providers, and cloud resources](scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/README.md)
    * [Supported AWS resources for cloud context](scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/supported-aws-resources-for-cloud-context.md)
    * [Supported Azure resources for cloud context](scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/supported-azure-resources-for-cloud-context.md)
    * [Supported Google resources for cloud context](scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/supported-google-resources-for-cloud-context.md)
  * [Getting started with current IaC](scan-infrastructure/getting-started-with-current-iac.md)
  ...
  * [Scan your IaC source code](scan-infrastructure/scan-your-iac-source-code/README.md)
    * [Scan Terraform files](scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/README.md)
      * [Configure your integration to find security issues in your Terraform files (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/configure-your-integration-to-find-security-issues-in-your-terraform-files-current-iac.md)
      * [Scan and fix security issues in Terraform files (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/scan-and-fix-security-issues-in-terraform-files-current-iac.md)
      * [Terraform variables support (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/terraform-variables-support-current-iac.md)
      * [Terraform AWS Provider support](scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/terraform-aws-provider-support.md)
    * [Scan CloudFormation files](scan-infrastructure/scan-your-iac-source-code/scan-cloudformation-files/README.md)
      * [Configure your integration to find security issues in your CloudFormation files (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-cloudformation-files/configure-your-integration-to-find-security-issues-in-your-cloudformation-files-current-iac.md)
      * [Scan and fix security issues in your CloudFormation files (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-cloudformation-files/scan-and-fix-security-issues-in-your-cloudformation-files-current-iac.md)
    * [Scan Kubernetes configuration files](scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/README.md)
      * [Configure integration to find security issues in Kubernetes configuration files (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/configure-integration-to-find-security-issues-in-kubernetes-configuration-files-current-iac.md)
      * [Scan and fix security issues in Kubernetes configuration files (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-kubernetes-configuration-files-current-iac.md)
      * [Scan and fix security issues in Helm Charts (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-helm-charts-current-iac.md)
      * [Working with Kubernetes configuration file test results (current IaC)](scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/working-with-kubernetes-configuration-file-test-results-current-iac.md)
    * [Scan ARM configuration files](scan-infrastructure/scan-your-iac-source-code/scan-arm-configuration-files.md)
    * [Scan Serverless files](scan-infrastructure/scan-your-iac-source-code/scan-serverless-files.md)
    * [Disable IaC scans per Organization (current IaC)](scan-infrastructure/scan-your-iac-source-code/disable-iac-scans-per-organization-current-iac.md)
  ...
  * [Build your own custom rules](scan-infrastructure/build-your-own-custom-rules/README.md)
    * [Current IaC custom rules](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/README.md)
      * [Install the SDK](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/install-the-sdk.md)
      * [Writing rules using the SDK](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/README.md)
        * [Parsing an input file](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/parsing-an-input-file.md)
        * [Writing a rule](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/writing-a-rule.md)
        * [Testing a rule](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/testing-a-rule.md)
        * [Bundling rules](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/bundling-rules.md)
        * [Pushing a bundle](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/pushing-a-bundle.md)
        * [Custom Rego Builtins](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/custom-rego-builtins.md)
        * [Examples of custom rules](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/examples-of-custom-rules.md)
      * [Use IaC custom rules with CLI](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/use-iac-custom-rules-with-cli/README.md)
        * [Using a local custom rules bundle](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/use-iac-custom-rules-with-cli/using-a-local-custom-rules-bundle.md)
        * [Using a remote custom rules bundle](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/use-iac-custom-rules-with-cli/using-a-remote-custom-rules-bundle.md)
      * [Integrating IaC custom rules within a pipeline](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/integrating-iac-custom-rules-within-a-pipeline.md)
      * [SDK reference](scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/sdk-reference.md)
  ...
  * [IaC+ code to cloud capabilities](scan-infrastructure/iac+-code-to-cloud-capabilities/README.md)
    * [Add cloud context to your IaC tests](scan-infrastructure/iac+-code-to-cloud-capabilities/add-cloud-context-to-your-iac-tests.md)
    * [Fix cloud issues in IaC](scan-infrastructure/iac+-code-to-cloud-capabilities/fix-cloud-issues-in-iac.md)
    * [Detect drift and manually created resources](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/README.md)
      * [Get started with Snyk IaC Describe on AWS](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/get-started-with-snyk-iac-describe-on-aws.md)
      * [Configure cloud providers](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/README.md)
        * [Configure AWS provider](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-aws-provider.md)
        * [Configure Azure provider](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-azure-provider.md)
        * [Configure GitHub provider](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-github-provider.md)
        * [Configure Google provider](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-google-provider.md)
      * [Supported resources](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/README.md)
        * [AWS resources](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/aws-resources.md)
        * [Azure resources](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/azure-resources.md)
        * [GitHub resources](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/github-resources.md)
        * [Google resources](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/google-resources.md)
      * [IaC describe command examples](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/iac-describe-command-examples.md)
      * [Filter rules](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/filter-rules.md)
      * [Ignore resources for drift](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/ignore-resources-for-drift.md)
      * [IAC sources usage](scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/iac-sources-usage.md)
  * [View IaC+ and cloud compliance reporting](scan-infrastructure/view-iac+-and-cloud-compliance-reporting.md)
  * [View Snyk IaC issue reports](scan-infrastructure/view-snyk-iac-issue-reports.md)
