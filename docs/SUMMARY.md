  ...
  * [Snyk Broker - Code Agent](features/snyk-broker/snyk-broker-code-agent/README.md)
    ...
    * [Setting up the Code Agent – Broker Client deployment](features/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/README.md)
      ...
      * [Step 5: Setting up the Broker Client](features/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/README.md)
        ...
        * [Step 5.2b – Running the Broker Client with the code snippets display](features/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/step-5-setting-up-the-broker-client/step-5.2b-running-the-broker-client-with-the-code-snippets-display.md)
