...
* [Scan applications](scan-applications/README.md)
  ...
  * [Start scanning](scan-applications/start-scanning/README.md)
    * [Import repository to Snyk](scan-applications/start-scanning/snyk-code-and-your-repositories/README.md)
      * [Exclude directories and files from the import process](scan-applications/start-scanning/snyk-code-and-your-repositories/excluding-directories-and-files-from-the-import-process.md)
      * [Remove imported repository](scan-applications/start-scanning/snyk-code-and-your-repositories/removing-imported-repositories-from-snyk-code-testing.md)
