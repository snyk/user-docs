...
* [Scan configurations](scan-configurations/README.md)
  * [Supported IaC and cloud providers](scan-configurations/supported-iac-and-cloud-providers.md)
  * [Snyk Infrastructure as Code](scan-configurations/snyk-infrastructure-as-code/README.md)
    * [Getting started with Snyk Infrastructure as Code (IaC)](scan-configurations/snyk-infrastructure-as-code/getting-started-snyk-iac.md)
    * [Using Snyk IaC with the Web UI](scan-configurations/snyk-infrastructure-as-code/using-snyk-iac-via-web.md)
    * [Snyk CLI for Infrastructure as Code](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/README.md)
      * [Test your IaC files](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/README.md)
        * [Test your Terraform files with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-terraform-files-with-snyk-cli.md)
        * [Test your CloudFormation files with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-cloudformation-files-with-snyk-cli.md)
        * [Test your AWS CDK files with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-aws-cdk-files-with-snyk-cli.md)
        * [Test your Kubernetes files with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-kubernetes-files-with-snyk-cli.md)
        * [Test your ARM files with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-arm-files-with-snyk-cli.md)
        * [Test your Kustomize files with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-kustomize-files-with-snyk-cli.md)
        * [Test your Helm charts with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-helm-charts-with-snyk-cli.md)
        * [Test your Serverless files with Snyk CLI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-serverless-files-with-snyk-cli.md)
      * [Share CLI results with the Snyk Web UI](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/share-cli-results-with-the-snyk-web-ui.md)
      ...
      * [IaC exclusions using the command line](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/iac-exclusions-using-the-command-line.md)
      * [Understanding the IaC CLI test results](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/README.md)
        * [Snyk IaC CLI test results (v. 1.939.0 and later)](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/snyk-iac-cli-test-results-v.-1.939.0-and-later.md)
        * [Snyk IaC CLI test results (v. 1.938.0 and earlier)](scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/snyk-iac-cli-test-results-v.-1.938.0-and-earlier.md)
    * [Snyk Infrastructure as Code with Broker for self-hosted Git](scan-configurations/snyk-infrastructure-as-code/snyk-infrastructure-as-code-with-broker-for-self-hosted-git.md)
    * [Scan Terraform files](scan-configurations/snyk-infrastructure-as-code/scan-terraform-files/README.md)
      * [Configure your integration to find security issues in your Terraform files](scan-configurations/snyk-infrastructure-as-code/scan-terraform-files/configure-your-integration-to-find-security-issues-in-your-terraform-filess.md)
      * [Scan and fix security issues in Terraform files](scan-configurations/snyk-infrastructure-as-code/scan-terraform-files/scan-and-fix-security-issues-in-terraform-files.md)
      * [Terraform variables support](scan-configurations/snyk-infrastructure-as-code/scan-terraform-files/terraform-variables-support.md)
      * [Terraform AWS Provider support](scan-configurations/snyk-infrastructure-as-code/scan-terraform-files/terraform-aws-provider-support.md)
    * [Scan CloudFormation files](scan-configurations/snyk-infrastructure-as-code/scan-cloudformation-files/README.md)
      * [Configure your integration to find security issues in your CloudFormation files](scan-configurations/snyk-infrastructure-as-code/scan-cloudformation-files/configure-your-integration-to-find-security-issues-in-your-cloudformation-files.md)
      * [Scan and fix security issues in your CloudFormation files](scan-configurations/snyk-infrastructure-as-code/scan-cloudformation-files/scan-and-fix-security-issues-in-your-cloudformation-files.md)
    * [Scan Kubernetes configuration files](scan-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/README.md)
      * [Configure integration to find security issues in Kubernetes configuration files](scan-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/configure-integration-for-security-issues-in-kubernetes-configuration-files.md)
      * [Scan and fix security issues in Kubernetes configuration files](scan-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-kubernetes-configuration-files.md)
      * [Scan and fix security issues in Helm Charts](scan-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-helm-charts.md)
      * [Working with Kubernetes configuration file test results](scan-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/working-with-kubernetes-configuration-file-test-results.md)
    * [Scan ARM configuration files](scan-configurations/snyk-infrastructure-as-code/scan-arm-configuration-files.md)
    * [Scan Serverless files](scan-configurations/snyk-infrastructure-as-code/scan-serverless-files.md)
    * [Jira integration for IaC](scan-configurations/snyk-infrastructure-as-code/jira-integration-for-iac.md)
    * [View Infrastructure as Code issue reports](scan-configurations/snyk-infrastructure-as-code/view-infrastructure-as-code-issue-reports.md)
    * [Build your own custom rules](scan-configurations/snyk-infrastructure-as-code/custom-rules/README.md)
      * [Install the SDK](scan-configurations/snyk-infrastructure-as-code/custom-rules/install-the-sdk.md)
      * [Getting started with the SDK](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/README.md)
        * [Parsing an input file](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/parsing-an-input-file.md)
        * [Writing a rule](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/writing-a-rule.md)
        * [Testing a rule](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/testing-a-rule.md)
        * [Bundling rules](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/bundling-rules.md)
        * [Pushing a bundle](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/pushing-a-bundle.md)
        * [Custom Rego Builtins](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/advanced-rego.md)
        * [Examples of custom rules](scan-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/examples.md)
      * [Use IaC custom rules with CLI](scan-configurations/snyk-infrastructure-as-code/custom-rules/use-iac-custom-rules-with-cli/README.md)
        * [Using a local custom rules bundle](scan-configurations/snyk-infrastructure-as-code/custom-rules/use-iac-custom-rules-with-cli/using-a-local-custom-rules-bundle.md)
        * [Using a remote custom rules bundle](scan-configurations/snyk-infrastructure-as-code/custom-rules/use-iac-custom-rules-with-cli/using-a-remote-custom-rules-bundle.md)
      * [Integrating IaC custom rules within a pipeline](scan-configurations/snyk-infrastructure-as-code/custom-rules/integrating-iac-custom-rules-within-a-pipeline.md)
      * [SDK reference](scan-configurations/snyk-infrastructure-as-code/custom-rules/sdk-reference.md)
    * [Detect drift and manually created resources](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/README.md)
      * [Get started with Snyk IaC Describe on AWS](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/get-started-with-snyk-iac-describe-on-aws.md)
      * [Configure cloud providers](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/README.md)
        * [Configure AWS provider](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-aws-provider.md)
        * [Configure Azure provider](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-azure-provider.md)
        * [Configure GitHub provider](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-github-provider.md)
        * [Configure Google provider](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-google-provider.md)
      * [Supported resources](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/README.md)
        * [AWS resources](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/aws-resources.md)
        * [Azure resources](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/azure-resources.md)
        * [GitHub resources](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/github-resources.md)
        * [Google resources](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/google-resources.md)
      * [Detect and report infrastructure drift](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/detect-and-report-infrastructure-drift.md)
      * [IaC describe command examples](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/iac-describe-command-examples.md)
      * [Filter rules](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/filter-rules.md)
      * [Ignore resources for drift](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/ignore-resources.md)
      * [IAC sources usage](scan-configurations/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/iac-sources-usage.md)
    * [Disable IaC scans per Organization](scan-configurations/snyk-infrastructure-as-code/disable-iac-scans.md)
  * [Snyk IaC+](scan-configurations/snyk-iac+/README.md)
    * [Key concepts in IaC+](scan-configurations/snyk-iac+/key-concepts-in-iac+.md)
    * [Getting started with IaC+ in the Web UI](scan-configurations/snyk-iac+/getting-started-with-iac+-in-the-web-ui.md)
    * [Test your IaC files with the Snyk CLI](scan-configurations/snyk-iac+/test-your-iac-files-with-the-snyk-cli.md)
    * [Adding cloud context to your IaC tests](scan-configurations/snyk-iac+/adding-cloud-context-to-your-iac-tests.md)
    * [Fix cloud issues in IaC](scan-configurations/snyk-iac+/fix-cloud-issues-in-integrated-iac.md)
    * [Snyk environments](scan-configurations/snyk-iac+/snyk-environments/README.md)
      * [View, add, and remove environments](scan-configurations/snyk-iac+/snyk-environments/view-add-and-remove-environments.md)
      * [Find an environment ID](scan-configurations/snyk-iac+/snyk-environments/find-an-environment-id.md)
      * [Scan a cloud environment](scan-configurations/snyk-iac+/snyk-environments/scan-a-cloud-environment.md)
      * [Update a cloud environment](scan-configurations/snyk-iac+/snyk-environments/update-a-cloud-environment.md)
      * [Remove an environment](scan-configurations/snyk-iac+/snyk-environments/remove-a-snyk-cloud-environment.md)
    * [Supported resources for Snyk cloud context](scan-configurations/snyk-iac+/supported-resources-for-snyk-cloud-context/README.md)
      * [Supported AWS resources for Snyk cloud context](scan-configurations/snyk-iac+/supported-resources-for-snyk-cloud-context/supported-aws-resources-for-snyk-cloud-context.md)
      * [Supported Azure resources for Snyk cloud context](scan-configurations/snyk-iac+/supported-resources-for-snyk-cloud-context/supported-azure-resources-for-snyk-cloud-context.md)
      * [Supported Google resources for Snyk cloud context](scan-configurations/snyk-iac+/supported-resources-for-snyk-cloud-context/supported-google-resources-for-snyk-cloud-context.md)
    * [Build your own IaC to cloud custom rules](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/README.md)
      * [Create a Custom Rules Project](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/create-a-custom-rules-project.md)
      * [Create a Custom Rule](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/create-a-custom-rule.md)
      * [(Recommended) Write a Custom Rule Spec (Unit Test)](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/recommended-write-a-custom-rule-spec-unit-test.md)
      * [(Recommended) Test your Custom Rule](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/recommended-test-your-custom-rule.md)
      * [Build, bundle, and upload your Custom Rules](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/build-bundle-and-upload-your-custom-rules.md)
      * [Enforce your Custom Rules](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/enforce-your-custom-rules.md)
      * [Explore example Custom Rules](scan-configurations/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/explore-example-custom-rules.md)
    * [Managing cloud and IaC+ rules](scan-configurations/snyk-iac+/managing-cloud-and-iac+-rules.md)
    * [Cloud and IaC+ issues](scan-configurations/snyk-iac+/cloud-and-integrated-iac-issues/README.md)
      * [View cloud and IaC+ issues in the Snyk Web UI](scan-configurations/snyk-iac+/cloud-and-integrated-iac-issues/view-cloud-and-integragted-iac-issues-in-the-snyk-web-ui.md)
      * [Ignoring cloud and IaC+ issues](scan-configurations/snyk-iac+/cloud-and-integrated-iac-issues/ignoring-cloud-and-integrated-iac-issues.md)
    * [View compliance reporting](scan-configurations/snyk-iac+/view-compliance-reporting.md)
    * [View resources](scan-configurations/snyk-iac+/view-resources.md)
* [Manage issues](manage-issues/README.md)
  ...
  * [Priorities for fixing issues](manage-issues/priorities-for-fixing-issues/README.md)
    * [Severity levels](manage-issues/priorities-for-fixing-issues/severity-levels.md)
