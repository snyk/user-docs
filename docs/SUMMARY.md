...
* [Scan applications](scan-applications/README.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Analyze code with Snyk Code CLI](scan-applications/snyk-code/using-snyk-code-from-the-cli/README.md)
      * [Set Snyk Organization for CLI tests](scan-applications/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests.md)
      * [Scan source code with Snyk Code CLI](scan-application-code/snyk-code/cli-for-snyk-code/testing-your-source-code-using-the-cli.md)
      * [Publish Snyk Code CLI results](scan-application-code/snyk-code/cli-for-snyk-code/publishing-cli-results-to-a-snyk-project-and-ignoring-cli-results.md)
      * [Exclude directories and files from Snyk Code CLI tests](scan-application-code/snyk-code/cli-for-snyk-code/excluding-directories-and-files-from-the-snyk-code-cli-test.md)
      * [View Snyk Code CLI results](scan-applications/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results.md)
