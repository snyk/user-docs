...
* [Manage issues](manage-issues/README.md)
  ...
  * [Policies](manage-issues/policies/README.md)
    ...
    * [Security policies](manage-issues/policies/security-policies/README.md)
      * [Introduction to security policies](manage-issues/policies/security-policies/getting-started-with-security-policies.md)
    ...
    * [License policies](manage-issues/policies/license-policies/README.md)
      * [Setting a license policy](manage-issues/policies/license-policies/setting-a-license-policy.md)
      * [License policies: What collaborators see](manage-issues/policies/license-policies/license-policies-what-collaborators-see.md)
...
* [Snyk admin](snyk-admin/README.md)
  ...
  * [Setting up Single Sign-On (SSO) for authentication](snyk-admin/setting-up-sso-for-authentication/README.md)
    ...
    * [Self Serve Single Sign-On (SSO)](snyk-admin/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/README.md)
      * [Example: Okta SAML Application](snyk-admin/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/example-okta.md)
  ...
  * [Snyk Broker](snyk-admin/snyk-broker/README.md)
    * [Set up Snyk Broker](snyk-admin/snyk-broker/set-up-snyk-broker/README.md)
      * [Prepare Snyk Broker for deployment](snyk-admin/snyk-broker/set-up-snyk-broker/prepare-snyk-broker-for-deployment.md)
      * [Install, configure, and upgrade the Snyk Broker Client](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/README.md)
        * [Install and configure Broker using Helm](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/install-and-configure-broker-using-helm/README.md)
          * [Advanced setup for Helm Chart installation](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/install-and-configure-broker-using-helm/advanced-setup-for-helm-chart-installation.md)
          * [Adding custom accept.json for Helm installation](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/install-and-configure-broker-using-helm/adding-custom-accept.json-for-helm-installation.md)
          * [Ingress options with Snyk Broker Helm installation](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/install-and-configure-broker-using-helm/ingress-options-with-snyk-broker-helm-installation.md)
          * [Deploying multiple Brokers in the same namespace](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/install-and-configure-broker-using-helm/deploying-multiple-brokers-in-the-same-namespace.md)
        * [Install and configure Broker using Docker](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/install-and-configure-broker-using-docker/README.md)
          * [Advanced configuration for Snyk Broker Docker installation](snyk-admin/snyk-broker/set-up-snyk-broker/how-to-install-and-configure-your-snyk-broker-client/install-and-configure-broker-using-docker/advanced-configuration-for-snyk-broker-docker-installation.md)
    ...
    * [Install Broker for SCMs using Helm](snyk-admin/snyk-broker/install-broker-for-scms-using-helm.md)
    * [Snyk Broker - Code Agent](snyk-admin/snyk-broker/snyk-broker-code-agent/README.md)
      ...
      * [Setting up the Code Agent – Broker Client deployment](snyk-admin/snyk-broker/snyk-broker-code-agent/setting-up-the-code-agent-broker-client-deployment/README.md)
    ...
    * [Install Broker for Code Agent using Helm](snyk-admin/snyk-broker/install-broker-for-code-agent-using-helm.md)
    * [Snyk Broker - Container Registry Agent](snyk-admin/snyk-broker/snyk-broker-container-registry-agent/README.md)
      ...
      * [Container Registry Agent advanced configuration](snyk-admin/snyk-broker/snyk-broker-container-registry-agent/container-registry-agent-advanced-configuration.md)
    ...
    * [Install Broker for Container Registry Agent using Helm](snyk-admin/snyk-broker/install-broker-for-container-registry-agent-using-helm.md)
  ...
  * [Managing users & permissions](snyk-admin/managing-users-and-permissions/README.md)
    ...
    * [Manage permissions](snyk-admin/managing-users-and-permissions/managing-permissions.md)
...
* [Snyk CLI](snyk-cli/README.md)
  ...
  * [CLI help](snyk-cli/commands/README.md)
    ...
    * [SBOM (beta)](snyk-cli/commands/sbom.md)
