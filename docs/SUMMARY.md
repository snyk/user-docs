...
* [Scan applications](scan-applications/README.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Manage code vulnerabilities](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/README.md)
      * [Code analysis breakdown](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/README.md)
      ...
      * [Fix code issues automatically](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/fix-code-issues-automatically-with-deepcode-ai-fix-suggestions.md)
    ...
    * [Snyk Code CI/CD pipeline](scan-application-code/snyk-code/using-snyk-code-from-a-ci-cd-pipeline.md)
    * [Snyk Code IDE](scan-application-code/snyk-code/using-snyk-code-in-an-ide.md)
