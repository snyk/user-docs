...
* [Snyk CLI](snyk-cli/README.md)
  ...
  * [Analyze code with Snyk Code CLI](snyk-cli/using-snyk-code-from-the-cli/README.md)
    * [Set Snyk Organization for CLI tests](snyk-cli/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests.md)
    * [Scan source code with Snyk Code CLI](snyk-cli/using-snyk-code-from-the-cli/testing-your-source-code-using-the-cli.md)
    * [Publish Snyk Code CLI results](snyk-cli/using-snyk-code-from-the-cli/publishing-cli-results-to-a-snyk-project-and-ignoring-cli-results.md)
    * [Exclude directories and files from Snyk Code CLI tests](snyk-cli/using-snyk-code-from-the-cli/excluding-directories-and-files-from-the-snyk-code-cli-test.md)
    * [View Snyk Code CLI results](snyk-cli/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results.md)
