...
* [Integrate with Snyk](integrations/README.md)
  * [Use Snyk in your IDE](integrations/ide-tools/README.md)
    ...
    * [Language Server](integrations/ide-tools/language-server.md)
...
* [Snyk API](snyk-api/README.md)
  ...
  * [Snyk Webhooks](snyk-api/snyk-webhooks/README.md)
    ...
    * [Using Snyk Webhooks to integrate New Relic with Snyk through an Azure Function App](snyk-api/snyk-webhooks/using-snyk-webhooks-to-integrate-new-relic-with-snyk-through-an-azure-function-app/README.md)
      * [Create an Azure Function App](snyk-api/snyk-webhooks/using-snyk-webhooks-to-integrate-new-relic-with-snyk-through-an-azure-function-app/create-an-azure-function-app.md)
      * [Configure Azure Function environment variables](snyk-api/snyk-webhooks/using-snyk-webhooks-to-integrate-new-relic-with-snyk-through-an-azure-function-app/configure-azure-function-environment-variables.md)
      * [Copy the Azure Function URL](snyk-api/snyk-webhooks/using-snyk-webhooks-to-integrate-new-relic-with-snyk-through-an-azure-function-app/copy-the-azure-function-url.md)
      * [Create a Snyk Webhook](snyk-api/snyk-webhooks/using-snyk-webhooks-to-integrate-new-relic-with-snyk-through-an-azure-function-app/create-a-snyk-webhook.md)
      * [New Relic Curated UI and Snyk Custom Dashboard](snyk-api/snyk-webhooks/using-snyk-webhooks-to-integrate-new-relic-with-snyk-through-an-azure-function-app/new-relic-curated-ui-and-snyk-custom-dashboard.md)
