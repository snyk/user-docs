...
* [Scan applications](scan-applications/README.md)
  ...
  * [Start scanning using the CLI, Web UI, or API](scan-applications/start-scanning-using-the-cli-web-ui-or-api/README.md)
    * [Import repository to Snyk](scan-applications/start-scanning-using-the-cli-web-ui-or-api/snyk-code-and-your-repositories/README.md)
      * [Exclude directories and files from the import process](scan-applications/start-scanning-using-the-cli-web-ui-or-api/snyk-code-and-your-repositories/excluding-directories-and-files-from-the-import-process.md)
      * [Remove imported repository](scan-applications/start-scanning-using-the-cli-web-ui-or-api/snyk-code-and-your-repositories/removing-imported-repositories-from-snyk-code-testing.md)
    * [Scan open-source libraries and licenses](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-open-source-libraries-and-licenses/README.md)
      * [Open-source license compliance](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-open-source-libraries-and-licenses/open-source-license-compliance.md)
      * [Snyk License Compliance Management](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-open-source-libraries-and-licenses/snyk-license-compliance-management.md)
    * [Scan code](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-code/README.md)
      * [Activate Snyk Code using the Web UI](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-code/activate-snyk-code-using-the-web-ui.md)
      * [Enable the Snyk Code option](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-code/enable-the-snyk-code-option.md)
      * [Integrate your Source Control System with your Snyk account](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-code/integrate-your-source-control-system-with-your-snyk-account.md)
      * [Import repositories to scan with Snyk Code](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-code/import-repositories-to-scan-with-snyk-code.md)
    * [Scan container images](scan-applications/start-scanning-using-the-cli-web-ui-or-api/scan-container-images.md)
  ...
  * [Snyk Open Source](scan-application-code/snyk-open-source/README.md)
    ...
    * [Automatic and manual PRs with Snyk Open Source](scan-application-code/snyk-open-source/open-source-basics/README.md)
      ...
      * [Upgrade dependencies with automatic PRs](scan-application-code/snyk-open-source/open-source-basics/upgrading-dependencies-with-automatic-prs.md)
      * [Customize PR templates (closed beta)](scan-applications/snyk-open-source/open-source-basics/customize-pr-templates-closed-beta/README.md)
        * [Apply a Custom PR template](scan-applications/snyk-open-source/open-source-basics/customize-pr-templates-closed-beta/apply-a-custom-pr-template.md)
        * [Variables list and description](scan-applications/snyk-open-source/open-source-basics/customize-pr-templates-closed-beta/variables-list-and-description.md)
        * [Troubleshooting and limitations](scan-applications/snyk-open-source/open-source-basics/customize-pr-templates-closed-beta/troubleshooting-and-limitations.md)
        * [Examples and template validation](scan-applications/snyk-open-source/open-source-basics/customize-pr-templates-closed-beta/validate-the-template-and-examples.md)
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    * [Snyk Code overview](scan-application-code/snyk-code/snyk-code-key-features/README.md)
      * [Snyk Code deployment](scan-application-code/snyk-code/deployment-options.md)
    ...
    * [Custom rules (beta)](scan-application-code/snyk-code/custom-rules-beta/README.md)
      * [Introduction to custom rules](scan-applications/snyk-code/custom-rules-beta/introducing-custom-rules.md)
    ...
    * [Manage code vulnerabilities](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/README.md)
      * [Breakdown of code analysis](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/README.md)
        * [Project summary](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/code-analysis-page-header.md)
        * [Vulnerabilities](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/code-analysis-page-vulnerability-issues-area.md)
        * [Data flow](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/exploring-the-data-flow-and-fix-analysis-pages-of-an-issue.md)
        * [Fix analysis](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/exploring-the-fix-analysis-page.md)
        * [Priority score](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/understanding-the-priority-score-of-snyk-code-issues.md)
        * [Severity score](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/understanding-the-severity-score-of-snyk-code-issues.md)
      ...
      * [Fix code vulnerabilities automatically](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/fix-code-issues-automatically-with-deepcode-ai-fix-suggestions.md)
      * [Code Analysis results history](scan-application-code/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-history-of-snyk-code-results.md)
    * [Use Snyk Code in the CI/CD pipeline](scan-application-code/snyk-code/using-snyk-code-from-a-ci-cd-pipeline.md)
    * [Use Snyk Code IDE](scan-application-code/snyk-code/using-snyk-code-in-an-ide.md)
  ...
  * [Scan infrastructure](scan-applications/scan-infrastructure/README.md)
    * [Supported IaC languages, cloud providers, and cloud resources](scan-applications/scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/README.md)
      * [Supported AWS resources for cloud context](scan-applications/scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/supported-aws-resources-for-cloud-context.md)
      * [Supported Azure resources for cloud context](scan-applications/scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/supported-azure-resources-for-cloud-context.md)
      * [Supported Google resources for cloud context](scan-applications/scan-infrastructure/supported-iac-languages-cloud-providers-and-cloud-resources/supported-google-resources-for-cloud-context.md)
    * [Getting started with current IaC](scan-applications/scan-infrastructure/getting-started-with-current-iac.md)
    * [Getting started with IaC+ and cloud scans](scan-applications/scan-infrastructure/introduction-to-iac+/README.md)
      * [Key concepts for IaC+ and cloud](scan-applications/scan-infrastructure/introduction-to-iac+/key-concepts-in-iac+.md)
      * [Manage IaC+ and cloud issues](scan-applications/scan-infrastructure/introduction-to-iac+/cloud-and-integrated-iac-issues/README.md)
        * [View IaC+ and cloud issues in the Snyk Web UI](scan-applications/scan-infrastructure/introduction-to-iac+/cloud-and-integrated-iac-issues/view-cloud-and-integragted-iac-issues-in-the-snyk-web-ui.md)
        * [Ignoring cloud and IaC+ issues](scan-applications/scan-infrastructure/introduction-to-iac+/cloud-and-integrated-iac-issues/ignoring-cloud-and-integrated-iac-issues.md)
      * [Manage IaC+ and cloud environments](scan-applications/scan-infrastructure/introduction-to-iac+/snyk-environments/README.md)
        * [View, add, and remove environments](scan-applications/scan-infrastructure/introduction-to-iac+/snyk-environments/view-add-and-remove-environments.md)
        * [Find an environment ID](scan-applications/scan-infrastructure/introduction-to-iac+/snyk-environments/find-an-environment-id.md)
        * [Scan a cloud environment](scan-applications/scan-infrastructure/introduction-to-iac+/snyk-environments/scan-a-cloud-environment.md)
        * [Update a cloud environment](scan-applications/scan-infrastructure/introduction-to-iac+/snyk-environments/update-a-cloud-environment.md)
        * [Remove an environment](scan-applications/scan-infrastructure/introduction-to-iac+/snyk-environments/remove-a-snyk-cloud-environment.md)
      * [View IaC+ and cloud resources](scan-applications/scan-infrastructure/introduction-to-iac+/view-resources.md)
      * [Manage IaC+ and cloud rules](scan-applications/scan-infrastructure/introduction-to-iac+/manage-cloud-and-iac+-rules.md)
    * [Scan your IaC source code](scan-applications/scan-infrastructure/scan-your-iac-source-code/README.md)
      * [Scan Terraform files](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/README.md)
        * [Configure your integration to find security issues in your Terraform files (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/configure-your-integration-to-find-security-issues-in-your-terraform-files-current-iac.md)
        * [Scan and fix security issues in Terraform files (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/scan-and-fix-security-issues-in-terraform-files-current-iac.md)
        * [Terraform variables support (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/terraform-variables-support-current-iac.md)
        * [Terraform AWS Provider support](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-terraform-files/terraform-aws-provider-support.md)
      * [Scan CloudFormation files](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-cloudformation-files/README.md)
        * [Configure your integration to find security issues in your CloudFormation files (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-cloudformation-files/configure-your-integration-to-find-security-issues-in-your-cloudformation-files-current-iac.md)
        * [Scan and fix security issues in your CloudFormation files (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-cloudformation-files/scan-and-fix-security-issues-in-your-cloudformation-files-current-iac.md)
      * [Scan Kubernetes configuration files](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/README.md)
        * [Configure integration to find security issues in Kubernetes configuration files (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/configure-integration-to-find-security-issues-in-kubernetes-configuration-files-current-iac.md)
        * [Scan and fix security issues in Kubernetes configuration files (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-kubernetes-configuration-files-current-iac.md)
        * [Scan and fix security issues in Helm Charts (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-helm-charts-current-iac.md)
        * [Working with Kubernetes configuration file test results (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-kubernetes-configuration-files/working-with-kubernetes-configuration-file-test-results-current-iac.md)
      * [Scan ARM configuration files](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-arm-configuration-files.md)
      * [Scan Serverless files](scan-applications/scan-infrastructure/scan-your-iac-source-code/scan-serverless-files.md)
      * [Disable IaC scans per Organization (current IaC)](scan-applications/scan-infrastructure/scan-your-iac-source-code/disable-iac-scans-per-organization-current-iac.md)
    * [Snyk CLI for IaC](scan-applications/scan-infrastructure/snyk-cli-for-iac/README.md)
      * [Test your IaC files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/README.md)
        * [Terraform files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/terraform-files.md)
        * [CloudFormation files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/cloudformation-files.md)
        * [AWS CDK files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/aws-cdk-files.md)
        * [Kubernetes files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/kubernetes-files.md)
        * [ARM files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/arm-files.md)
        * [Kustomize files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/kustomize-files.md)
        * [Helm charts](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/helm-charts.md)
        * [Serverless files](scan-applications/scan-infrastructure/snyk-cli-for-iac/test-your-iac-files/serverless-files.md)
      * [Share CLI results with the Snyk Web UI](scan-applications/scan-infrastructure/snyk-cli-for-iac/share-cli-results-with-the-snyk-web-ui.md)
      * [IaC ignores using the .snyk policy file](scan-applications/scan-infrastructure/snyk-cli-for-iac/iac-ignores-using-the-.snyk-policy-file.md)
      * [IaC exclusions using the command line](scan-applications/scan-infrastructure/snyk-cli-for-iac/iac-exclusions-using-the-command-line.md)
      * [Understanding the IaC CLI test results](scan-applications/scan-infrastructure/snyk-cli-for-iac/understanding-the-iac-cli-test-results/README.md)
        * [Snyk IaC CLI test results (v. 1.938.0 and earlier)](scan-applications/scan-infrastructure/snyk-cli-for-iac/understanding-the-iac-cli-test-results/snyk-iac-cli-test-results-v.-1.938.0-and-earlier.md)
        * [Snyk IaC CLI test results (v. 1.939.0 and later)](scan-applications/scan-infrastructure/snyk-cli-for-iac/understanding-the-iac-cli-test-results/snyk-iac-cli-test-results-v.-1.939.0-and-later.md)
    * [Build your own custom rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/README.md)
      * [Current IaC custom rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/README.md)
        * [Install the SDK](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/install-the-sdk.md)
        * [Writing rules using the SDK](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/README.md)
          * [Parsing an input file](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/parsing-an-input-file.md)
          * [Writing a rule](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/writing-a-rule.md)
          * [Testing a rule](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/testing-a-rule.md)
          * [Bundling rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/bundling-rules.md)
          * [Pushing a bundle](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/pushing-a-bundle.md)
          * [Custom Rego Builtins](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/custom-rego-builtins.md)
          * [Examples of custom rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/writing-rules-using-the-sdk/examples-of-custom-rules.md)
        * [Use IaC custom rules with CLI](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/use-iac-custom-rules-with-cli/README.md)
          * [Using a local custom rules bundle](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/use-iac-custom-rules-with-cli/using-a-local-custom-rules-bundle.md)
          * [Using a remote custom rules bundle](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/use-iac-custom-rules-with-cli/using-a-remote-custom-rules-bundle.md)
        * [Integrating IaC custom rules within a pipeline](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/integrating-iac-custom-rules-within-a-pipeline.md)
        * [SDK reference](scan-applications/scan-infrastructure/build-your-own-custom-rules/current-iac-custom-rules/sdk-reference.md)
      * [IaC+ and cloud custom rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/README.md)
        * [Create a Custom Rules Project](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/create-a-custom-rules-project.md)
        * [Create a Custom Rule](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/create-a-custom-rule.md)
        * [(Recommended) Write a Custom Rule Spec (Unit Test)](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/recommended-write-a-custom-rule-spec-unit-test.md)
        * [(Recommended) Test your Custom Rule](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/recommended-test-your-custom-rule.md)
        * [Build, bundle, and upload your Custom Rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/build-bundle-and-upload-your-custom-rules.md)
        * [Enforce your Custom Rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/enforce-your-custom-rules.md)
        * [Explore example Custom Rules](scan-applications/scan-infrastructure/build-your-own-custom-rules/build-your-own-iac+-to-cloud-custom-rules/explore-example-custom-rules.md)
    * [IaC+ code to cloud capabilities](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/README.md)
      * [Add cloud context to your IaC tests](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/add-cloud-context-to-your-iac-tests.md)
      * [Fix cloud issues in IaC](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/fix-cloud-issues-in-iac.md)
      * [Detect drift and manually created resources](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/README.md)
        * [Get started with Snyk IaC Describe on AWS](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/get-started-with-snyk-iac-describe-on-aws.md)
        * [Configure cloud providers](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/README.md)
          * [Configure AWS provider](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-aws-provider.md)
          * [Configure Azure provider](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-azure-provider.md)
          * [Configure GitHub provider](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-github-provider.md)
          * [Configure Google provider](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-google-provider.md)
        * [Supported resources](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/README.md)
          * [AWS resources](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/aws-resources.md)
          * [Azure resources](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/azure-resources.md)
          * [GitHub resources](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/github-resources.md)
          * [Google resources](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/supported-resources/google-resources.md)
        * [IaC describe command examples](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/iac-describe-command-examples.md)
        * [Filter rules](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/filter-rules.md)
        * [Ignore resources for drift](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/ignore-resources-for-drift.md)
        * [IAC sources usage](scan-applications/scan-infrastructure/iac+-code-to-cloud-capabilities/detect-drift-and-manually-created-resources/iac-sources-usage.md)
    * [View IaC+ and cloud compliance reporting](scan-applications/scan-infrastructure/view-iac+-and-cloud-compliance-reporting.md)
    * [View Snyk IaC issue reports](scan-applications/scan-infrastructure/view-snyk-iac-issue-reports.md)
    * [Snyk IaC integrations](scan-applications/scan-infrastructure/snyk-iac-integrations/README.md)
      * [Snyk IaC with Broker for self-hosted Git](scan-applications/scan-infrastructure/snyk-iac-integrations/snyk-iac-with-broker-for-self-hosted-git.md)
      * [Jira integration for Snyk IaC](scan-applications/scan-infrastructure/snyk-iac-integrations/jira-integration-for-iac.md)
