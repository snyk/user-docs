...
* [Scan applications](scan-applications/README.md)
  ...
  * [Start scanning](scan-applications/start-scanning/README.md)
    ...
    * [Scan code](scan-applications/start-scanning/scan-code/README.md)
      * [Start using Snyk Code](scan-applications/start-scanning/scan-code/getting-started-with-snyk-code/README.md)
        * [Prerequisites for Snyk Code](scan-applications/start-scanning/scan-code/getting-started-with-snyk-code/prerequisites-for-snyk-code.md)
        * [Activating Snyk Code using the Web UI](scan-applications/start-scanning/scan-code/getting-started-with-snyk-code/activating-snyk-code-using-the-web-ui.md)
        * [Enabling the Snyk Code option in an Organization](scan-applications/start-scanning/scan-code/getting-started-with-snyk-code/enabling-the-snyk-code-option-in-an-organization.md)
        * [Integrating your Source Control System with your Snyk account](scan-applications/start-scanning/scan-code/getting-started-with-snyk-code/integrating-your-source-control-system-with-your-snyk-account.md)
        * [Importing repositories for Snyk Code testing](scan-applications/start-scanning/scan-code/getting-started-with-snyk-code/importing-repositories-for-snyk-code-testing.md)
  ...
  * [Snyk Container](scan-applications/snyk-container/README.md)
    ...
    * [Integrate with Kubernetes](scan-containers/kubernetes-integration/README.md)
