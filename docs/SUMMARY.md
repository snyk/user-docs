...
* [Manage issues](features/manage-issues/README.md)
  * [Starting to fix vulnerabilities](features/manage-issues/starting-to-fix-vulnerabilities/README.md)
    * [Fix your vulnerabilities](features/manage-issues/starting-to-fix-vulnerabilities/fix-your-vulnerabilities.md)
    * [Upgrading package versions to fix vulnerabilities](features/manage-issues/starting-to-fix-vulnerabilities/upgrading-package-versions-fix-vulnerabilities.md)
    * [Snyk patches to fix vulnerabilities](features/manage-issues/starting-to-fix-vulnerabilities/snyk-patches-to-fix-vulnerabilities.md)
    * [Snyk Vulnerability Database](features/manage-issues/starting-to-fix-vulnerabilities/using-the-snyk-vulnerability-database.md)
    * [Fixed in version vs. fixable attribute in vulnerabilities](features/manage-issues/starting-to-fix-vulnerabilities/fixed-in-version-vs.-fixable-attribute-in-vulnerabilities.md)
    * [Why can't I open a Pull Request/Merge Request for issues found by Snyk?](features/manage-issues/starting-to-fix-vulnerabilities/why-cant-i-open-a-pull-request-merge-request-for-issues-found-by-snyk.md)
    * [What languages do we support Fix Pull Requests or Merge Requests?](features/manage-issues/starting-to-fix-vulnerabilities/what-languages-do-we-support-fix-pull-requests-or-merge-requests.md)
  * [Prioritizing and managing issues](features/manage-issues/issue-management/README.md)
    * [Severity levels](features/manage-issues/issue-management/severity-levels.md)
    * [Priority Score](features/manage-issues/issue-management/priority-score.md)
    * [Ignore issues](features/manage-issues/issue-management/ignore-issues.md)
    * [Evaluating and prioritizing vulnerabilities](features/manage-issues/issue-management/evaluating-and-prioritizing-vulnerabilities.md)
    * [Triaging issues](features/manage-issues/issue-management/triaging-issues.md)
    * [Reachable vulnerabilities](features/manage-issues/issue-management/reachable-vulnerabilities.md)
    * [Vulnerabilities with Social Trends](features/manage-issues/issue-management/prioritize-by-social-trends.md)
  * [Policies](features/manage-issues/policies/README.md)
    * [Shared Policies Overview](features/manage-issues/policies/shared-policies-overview.md)
    * [Creating and editing policies](features/manage-issues/policies/creating-and-editing-policies.md)
    * [Assign a policy to project attributes](features/manage-issues/policies/assign-a-policy-to-project-attributes.md)
    * [Assign a policy to organizations](features/manage-issues/policies/assign-a-policy-to-organizations.md)
  * [Security policies](features/manage-issues/security-policies/README.md)
    * [Getting started with security policies](features/manage-issues/security-policies/getting-started-with-security-policies.md)
    * [How to create a security policy and set rules](features/manage-issues/security-policies/how-to-create-a-security-policy-and-set-rules.md)
    * [Security policies: Conditions](features/manage-issues/security-policies/security-policies-conditions.md)
    * [Security policies: Actions](features/manage-issues/security-policies/security-policies-actions.md)
    * [Security policies: What collaborators see](features/manage-issues/security-policies/security-policies-what-collaborators-see.md)
...
* [User and Group management](features/user-and-group-management/README.md)
  ...
  * [Setting up Single Sign-On (SSO) for authentication](features/user-and-group-management/setting-up-sso-for-authentication/README.md)
    ...
    * [Self Serve Single Sign-On (SSO)](features/user-and-group-management/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/README.md)
      * [Example: Okta SAML Application](features/user-and-group-management/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/self-serve-single-sign-on-sso.md)
      * [Example: Azure AD Enterprise Application](features/user-and-group-management/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/example-azure-ad-enterprise-application.md)
      * [Example: Google Workspace](features/user-and-group-management/setting-up-sso-for-authentication/self-serve-single-sign-on-sso/example-google-workspace.md)
    * [Custom Mapping Option](features/user-and-group-management/setting-up-sso-for-authentication/custom-mapping-option/README.md)
...
## Snyk processes <a href="#Snyk-processes" id="Snyk-processes"></a>

* [Snyk Partner workshops](Snyk-processes/getting-started/README.md)
  * [Atlassian Integrations](Snyk-processes/getting-started/atlassian-integrations/README.md)
    * [Snyk - Atlassian Bitbucket Integration](Snyk-processes/getting-started/atlassian-integrations/snyk-atlassian-bitbucket-integration.md)
    * [Atlassian Bitbucket account](Snyk-processes/getting-started/atlassian-integrations/atlassian-bitbucket-account.md)
    * [Atlassian Bitbucket App Password](Snyk-processes/getting-started/atlassian-integrations/atlassian-bitbucket-app-password.md)
    * [Atlassian Bitbucket Pipeline Variables](Snyk-processes/getting-started/atlassian-integrations/atlassian-bitbucket-pipeline-variables.md)
    * [Atlassian Jira](Snyk-processes/getting-started/atlassian-integrations/atlassian-jira.md)
    * [Atlassian](Snyk-processes/getting-started/atlassian-integrations/atlassian/README.md)
      * [DevOps Pipeline with Bitbucket Cloud and Kubernetes](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/README.md)
        * [Prerequisites](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/prerequisites.md)
        * [Module 1 - Scanning and monitoring source code](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-1-scanning-and-monitoring-source-code/README.md)
          * [Initial Setup](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-1-scanning-and-monitoring-source-code/initial-setup.md)
          * [Add a Bitbucket Repository](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-1-scanning-and-monitoring-source-code/add-a-bitbucket-repository.md)
          * [Enable integrations](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-1-scanning-and-monitoring-source-code/enable-integrations.md)
          * [Review Application Scan Results](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-1-scanning-and-monitoring-source-code/review-application-scan-results.md)
          * [Create a Jira Ticket](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-1-scanning-and-monitoring-source-code/create-a-jira-ticket.md)
          * [Create a Pull Request](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-1-scanning-and-monitoring-source-code/create-a-pull-request.md)
        * [Module 2 - Bitbucket Pipelines](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-2-bitbucket-pipelines/README.md)
          * [Initial Setup](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-2-bitbucket-pipelines/initial-setup.md)
          * [Configure AWS ECR](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-2-bitbucket-pipelines/configure-aws-ecr.md)
          * [Enable Pipeline Operations](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-2-bitbucket-pipelines/enable-pipeline-operations.md)
          * [Add Bitbucket Repository Variables](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-2-bitbucket-pipelines/add-bitbucket-repository-variables.md)
          * [Application Scanning in your pipeline](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-2-bitbucket-pipelines/application-scanning-in-your-pipeline.md)
        * [Module 3 - Exploiting Tomcat RCE on Kubernetes](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-3-exploiting-tomcat-rce-on-kubernetes/README.md)
          * [Initial Setup](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-3-exploiting-tomcat-rce-on-kubernetes/initial-setup.md)
          * [RCE Vulnerability](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/module-3-exploiting-tomcat-rce-on-kubernetes/rce-vulnerability.md)
        * [Conclusion](Snyk-processes/getting-started/atlassian-integrations/atlassian/devops-pipeline-with-bitbucket-cloud-and-kubernetes/conclusion.md)
      * [DevSecOps with Bitbucket Cloud](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/README.md)
        * [Prerequisites](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/prerequisites.md)
        * [Getting Started](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/getting-started/README.md)
          * [Snyk Account](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/getting-started/snyk-account.md)
          * [Atlassian Account](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/getting-started/atlassian-account.md)
          * [Configure Environment](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/getting-started/configure-environment.md)
        * [Module 1](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-1/README.md)
          * [Bitbucket Configuration](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-1/bitbucket-configuration.md)
          * [Snyk Configuration](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-1/snyk-configuration.md)
          * [Application Scanning](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-1/application-scanning.md)
        * [Module 2](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-2/README.md)
          * [Amazon ECR](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-2/amazon-ecr.md)
          * [Container Scanning](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-2/container-scanning.md)
        * [Module 3](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-3/README.md)
          * [Snyk controller](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-3/snyk-controller.md)
          * [Deploying your app](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-3/deploying-your-app.md)
          * [Adding Kubernetes workloads](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-3/adding-kubernetes-workloads.md)
        * [Module 4](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-4/README.md)
          * [Fix Pull Requests](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-4/fix-pull-requests.md)
          * [Fix Dockerfile](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-4/fix-dockerfile.md)
          * [Fix Configuration](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/module-4/fix-configuration.md)
        * [Cleanup](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/cleanup.md)
        * [Conclusion](Snyk-processes/getting-started/atlassian-integrations/atlassian/devsecops-bitbucket-cloud/conclusion.md)
      * [Opsgenie](Snyk-processes/getting-started/atlassian-integrations/atlassian/opsgenie/README.md)
        * [Getting Started](Snyk-processes/getting-started/atlassian-integrations/atlassian/opsgenie/getting-started.md)
        * [Install integration](Snyk-processes/getting-started/atlassian-integrations/atlassian/opsgenie/install-integration.md)
        * [Postman](Snyk-processes/getting-started/atlassian-integrations/atlassian/opsgenie/postman.md)
        * [Alerts](Snyk-processes/getting-started/atlassian-integrations/atlassian/opsgenie/alerts.md)
      * [Snyk Security for Bitbucket Cloud](Snyk-processes/getting-started/atlassian-integrations/atlassian/snyk-security-for-bitbucket-cloud/README.md)
        * [Getting Started](Snyk-processes/getting-started/atlassian-integrations/atlassian/snyk-security-for-bitbucket-cloud/getting-started.md)
        * [Connecting](Snyk-processes/getting-started/atlassian-integrations/atlassian/snyk-security-for-bitbucket-cloud/connecting.md)
        * [App Password](Snyk-processes/getting-started/atlassian-integrations/atlassian/snyk-security-for-bitbucket-cloud/app-password.md)
        * [Scanning](Snyk-processes/getting-started/atlassian-integrations/atlassian/snyk-security-for-bitbucket-cloud/scanning.md)
        * [Findings](Snyk-processes/getting-started/atlassian-integrations/atlassian/snyk-security-for-bitbucket-cloud/findings.md)
      * [Broker for Bitbucket Data Center](Snyk-processes/getting-started/atlassian-integrations/atlassian/broker-for-bitbucket-data-center/README.md)
        * [Prerequisites](Snyk-processes/getting-started/atlassian-integrations/atlassian/broker-for-bitbucket-data-center/prerequisites.md)
        * [Importing Projects into Snyk](Snyk-processes/getting-started/atlassian-integrations/atlassian/broker-for-bitbucket-data-center/importing-projects-into-snyk.md)
        * [Conclusion](Snyk-processes/getting-started/atlassian-integrations/atlassian/broker-for-bitbucket-data-center/conclusion.md)
  * [AWS Integrations](Snyk-processes/getting-started/aws-integrations/README.md)
    * [AWS Account](Snyk-processes/getting-started/aws-integrations/aws-account.md)
    * [AWS CLI](Snyk-processes/getting-started/aws-integrations/aws-cli.md)
    * [AWS ECR](Snyk-processes/getting-started/aws-integrations/aws-ecr.md)
    * [AWS EKS](Snyk-processes/getting-started/aws-integrations/aws-eks.md)
    * [Amazon Web Services](Snyk-processes/getting-started/aws-integrations/amazon-web-services/README.md)
      * [AWS CodePipeline](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-codepipeline/README.md)
        * [Getting Started](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-codepipeline/getting-started.md)
        * [Editing the pipeline](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-codepipeline/editing-the-pipeline.md)
        * [Connect to Snyk](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-codepipeline/connect-to-snyk.md)
        * [Scan your code](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-codepipeline/scan-your-code.md)
      * [AWS Code Suite](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/README.md)
        * [Create an AWS account](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/create-an-aws-account.md)
        * [Creating your environment](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/creating-your-environment/README.md)
          * [Setup basic services](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/creating-your-environment/setup-basic-services.md)
          * [Build & push to repo](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/creating-your-environment/build-and-push-to-repo.md)
          * [Deploy ECS Fargate service](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/creating-your-environment/deploy-ecs-fargate-service.md)
          * [Deploy CI/CD pipeline](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/creating-your-environment/deploy-ci-cd-pipeline.md)
        * [Snyk Security](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/snyk-security/README.md)
          * [Create account and obtain a token](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/snyk-security/create-account-and-obtain-a-token.md)
          * [Setup](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/snyk-security/setup.md)
          * [Exercise - Testing](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/snyk-security/exercise-testing.md)
          * [Exercise - Fixing the Vulnerability](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/snyk-security/exercise-fixing-the-vulnerability.md)
          * [Viewing Reporting](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/snyk-security/viewing-reporting.md)
        * [Conclusion](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/conclusion.md)
        * [Cleanup](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-code-suite/cleanup.md)
      * [AWS Quick start guide](Snyk-processes/getting-started/aws-integrations/amazon-web-services/aws-quick-start-guide.md)
  * [Snyk Integrations](Snyk-processes/getting-started/snyk-integrations/README.md)
    * [Snyk Account](Snyk-processes/getting-started/snyk-integrations/snyk-account.md)
    * [CircleCI](Snyk-processes/getting-started/snyk-integrations/circleci/README.md)
      * [Scan Terraform with the Snyk Orb](Snyk-processes/getting-started/snyk-integrations/circleci/scan-terraform-with-the-snyk-orb/README.md)
        * [Add the Snyk Orb to your CircleCI Config](Snyk-processes/getting-started/snyk-integrations/circleci/scan-terraform-with-the-snyk-orb/add-the-snyk-orb-to-your-circleci-config.md)
        * [Adjusting Snyk IAC Scan parameters](Snyk-processes/getting-started/snyk-integrations/circleci/scan-terraform-with-the-snyk-orb/adjusting-snyk-iac-scan-parameters.md)
      * [Securing Kubernetes Workloads on AWS](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/README.md)
        * [Getting started](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/getting-started.md)
        * [Create EKS cluster](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/create-eks-cluster.md)
        * [CircleCI Configuration](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/circleci-configuration.md)
        * [config.yml](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/config.yml/README.md)
          * [Testing the application](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/config.yml/testing-the-application.md)
          * [Application scanning](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/config.yml/application-scanning.md)
          * [Container image scanning](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/config.yml/container-image-scanning.md)
          * [Push image to registry](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/config.yml/push-image-to-registry.md)
          * [Deploy the application](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/config.yml/deploy-the-application.md)
        * [Kubernetes manifests](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/kubernetes-manifests.md)
        * [CircleCI Project](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/circleci-project.md)
        * [Test deployment](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/test-deployment.md)
        * [Interpret scan results](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/interpret-scan-results/README.md)
          * [Correlating results](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/interpret-scan-results/correlating-results.md)
          * [Summary](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/interpret-scan-results/summary.md)
        * [Exploits](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/exploits/README.md)
          * [Example 1](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/exploits/example-1.md)
          * [Example 2](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/exploits/example-2.md)
          * [Example 3](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/exploits/example-3.md)
        * [Conclusion](Snyk-processes/getting-started/snyk-integrations/circleci/securing-kubernetes-workloads-on-aws/conclusion.md)
    * [Docker](Snyk-processes/getting-started/snyk-integrations/docker/README.md)
      * [Scan with the Docker CLI](Snyk-processes/getting-started/snyk-integrations/docker/scanning-with-the-docker-cli.md)
      * [Build Secure Containers with Docker and Snyk](Snyk-processes/getting-started/snyk-integrations/docker/lab-build-secure-containers-with-docker-and-snyk/README.md)
        * [Clone and run the sample application](Snyk-processes/getting-started/snyk-integrations/docker/lab-build-secure-containers-with-docker-and-snyk/clone-and-run-the-sample-application.md)
        * [Set up a container delivery pipeline with vulnerability scanning](Snyk-processes/getting-started/snyk-integrations/docker/lab-build-secure-containers-with-docker-and-snyk/set-up-a-container-delivery-pipeline-with-vulnerability-scanning.md)
        * [Select the most secure base image available](Snyk-processes/getting-started/snyk-integrations/docker/lab-build-secure-containers-with-docker-and-snyk/select-the-most-secure-base-image-available.md)
        * [Upgrade or patch vulnerable application dependencies](Snyk-processes/getting-started/snyk-integrations/docker/lab-build-secure-containers-with-docker-and-snyk/upgrade-or-patch-vulnerable-application-dependencies.md)
        * [Ensure deployment manifests are free from misconfiguration](Snyk-processes/getting-started/snyk-integrations/docker/lab-build-secure-containers-with-docker-and-snyk/ensure-deployment-manifests-are-free-from-misconfiguration.md)
        * [Recap & Next Steps](Snyk-processes/getting-started/snyk-integrations/docker/lab-build-secure-containers-with-docker-and-snyk/recap-and-next-steps.md)
    * [Dynatrace](Snyk-processes/getting-started/snyk-integrations/dynatrace/README.md)
      * [Secure Kubernetes](Snyk-processes/getting-started/snyk-integrations/dynatrace/secure-kubernetes/README.md)
        * [Deploy Goof Sample App](Snyk-processes/getting-started/snyk-integrations/dynatrace/secure-kubernetes/deploy-goof-sample-app.md)
        * [Deploy OneAgent](Snyk-processes/getting-started/snyk-integrations/dynatrace/secure-kubernetes/deploy-oneagent.md)
        * [Deploy Snyk Monitor](Snyk-processes/getting-started/snyk-integrations/dynatrace/secure-kubernetes/deploy-snyk-monitor.md)
        * [Findings Reports](Snyk-processes/getting-started/snyk-integrations/dynatrace/secure-kubernetes/findings-reports.md)
    * [GCP](Snyk-processes/getting-started/snyk-integrations/gcp/README.md)
      * [Secure Kubernetes workloads on GKE Autopilot](Snyk-processes/getting-started/snyk-integrations/gcp/secure-kubernetes-workloads-on-gke-autopilot/README.md)
        * [Provision your cluster](Snyk-processes/getting-started/snyk-integrations/gcp/secure-kubernetes-workloads-on-gke-autopilot/provision-your-cluster.md)
        * [Deploy a sample application](Snyk-processes/getting-started/snyk-integrations/gcp/secure-kubernetes-workloads-on-gke-autopilot/deploy-a-sample-application.md)
        * [Deploy Snyk](Snyk-processes/getting-started/snyk-integrations/gcp/secure-kubernetes-workloads-on-gke-autopilot/deploy-snyk.md)
        * [Security findings](Snyk-processes/getting-started/snyk-integrations/gcp/secure-kubernetes-workloads-on-gke-autopilot/security-findings.md)
        * [Summary](Snyk-processes/getting-started/snyk-integrations/gcp/secure-kubernetes-workloads-on-gke-autopilot/summary.md)
    * [GitHub](Snyk-processes/getting-started/snyk-integrations/github/README.md)
      * [Securing a Toolchain with Snyk and GitHub](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/README.md)
        * [Part 1: Open Source](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-1-open-source/README.md)
          * [Section 1: Find Vulnerabilities](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-1-open-source/section-1-find-vulnerabilities.md)
          * [Section 2: Stop the Bleeding](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-1-open-source/section-2-stop-the-bleeding.md)
          * [Section 3: Fix Vulnerabilities](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-1-open-source/section-3-fix-vulnerabilities.md)
        * [Part 2: Container](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-2-container/README.md)
          * [Section 4: Containerize your app](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-2-container/section-1-containerize-your-app.md)
          * [Section 5: Explore the Container Scan results](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-2-container/section-2-explore-the-container-scan-results.md)
          * [Section 6: Secure your Container Image](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-2-container/section-3-secure-your-container-image.md)
        * [Part 3: Infrastructure as Code](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-3-infrastructure-as-code/README.md)
          * [Section 7: Create Deployment Manifests](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-3-infrastructure-as-code/section-7-create-deployment-manifests.md)
          * [Section 8: Review the IaC Scan Results](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-3-infrastructure-as-code/section-8-review-the-iac-scan-results.md)
          * [Section 9: Unblock the PROD Deployment](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/part-3-infrastructure-as-code/section-9-unblock-the-prod-deployment.md)
        * [Recap & Next Steps](Snyk-processes/getting-started/snyk-integrations/github/securing-a-toolchain-with-snyk-and-github/recap-and-next-steps.md)
    * [Microsoft Azure](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/README.md)
      * [Getting started](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/getting-started.md)
      * [Sign up for Snyk](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/setup-the-snyk-account.md)
      * [Securing AKS](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-aks/README.md)
        * [Provision Azure services](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-aks/provision-azure-services.md)
        * [Deploy an application](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-aks/deploy-an-application.md)
        * [Configure the Kubernetes integration](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-aks/configure-the-kubernetes-integration.md)
        * [Add Kubernetes workloads](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-aks/add-kubernetes-workloads.md)
        * [Interpret scan results](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-aks/interpret-scan-results.md)
        * [Fix issues](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-aks/fix-issues.md)
      * [Securing ACR](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-acr/README.md)
        * [Provision Azure services](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-acr/provision-azure-services.md)
        * [Building container images](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-acr/building-container-images.md)
        * [Configure the ACR integration](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-acr/configure-the-acr-integration.md)
        * [Scan ACR images](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-acr/scan-acr-images.md)
        * [Interpret scan results](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-acr/interpret-scan-results.md)
        * [Fix issues](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-acr/fix-issues.md)
      * [Securing Azure Repos](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-repos/README.md)
        * [Getting started](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-repos/getting-started.md)
        * [Provision Azure services](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-repos/provision-azure-services.md)
        * [Working with repos](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-repos/working-with-repos.md)
        * [Configure the Azure Repos integration](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-repos/configure-the-azure-repos-integration.md)
        * [Add Azure Repos repositories](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-repos/add-azure-repos-repositories.md)
        * [Next steps](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-repos/next-steps.md)
      * [Securing Azure Pipelines](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-pipelines/README.md)
        * [Getting started](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-pipelines/getting-started.md)
        * [Configuration](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-pipelines/configuration.md)
        * [YAML pipelines](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-pipelines/yaml-pipelines.md)
        * [Scanning](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-pipelines/scanning.md)
        * [Results](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/securing-azure-pipelines/results.md)
      * [Notifications in Microsoft Teams](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/README.md)
        * [Configure Zap](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/configure-zap/README.md)
          * [Catch Raw Hook](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/configure-zap/catch-raw-hook.md)
          * [Validate Payload](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/configure-zap/validate-payload.md)
          * [Parse Payload](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/configure-zap/parse-payload.md)
          * [Format Issues](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/configure-zap/format-issues.md)
          * [Filter](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/configure-zap/filter.md)
          * [Send Message](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/configure-zap/send-message.md)
        * [Notifications](Snyk-processes/getting-started/snyk-integrations/microsoft-azure/notifications-in-microsoft-teams/notifications.md)
    * [Oracle Cloud Infrastructure](Snyk-processes/getting-started/snyk-integrations/oracle-cloud-infrastructure/README.md)
      * [Secure Kubernetes workloads on OKE](Snyk-processes/getting-started/snyk-integrations/oracle-cloud-infrastructure/secure-kubernetes-workloads-on-oke/README.md)
        * [Accessing your cluster](Snyk-processes/getting-started/snyk-integrations/oracle-cloud-infrastructure/secure-kubernetes-workloads-on-oke/accessing-your-cluster.md)
        * [Deploy a sample application](Snyk-processes/getting-started/snyk-integrations/oracle-cloud-infrastructure/secure-kubernetes-workloads-on-oke/deploy-a-sample-application.md)
        * [Deploy Snyk](Snyk-processes/getting-started/snyk-integrations/oracle-cloud-infrastructure/secure-kubernetes-workloads-on-oke/deploy-snyk.md)
        * [Security findings](Snyk-processes/getting-started/snyk-integrations/oracle-cloud-infrastructure/secure-kubernetes-workloads-on-oke/security-findings.md)
        * [Summary](Snyk-processes/getting-started/snyk-integrations/oracle-cloud-infrastructure/secure-kubernetes-workloads-on-oke/summary.md)
    * [Red Hat](Snyk-processes/getting-started/snyk-integrations/red-hat/README.md)
      * [Getting Started](Snyk-processes/getting-started/snyk-integrations/red-hat/getting-started.md)
      * [Module 1](Snyk-processes/getting-started/snyk-integrations/red-hat/module-1.md)
      * [Module 2](Snyk-processes/getting-started/snyk-integrations/red-hat/module-2.md)
      * [Module 3](Snyk-processes/getting-started/snyk-integrations/red-hat/module-3.md)
      * [Conclusion](Snyk-processes/getting-started/snyk-integrations/red-hat/conclusion.md)
    * [SpringOne](Snyk-processes/getting-started/snyk-integrations/springone-workshop/README.md)
      * [Workshop Overview](Snyk-processes/getting-started/snyk-integrations/springone-workshop/workshop-environment.md)
      * [Create Github Repository](Snyk-processes/getting-started/snyk-integrations/springone-workshop/create-github-repository/README.md)
        * [Create Spring-Petclinic Repo](Snyk-processes/getting-started/snyk-integrations/springone-workshop/create-github-repository/create-spring-petclinic-repo.md)
      * [Configure Snyk for DevSecOps](Snyk-processes/getting-started/snyk-integrations/springone-workshop/configure-snyk-for-devops/README.md)
        * [Create a Snyk organization](Snyk-processes/getting-started/snyk-integrations/springone-workshop/configure-snyk-for-devops/create-snyk-organization.md)
        * [Configure GitHub integration](Snyk-processes/getting-started/snyk-integrations/springone-workshop/configure-snyk-for-devops/configure-snyk-and-github.md)
        * [Configure Docker Hub integration](Snyk-processes/getting-started/snyk-integrations/springone-workshop/configure-snyk-for-devops/configure-snyk-and-docker-hub.md)
      * [Developer Environment and Snyk](Snyk-processes/getting-started/snyk-integrations/springone-workshop/developer-environment-and-snyk/README.md)
        * [Clone SPC Repository](Snyk-processes/getting-started/snyk-integrations/springone-workshop/developer-environment-and-snyk/clone-spc-repository.md)
        * [Authenticate with Snyk](Snyk-processes/getting-started/snyk-integrations/springone-workshop/developer-environment-and-snyk/snyk-authenticate-using-cli.md)
        * [Snyk Test using CLI](Snyk-processes/getting-started/snyk-integrations/springone-workshop/developer-environment-and-snyk/snyk-test-using-cli.md)
        * [Snyk test using Maven](Snyk-processes/getting-started/snyk-integrations/springone-workshop/developer-environment-and-snyk/snyk-test-using-maven.md)
        * [Validate Kubernetes files with Snyk](Snyk-processes/getting-started/snyk-integrations/springone-workshop/developer-environment-and-snyk/deploy-spc-to-kubernetes.md)
      * [CI/CD Pipeline](Snyk-processes/getting-started/snyk-integrations/springone-workshop/ci-cd-pipeline/README.md)
        * [Enable GitHub Actions](Snyk-processes/getting-started/snyk-integrations/springone-workshop/ci-cd-pipeline/enable-github-actions.md)
        * [Add secrets](Snyk-processes/getting-started/snyk-integrations/springone-workshop/ci-cd-pipeline/configure-the-ci-cd-pipeline.md)
        * [Configure env vars and commit changes](Snyk-processes/getting-started/snyk-integrations/springone-workshop/ci-cd-pipeline/configure-env-vars-and-commit-changes.md)
        * [Review CI/CD results](Snyk-processes/getting-started/snyk-integrations/springone-workshop/ci-cd-pipeline/review-snyk-scan-results.md)
      * [Snyk Open-Source (SCA)](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-oss-for-developers/README.md)
        * [Import SPC into Snyk UI](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-oss-for-developers/import-spc-into-snyk-ui.md)
        * [Review Project Issues](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-oss-for-developers/review-project-issues.md)
        * [Review Project Dependency Tree](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-oss-for-developers/review-dependency-tree.md)
        * [Project fix advice](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-oss-for-developers/project-remediation-advice.md)
        * [Snyk checks in GitHub](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-oss-for-developers/snyk-testing.md)
      * [Snyk CI/CD](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-ci-cd/README.md)
        * [Review Imported CI/CD Scans in Snyk UI](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-ci-cd/review-imported-ci-cd-scans-in-snyk-ui.md)
      * [Snyk Containers](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-container-for-developers/README.md)
        * [Import SPC Container Image into Snyk UI](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-container-for-developers/import-spc-container-image-into-synk-ui.md)
        * [Dockerfile fix advice](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-container-for-developers/dockerfile-remediation-advice.md)
      * [Snyk Infrastructure as Code (IaC)](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-iac-for-developers/README.md)
        * [Review IaC artifacts in Snyk UI](Snyk-processes/getting-started/snyk-integrations/springone-workshop/snyk-iac-for-developers/review-iac-artifacts-in-snyk-ui.md)
      * [Workshop Wrap Up](Snyk-processes/getting-started/snyk-integrations/springone-workshop/additional-resources-and-next-steps.md)
