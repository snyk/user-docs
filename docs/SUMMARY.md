...
* [Integrate with Snyk](integrations/README.md)
  ...
  * [Cloud platforms](integrations/cloud-platforms/README.md)
    * [Getting started with Snyk Cloud: AWS](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/README.md)
      * [Snyk Cloud for AWS: Web UI](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-web-ui/README.md)
        * [Step 1: Download IAM role IaC template (Web UI)](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-web-ui/step-1-download-iam-role-iac-template-web-ui.md)
        * [Step 2: Create the Snyk IAM role](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-web-ui/step-2-create-the-snyk-iam-role.md)
        * [Step 3: Create and scan a Snyk Cloud Environment (Web UI)](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-web-ui/step-3-create-and-scan-a-snyk-cloud-environment-web-ui.md)
      * [Snyk Cloud for AWS: API](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-api/README.md)
        * [Step 1: Download IAM role IaC template (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-api/step-1-download-iam-role-iac-template.md)
        * [Step 2: Create the Snyk IAM role (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-api/step-2-create-the-snyk-iam-role-api.md)
        * [Step 3: Create and scan a Snyk Cloud Environment (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-aws/snyk-cloud-for-aws-api/step-3-create-and-scan-a-snyk-cloud-environment.md)
    * [Getting started with Snyk Cloud: Azure](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/README.md)
      * [Snyk Cloud for Azure: Web UI](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-web-ui/README.md)
        * [Step 1: Download Azure app registration IaC template or script (Web UI)](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-web-ui/step-1-download-azure-app-registration-iac-template-or-script-web-ui.md)
        * [Step 2: Create the Azure AD app registration](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-web-ui/step-2-create-the-azure-ad-app-registration.md)
        * [Step 3: Create and scan a Snyk Cloud Environment for Azure (Web UI)](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-web-ui/step-3-create-and-scan-a-snyk-cloud-environment-for-azure-web-ui.md)
      * [Snyk Cloud for Azure: API](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-api/README.md)
        * [Step 1: Download Azure app registration IaC template or script (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-api/step-1-download-azure-app-registration-iac-template-or-script-api.md)
        * [Step 2: Create the Azure AD app registration (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-api/step-2-create-the-azure-ad-app-registration-api.md)
        * [Step 3: Create and scan a Snyk Cloud Environment for Azure (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-azure/snyk-cloud-for-azure-api/step-3-create-and-scan-a-snyk-cloud-environment-for-azure-api.md)
    * [Getting started with Snyk Cloud: Google](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/README.md)
      * [Snyk Cloud for Google: Web UI](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-web-ui/README.md)
        * [Step 1: Download service account IaC template (Web UI)](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-web-ui/step-1-download-service-account-iac-template-web-ui.md)
        * [Step 2: Create the Google service account (Web UI)](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-web-ui/step-2-create-the-google-service-account-api.md)
        * [Step 3: Create and scan a Snyk Cloud Environment for Google (Web UI)](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-web-ui/step-3-create-and-scan-a-snyk-cloud-environment-for-google-web-ui.md)
      * [Snyk Cloud for Google: API](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-api/README.md)
        * [Step 1: Download service account IaC template (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-api/step-1-download-service-account-iac-template-api.md)
        * [Step 2: Create the Google service account (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-api/step-2-create-the-google-service-account-api.md)
        * [Step 3: Create and scan a Snyk Cloud Environment for Google (API)](integrations/cloud-platforms/getting-started-with-snyk-cloud-google/snyk-cloud-for-google-api/step-3-create-and-scan-a-snyk-cloud-environment-for-google-api.md)
