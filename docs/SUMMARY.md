...
* [Snyk admin](snyk-admin/README.md)
  ...
  * [Manage permissions and roles](snyk-admin/manage-permissions-and-roles/README.md)
    ...
    * [Member Roles](snyk-admin/manage-permissions-and-roles/member-roles.md)
    * [Update Member Roles via API](snyk-admin/manage-permissions-and-roles/update-member-roles-via-api.md)
