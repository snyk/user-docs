...
* [Manage issues](manage-issues/README.md)
  ...
  * [Security policies](manage-issues/security-policies/README.md)
    ...
    * [Security policy conditions](manage-issues/security-policies/security-policy-conditions.md)
...
* [Snyk admin](snyk-admin/README.md)
  ...
  * [Snyk Broker](snyk-admin/snyk-broker/README.md)
    ...
    * [Snyk Broker - Client integration setups](snyk-admin/snyk-broker/snyk-broker-set-up-examples/README.md)
      ...
      * [Set up Snyk Broker with Artifactory](snyk-admin/snyk-broker/snyk-broker-set-up-examples/set-up-snyk-broker-with-artifactory.md)
      * [Set up Snyk Broker with Jira](snyk-admin/snyk-broker/snyk-broker-set-up-examples/setup-broker-with-jira.md)
      * [Set up Snyk Broker with Nexus3](snyk-admin/snyk-broker/snyk-broker-set-up-examples/set-up-snyk-broker-with-nexus3.md)
