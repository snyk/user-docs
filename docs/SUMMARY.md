...
* [Scan applications](scan-applications/README.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Start using Snyk Code](scan-applications/snyk-code/start-using-snyk-code/README.md)
      * [Prerequisites for Snyk Code](scan-applications/snyk-code/start-using-snyk-code/prerequisites-for-snyk-code.md)
      * [Activating Snyk Code using the Web UI](scan-applications/snyk-code/start-using-snyk-code/activating-snyk-code-using-the-web-ui.md)
      * [Enabling the Snyk Code option in an Organization](scan-applications/snyk-code/start-using-snyk-code/enabling-the-snyk-code-option-in-an-organization.md)
      * [Integrating your Source Control System with your Snyk account](scan-applications/snyk-code/start-using-snyk-code/integrating-your-source-control-system-with-your-snyk-account.md)
      * [Importing repositories for Snyk Code testing](scan-applications/snyk-code/start-using-snyk-code/importing-repositories-for-snyk-code-testing.md)
