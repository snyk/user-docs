...
* [Snyk CLI](snyk-cli/README.md)
  ...
  * [Use Snyk Open Source from the CLI](snyk-cli/use-snyk-open-source-from-the-cli/README.md)
    * [Use options to customize the snyk test command](snyk-cli/use-snyk-open-source-from-the-cli/use-options-to-customize-the-snyk-test-command.md)
    ...
    * [Use Snyk Open Source from the CLI: example](snyk-cli/use-snyk-open-source-from-the-cli/integrate-snyk-into-your-workflow.md)
  * [Analyze code with the Snyk Code CLI](snyk-cli/analyze-code-with-the-snyk-code-cli/README.md)
    * [Set Snyk Organization for CLI tests](snyk-cli/analyze-code-with-the-snyk-code-cli/set-the-snyk-organization-for-the-cli-tests.md)
    * [Scan source code with Snyk Code CLI](snyk-cli/analyze-code-with-the-snyk-code-cli/testing-your-source-code-using-the-cli.md)
    * [Publish Snyk Code CLI results](snyk-cli/analyze-code-with-the-snyk-code-cli/publishing-cli-results-to-a-snyk-project-and-ignoring-cli-results.md)
    * [Exclude directories and files from Snyk Code CLI tests](snyk-cli/analyze-code-with-the-snyk-code-cli/excluding-directories-and-files-from-the-snyk-code-cli-test.md)
    * [View Snyk Code CLI results](snyk-cli/analyze-code-with-the-snyk-code-cli/working-with-the-snyk-code-cli-results.md)
  * [Use Snyk Container from the CLI](snyk-cli/use-snyk-container-from-the-cli/README.md)
    * [Scan and monitor images](snyk-cli/use-snyk-container-from-the-cli/scan-and-monitor-images.md)
    ...
    * [Advanced use of Snyk Container CLI](snyk-cli/use-snyk-container-from-the-cli/advanced-snyk-container-cli-usage.md)
