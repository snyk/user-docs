...
* [Snyk for IDEs](ide-tools/README.md)
  ...
  * [Building a Snyk IDE plugin](ide-tools/snyk-ide-plugins/README.md)
    * [Overview of IDE plugins](ide-tools/snyk-ide-plugins/overview.md)
    * [Snyk CLI for IDE plugins](ide-tools/snyk-ide-plugins/snyk-cli.md)
    * [Scanning with IDE plugins](ide-tools/snyk-ide-plugins/scanning.md)
    * [Dependencies and IDE plugins](ide-tools/snyk-ide-plugins/dependencies.md)
    * [Fix suggestions and IDE plugins](ide-tools/snyk-ide-plugins/fix-suggestions.md)
    * [Data mapping for IDE plugins](ide-tools/snyk-ide-plugins/data-mapping.md)
    * [IDE plugins FAQ](ide-tools/snyk-ide-plugins/faq.md)
    * [Help with IDE plugins](ide-tools/snyk-ide-plugins/help.md)
...
* [Snyk Code](products/snyk-code/README.md)
  ...
  * [Using Snyk Code via the CLI](products/snyk-code/cli-for-snyk-code/README.md)
    ...
    * [Working with the Snyk Code CLI results](products/snyk-code/cli-for-snyk-code/advanced-snyk-code-cli-usage/README.md)
      * [Displaying only discovered issues above a specific severity level](products/snyk-code/cli-for-snyk-code/advanced-snyk-code-cli-usage/displaying-only-discovered-issues-above-a-specific-severity-level.md)
      * [Outputting the test results to a JSON or SARIF format in the terminal](products/snyk-code/cli-for-snyk-code/advanced-snyk-code-cli-usage/outputting-the-test-results-to-a-json-or-sarif-format-in-the-terminal.md)
      * [Exporting the test results to a JSON or SARIF file](products/snyk-code/cli-for-snyk-code/advanced-snyk-code-cli-usage/exporting-the-test-results-to-a-json-or-sarif-file.md)
