...
* [Scan application code](scan-application-code/README.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Introduction to Snyk Code Local Engine](scan-application-code/snyk-code/introduction/README.md)
      * [CLI and IDEs with the Snyk Code Local Engine](scan-application-code/snyk-code/introduction/cli-and-ides-with-the-snyk-code-local-engine.md)
      * [Configure and deploy the Local Engine](scan-application-code/snyk-code/introduction/configure-and-deploy-local-engine.md)
