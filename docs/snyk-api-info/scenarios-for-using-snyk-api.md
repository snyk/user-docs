...
[Remove members from Groups and Orgs via API](../snyk-admin/manage-users-in-organizations-and-groups/remove-members-from-groups-and-orgs-using-the-snyk-api-v1.md)\
