...
* [List all projects with a vulnerability linked to a **CVE**](../installing-snyk-cli-as-a-binary-via-npm/list-all-projects-with-a-vulnerability-linked-to-a-cve.md)
