...
* If you're using self-hosted Artifactory, refer to our documentation for [Broker configuration](../../../integrate-with-snyk/snyk-broker/snyk-broker-container-registry-agent/).
