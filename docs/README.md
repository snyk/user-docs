...
<table data-header-hidden><thead><tr><th width="247"></th><th width="252"></th><th width="177"></th></tr></thead><tbody><tr><td><a href="snyk-scm-ide-and-ci-cd-integrations/git-repositories-scms-integrations-with-snyk/">Git repositories</a><br>Connect code repos to Snyk</td><td><a href="snyk-scm-ide-and-ci-cd-integrations/use-snyk-in-your-ide/">IDEs</a><br>Use Snyk in your dev environment</td><td><a href="snyk-scm-ide-and-ci-cd-integrations/snyk-ci-cd-integrations/">CI/CD</a><br>Add Snyk to your CI/CD pipeline</td></tr></tbody></table>
