...
For more details, see the [Visual Studio Code extension for Snyk Code](https://docs.snyk.io/integrations/ide-tools/visual-studio-code-extension-for-snyk-code-).
