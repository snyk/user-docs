...
Follow the link in the CLI output to see your issues in the Snyk Web UI. To learn more about the cloud issues view, see [View Cloud and Integrated IaC issues in the Snyk Web UI](../../scan-cloud-deployment/integrated-iac-with-cloud-context/snyk-cloud-issues/view-cloud-issues-in-the-snyk-web-ui.md).
...
4. Optional: View a list of all Integrated IaC and cloud context rules and adjust rule severity as needed. For more information, see [Managing Cloud and Integrated IaC rules](../../scan-cloud-deployment/integrated-iac-with-cloud-context/managing-snyk-cloud-rules.md).
