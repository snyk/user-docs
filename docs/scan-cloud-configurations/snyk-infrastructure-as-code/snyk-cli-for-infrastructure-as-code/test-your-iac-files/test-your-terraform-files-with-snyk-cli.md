...
For more information about variable processing, see [Terraform variables support](../../../../scan-cloud-deployment/snyk-infrastructure-as-code/scan-terraform-files/terraform-variables-support.md).
