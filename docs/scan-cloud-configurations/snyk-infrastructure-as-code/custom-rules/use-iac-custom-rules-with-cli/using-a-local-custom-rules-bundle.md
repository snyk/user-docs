...
The configuration scan results now include issues from both the default Snyk rules and your custom rules. See [Understanding the IaC CLI test results](../../../../scan-infrastructure/snyk-cli-for-iac/understanding-the-iac-cli-test-results/).
