...
<figure><img src="../../.gitbook/assets/image (207) (1).png" alt="Disable Detect configuration files"><figcaption><p>Disable Detect configuration files</p></figcaption></figure>
