...
To view all [Snyk cloud context](../../../scan-configurations/snyk-iac+/) environments in an Organization, navigate to your Organization **Settings (cog icon) > Cloud environments**.
