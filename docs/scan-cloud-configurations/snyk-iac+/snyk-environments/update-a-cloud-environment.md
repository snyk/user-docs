...
You can update the following attributes for a [cloud environment](../../../scan-infrastructure/introduction-to-iac+/key-concepts-for-iac+-and-cloud.md#environments):
