...
{% hint style="info" %}
This page describes a process using the Snyk Web UI. For details on using Integrated IaC with the Snyk CLI, see [Test your Integrated IaC files with Snyk CLI](../../scan-configurations/snyk-iac+/test-your-iac-files-with-the-snyk-cli.md).
{% endhint %}
