...
4. Optional: View a list of al IaC+ and cloud context rules and adjust rule severity as needed. For more information, see [Managing Cloud and IaC+ rules](managing-cloud-and-iac+-rules.md).
