...
See [Key concepts](../../scan-infrastructure/introduction-to-iac+/key-concepts-for-iac+-and-cloud.md) for definitions of compliance standards and controls, security rules, and more.
