...
* **Snyk Infrastructure as Code**: [Snyk IaC ](../scan-cloud-deployments/snyk-infrastructure-as-code/)supports configuration files for HashiCorp Terraform, AWS CloudFormation, Kubernetes, and Azure Resource Manager (ARM).
* **Snyk Cloud:** [Snyk Cloud](../scan-cloud-deployments/snyk-cloud/) supports scanning [Amazon Web Services resources](../scan-cloud-deployments/snyk-cloud/supported-aws-resources-for-snyk-cloud.md) and [Google Cloud resources](../scan-cloud-deployments/snyk-cloud/getting-started-with-snyk-cloud-google/).
