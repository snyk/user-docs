...
With the Snyk [CLI](../run-snyk/snyk-cli/cli-reference.md) you can use the following commands:
...
See [Getting started with the CLI](../run-snyk/snyk-cli/getting-started-with-the-cli.md) for details.
...
See [Snyk Web UI](../run-snyk/snyk-web-ui/) for details.
