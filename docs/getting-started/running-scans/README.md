...
To start using Snyk scanning capabilities for open-source libraries, container images, and application code, see [Start scanning](../../scan-applications/start-scanning/).
