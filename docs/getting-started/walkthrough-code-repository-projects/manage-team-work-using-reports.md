...
See [Reports](../../fixing-and-prioritizing-issues/snyk-reports/) for more details.
...
For Open Source vulnerabilities, we also have tagging, which lets you add your own tags, including custom values for metadata. See [Project tags](../../fixing-and-prioritizing-issues/introduction-to-snyk-projects/project-tags.md) and [Project attributes](../../fixing-and-prioritizing-issues/introduction-to-snyk-projects/project-attributes.md).
