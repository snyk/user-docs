...
{% hint style="info" %}
[Snyk Code](../../scan-application-code/snyk-code/) and [Snyk IaC](../../scan-applications/scan-infrastructure/scan-your-iac-source-code/) issue cards have separate information sets for these areas.
{% endhint %}
