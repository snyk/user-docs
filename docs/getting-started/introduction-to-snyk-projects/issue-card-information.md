...
Issue cards appear in the details page for your project - see [View project information](https://snyk.gitbook.io/user-docs/getting-started/introduction-to-snyk-projects/view-project-information).
...
* [Severity level](https://snyk.gitbook.io/user-docs/introducing-snyk/snyks-core-concepts/severity-levels): for example, **H** \(High\)
...
* [Exploit maturity](https://snyk.gitbook.io/user-docs/fixing-and-prioritizing-issues/issue-management/evaluating-and-prioritizing-vulnerabilities): for example, **Proof Of Concept**.
