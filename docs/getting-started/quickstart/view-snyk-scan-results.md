...
* Container images: see [Snyk Container](../../scan-containers/getting-started-snyk-container.md).
...
* Cloud misconfigurations: see [Snyk Cloud](../../scan-cloud-configurations/integrated-iac-with-cloud-context/).
