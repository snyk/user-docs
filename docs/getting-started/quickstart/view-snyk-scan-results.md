...
This shows the number of issues found, grouped by severity level (**C**ritical, **H**igh, **M**edium or **L**ow). See [Severity levels](../../scan-using-snyk/prioritize-your-issues/severity-levels.md) for more details.
