...
* Application code: see [Snyk Code](../../scan-with-snyk/start-scanning-using-the-cli-web-ui-or-api/scan-code/activate-snyk-code-using-the-web-ui.md).
* Container images: see [Snyk Container](../../scan-with-snyk/start-scanning-using-the-cli-web-ui-or-api/scan-container-images.md).
