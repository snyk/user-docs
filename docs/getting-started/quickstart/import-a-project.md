...
<figure><img src="../../.gitbook/assets/image (48).png" alt=""><figcaption><p>Add selected repositories</p></figcaption></figure>

{% hint style="info" %}
Projects you select to import are shown with a ![Check mark](<../../.gitbook/assets/image (494).png>).\
