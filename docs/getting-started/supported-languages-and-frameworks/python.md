...
To define which Python Major version Snyk uses to test your Git-imported pip Projects, you can use Organization settings and [`.snyk` policy files](../../manage-risk/prioritize-your-issues/the-.snyk-file.md).
