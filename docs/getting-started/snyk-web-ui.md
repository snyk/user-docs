...
{% hint style="info" %}
You can also use Snyk functions from the [Snyk CLI](../snyk-cli/), [in your IDE](../snyk-scm-ide-and-ci-cd-integrations/use-snyk-in-your-ide/), and with the [Snyk API](../snyk-api/).
{% endhint %}
