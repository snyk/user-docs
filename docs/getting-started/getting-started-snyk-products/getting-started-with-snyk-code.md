...
* If you are using the Snyk IDE, CLI, or API Environments – use the Snyk Web UI to [enable the **Snyk Code** option](../../products/snyk-code/getting-started-with-snyk-code/activating-snyk-code-using-the-web-ui/step-1-enabling-the-snyk-code-option.md). Then, continue to test your code with Snyk Code in your selected Environment.
...
**Note**: For more information, see [Prerequisites for Snyk Code](../../products/snyk-code/getting-started-with-snyk-code/prerequisites-for-snyk-code.md).
...
**Note**: If you are working with the API Environment WITHOUT the CLI, you also need to [integrate your SCM via the Web UI](../../products/snyk-code/getting-started-with-snyk-code/activating-snyk-code-using-the-web-ui/step-2-integrating-your-source-control-system-with-snyk-code.md). &#x20;
...
**Note**: For more information, see [Activating Snyk Code using the Web UI](../../products/snyk-code/getting-started-with-snyk-code/activating-snyk-code-using-the-web-ui/).
