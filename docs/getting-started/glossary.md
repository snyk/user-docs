...
A pull request with an automatic fix for vulnerabilities found that Snyk can offer the user. See [Configure Automatic fix PRs](../scan-applications/snyk-open-source/open-source-basics/fix-pull-requests-for-known-vulnerabilities-backlog.md).
