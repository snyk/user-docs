...
After you [sign up for a Snyk account, authenticate and log in to Snyk](../../), the Web UI opens to the [Dashboard](../../../snyk-web-ui/broken-reference/), with a wizard to guide you through setup steps:
