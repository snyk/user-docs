...
There are special considerations for [Snyk CLI with Maven and Gradle](snyk-cli-with-maven-and-gradle.md) and [Git repositories with Maven and Gradle](git-repositories-with-maven-and-gradle.md).
