...
You can import JavaScript repositories from any Git services [supported by Snyk](../../scm-ide-and-ci-cd-workflow-and-integrations/git-repositories-scms-integrations-with-snyk/). After the import, Snyk analyzes your Projects based on their supported manifest files.
