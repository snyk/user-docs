...
| ![](<../../.gitbook/assets/image (156).png>) Low severity                                                                                           | The application may expose some data allowing vulnerability mapping, which can be used with other vulnerabilities to attack the application. |
