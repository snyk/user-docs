...
![Snyk Open Source findings displayed in Sublime Text](<../.gitbook/assets/image (5).png>)

![Snyk Code findings displayed in Sublime Text](<../.gitbook/assets/image (7).png>)
...
![Snyk Code findings displayed in Neovim](<../.gitbook/assets/image (9).png>)
