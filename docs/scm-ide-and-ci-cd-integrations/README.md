...
* **Organization level** - At the Organization level, you can set up the SCM integrations for all other Snyk products and all Snyk plans. See the [Manage your Integrations](../getting-started/explore-the-snyk-web-ui.md) at the Organizational level page for more details.&#x20;
