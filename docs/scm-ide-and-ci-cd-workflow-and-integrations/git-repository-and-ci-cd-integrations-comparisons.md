...
For more details, see [Snyk Git repository integration: deployment recommendations](snyk-scm-integrations/introduction-to-git-repository-integrations/deployment-recommendations-for-scm-integrations.md).
