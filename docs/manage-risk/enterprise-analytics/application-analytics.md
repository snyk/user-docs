...
{% hint style="info" %}
If you are using Snyk AppRisk Essentials, navigate to the [asset dashboard](../../getting-started/explore-the-snyk-web-ui.md#view-the-assets-dashboard) page to learn more about your assets or remain on the  [Analytics](issues-analytics.md) page to explore the detected issues.
{% endhint %}
