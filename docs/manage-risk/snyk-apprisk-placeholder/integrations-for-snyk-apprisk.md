...
See the [Connect an SCM integration](broken-reference) page or the Connect a third-party integration [third-party-integrations-for-snyk-apprisk.md](../../integrate-with-snyk/third-party-integrations-for-snyk-apprisk.md "mention") page for step-by-step details about how to set up an integration.
