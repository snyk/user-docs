...
* You must set up the Dynatrace or Sysdig integrations with Snyk AppRisk, or the [Snyk Runtime Sensor](../../../integrate-with-snyk/snyk-runtime-sensor.md). You can find more details on the [runtime third-party integrations](../../../integrate-with-snyk/third-party-integrations-for-snyk-apprisk.md) page.&#x20;
