...
[Prioritize the Projects](../../admin/snyk-projects/project-information.md) from your repositories by the type of Projects you want to focus on, for example, prioritize your Projects depending on their severity.
...
[Prioritize the issues](../../admin/snyk-projects/view-project-issues-fixes-and-dependencies.md) within a Project by using any of the following custom filters:&#x20;
...
You can use many features of [Snyk Projects](../../admin/snyk-projects/) to help you focus on priority issues:

* [View Project information](../../admin/snyk-projects/project-information.md).
* Apply and remove [Project attributes ](../../admin/snyk-projects/project-attributes.md)and [Project tags](../../admin/snyk-projects/project-tags.md) to characterize Projects.
* Look at [Project collections groupings](../../admin/snyk-projects/project-collections-groupings/).
* [View Project issues, fixes, and dependencies](../../admin/snyk-projects/view-project-issues-fixes-and-dependencies.md).
* [View Project settings](../../admin/snyk-projects/view-and-edit-project-settings.md).
