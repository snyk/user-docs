...
* See the [Python version](../../supported-languages-and-package-managers/python.md#python-version-support) documentation for more information about Python version support.&#x20;
...
For more information, see [Setting Python version in Git Projects](../../supported-languages-and-package-managers/python.md#setting-python-version-in-git-projects).
