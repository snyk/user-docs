...
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Application\*                | <ul><li>Is one of</li><li>Is not one of</li></ul>                                                                                                                    | all available applications for which you have configured the application context in Snyk Essentials                   |
...
| Organizations                | <ul><li>containing one or more of</li></ul><ul><li>containing all of</li></ul><ul><li>not containing one or more of</li></ul><ul><li>not containing all of</li></ul> | the list of available organizations                                                                                   |
...
<figure><img src="../../../.gitbook/assets/Create policy New UI.png" alt=""><figcaption><p>Asset policy - Create new policy</p></figcaption></figure>
