...
If you change severity, results from scans are updated in the [Snyk Web UI](../../../getting-started/snyk-web-ui.md), in [your IDE](../../../snyk-scm-ide-and-ci-cd-integrations/use-snyk-in-your-ide/), or in Snyk [PR Checks](../../../scan-with-snyk/pull-requests/pull-request-checks/).
