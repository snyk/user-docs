...
The Snyk Runtime Sensor for Snyk AppRisk Pro is in Closed Beta and is available only for Snyk Enterprise plans with Snyk AppRisk Pro. If you want to set it up in your Group, contact your Snyk account team.
{% endhint %}
