...
* **A Snyk service account created specifically** to be used with the Kubernetes connector. For instructions on creating a service account, see [Service accounts](../../../../enterprise-configurations/service-accounts/). For the roles and permissions, Snyk recommends:
...
If you create a separate Organization for the Kubernetes connector, follow the steps in the Snyk documentation to [create a Snyk Organization](../../../../snyk-admin/manage-groups-and-organizations/create-and-delete-organizations.md#create-an-organization). The new Snyk Organization must be in the same Snyk Group as your other Snyk Organization.&#x20;
...
Next, create a new [service account](../../../../enterprise-configurations/service-accounts/) for Kubernetes connector integration with Snyk AppRisk.
