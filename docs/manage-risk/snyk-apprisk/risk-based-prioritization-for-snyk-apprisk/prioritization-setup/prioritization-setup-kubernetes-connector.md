...
* **A Snyk service account created specifically** to be used with the Kubernetes connector. For instructions on creating a service account, see [Service accounts](../../../../getting-started-with-the-snyk-enterprise-plan/service-accounts/). For the roles and permissions, Snyk recommends:
...
Next, create a new [service account](../../../../getting-started-with-the-snyk-enterprise-plan/service-accounts/) for Kubernetes connector integration with Snyk AppRisk.
