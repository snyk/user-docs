...
{% hint style="info" %}
Severity levels also apply to license issues. See [Licenses](../../scan-applications/snyk-open-source/licenses/).
{% endhint %}
...
See [Snyk Priority Score](../../manage-issues/prioritizing-issues/priority-score.md) for details.
