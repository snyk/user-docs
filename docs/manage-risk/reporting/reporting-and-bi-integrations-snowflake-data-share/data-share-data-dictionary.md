...
| `exploit_maturity`               | varchar        | Represents the legacy existence and maturity, as defined by Snyk, of public exploits validated by Snyk, for example, Mature or Proof of Concept.                                              |
| `exploit_maturity_cvss_v4`       | varchar        | Represents the existence and maturity of public exploits validated by Snyk, using the CVSS v4 values: Not Defined, POC, Attacked.                                                             |
