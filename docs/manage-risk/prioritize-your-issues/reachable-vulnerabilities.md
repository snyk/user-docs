...
{% hint style="info" %}
To update existing Projects with the reachability analysis immediately, trigger a [manual test](../../scan-with-snyk/snyk-pr-checks/automated-and-manual-prs/#manual-pull-and-merge-requests-for-project-code).
{% endhint %}
