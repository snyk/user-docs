...
*   If you import a Project through an SCM integration, add the exclusions, folders only, to the bottom of the import window; see [Stage 2: Import Project](../../../integrate-with-snyk/snyk-scm-integrations/introduction-to-git-repository-integrations/snyk-scm-integration-good-practices.md#stage-2-import-projects) in Git repositories deployment recommendations.\
