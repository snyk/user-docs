...
An issue ignored in an Open Source or Code Project in the Snyk web UI will be reflected and not flagged in any subsequent [PR checks](../../../scan-using-snyk/pull-requests/pull-request-checks/) across all branches of the Project.
{% endhint %}
