...
* [Manage service accounts using the Snyk API](../../getting-started-with-the-snyk-enterprise-plan/service-accounts/manage-service-accounts-using-the-snyk-api.md)
