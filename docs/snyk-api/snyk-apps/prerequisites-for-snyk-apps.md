...
To create a Snyk App, you must have access to the Snyk API. To get started, follow the steps for [authentication for API](../snyk-rest-api-overview/authentication-for-api/).
