...
* The Snyk Group to which the Organizations belong should have [Single Sign On (SSO) configured](../../enterprise-configuration/using-single-sign-on-sso-for-authentication/).
...
{% hint style="info" %}
Enterprise plan users can define their own customized [member roles](../../snyk-admin/user-roles-and-permissions/user-role-management.md) and can use `rolePublicId` for assignment.\
\
