...
* Ensure you have installed Snyk CLI and authenticated your account.
* `SNYK_TOKEN` \(for use with our CLI\)—you can find your API token in your [account settings on snyk.io](https://app.snyk.io/account/)
* Fortify SSC 18.20
