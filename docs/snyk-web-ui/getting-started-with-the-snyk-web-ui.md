...
![Use project links to explore and manage target options](<../.gitbook/assets/image (271).png>)
...
![Integrations tab](<../.gitbook/assets/image (46).png>)
...
![Snyk product updates](<../.gitbook/assets/image (206).png>)
...
![Options for a user account](<../.gitbook/assets/image (324).png>)
