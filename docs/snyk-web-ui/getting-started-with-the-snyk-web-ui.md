...
![Use project links to explore and manage target options](<../.gitbook/assets/image (318).png>)
...
![Integrations tab](<../.gitbook/assets/image (265).png>)
...
![Getting help via the Help menu](<../.gitbook/assets/image (180).png>)
...
![Options for a user account](<../.gitbook/assets/image (231).png>)
