...
{% hint style="info" %}
If you're signing into a paid Team, Business, or Enterprise account, you'll also need to select the relevant [organization](../getting-started/introducing-snyk/key-concepts/groups-organizations-and-users.md) after you log in to Snyk.
{% endhint %}
