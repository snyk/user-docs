...
![Snyk dashboard for an Enterprise account showing pending tasks, vulnerable projects, as well as current security and license issues](<../.gitbook/assets/image (309).png>)
...
![Use project links to explore and manage target options](<../.gitbook/assets/image (63).png>)
...
![Integrations tab](<../.gitbook/assets/image (51).png>)
...
![Group and Organization settings](<../.gitbook/assets/image (129).png>)

## View product updates

"Ring the bell" to view a summary from [**snyk.io updates**](https://updates.snyk.io/).

![Snyk product updates](<../.gitbook/assets/image (16).png>)
...
![Getting help via the Help menu](<../.gitbook/assets/image (193).png>)
...
![Options for a user account](<../.gitbook/assets/image (321).png>)
