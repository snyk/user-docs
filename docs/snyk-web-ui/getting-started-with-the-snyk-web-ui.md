...
![Use project links to explore and manage target options](<../.gitbook/assets/image (182).png>)
...
![Target page: details and options for a single project from the dashboard](<../.gitbook/assets/dockerfile\_fix\_vulnerabilities (3).gif>)
...
![Integrations tab](<../.gitbook/assets/image (231).png>)
...
![Group and Organization settings](<../.gitbook/assets/image (132).png>)

## View product updates

"Ring the bell" to view a summary from [**snyk.io updates**](https://updates.snyk.io/).

![Snyk product updates](<../.gitbook/assets/image (212).png>)
...
![Getting help via the Help menu](<../.gitbook/assets/image (65).png>)
...
![Options for a user account](<../.gitbook/assets/image (144).png>)
