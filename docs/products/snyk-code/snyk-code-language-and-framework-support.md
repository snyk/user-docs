...
The analysis is available only for files with names shorter or equal to 255 character. You receive an error if the filename exceeds this limit. To make sure that all files are being analyzed, consider shortening long filenames.