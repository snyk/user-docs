...
2\. On the Snyk Web UI, select the <img src="../../../../.gitbook/assets/Snyk Code - CLI - Org Settings button - Icon (1) (4).png" alt="" data-size="line"> **Settings > Snyk Code** menu option.
