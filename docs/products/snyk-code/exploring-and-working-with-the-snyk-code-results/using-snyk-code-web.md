...
* The severity level (for example, **H** for high), the name (for example, **Cross-site Scripting**), and the [priority-score.md](../../../features/fixing-and-prioritizing-issues/issue-management/priority-score.md "mention") value.
