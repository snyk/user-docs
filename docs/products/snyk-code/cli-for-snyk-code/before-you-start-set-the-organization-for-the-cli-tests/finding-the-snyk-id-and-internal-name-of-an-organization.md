...
2\. Once the selected Organization is open, click the **Org Settings** button <img src="../../../../.gitbook/assets/Org Settings button - Icon.png" alt="" data-size="line"> on the top menu:
