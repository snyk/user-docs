...
{% hint style="info" %}
Only Snyk organizations that share the same Kubernetes integration ID can provision the Snyk controller to do so. More information on how to share the same integration ID can be found in [Clone an integration across your Snyk orgs](../../../../../integrate-with-snyk/managing-integrations/clone-an-integration-across-your-snyk-orgs.md).
{% endhint %}
