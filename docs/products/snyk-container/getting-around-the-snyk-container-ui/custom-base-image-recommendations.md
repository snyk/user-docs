...
4. Mark the project as a custom base image.
   1.  Go to the **Settings** page for the project.
       ...
       <figure><img src="../../../.gitbook/assets/image (74).png" alt="Navigate to Settings page for the project"><figcaption><p>Navigate to Settings page for the project</p></figcaption></figure>
