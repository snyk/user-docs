...
To learn how to configure Snyk Broker see the [Broker documentation](../../features/snyk-broker/broker-introduction.md).
...
To learn what to configure and how, see [Snyk Broker Infrastructure as Code detection](../../features/snyk-broker/snyk-broker-infrastructure-as-code-detection/) documentation.
