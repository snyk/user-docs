...
* [How to integrate custom rules within a pipeline](../detect-drift-and-manually-created-resources/integrating-iac-custom-rules-within-a-pipeline.md)
* [SDK reference](../detect-drift-and-manually-created-resources/sdk-reference.md)

![End to end flow of writing your own custom rules to distributing and using them to scan files with the Snyk CLI](<../../../.gitbook/assets/image (77) (1) (1) (1) (1).png>)
