...
## Terraform custom role[​](https://docs.driftctl.com/0.22.0/providers/aws/authentication#terraform-custom-role) <a href="#terraform-custom-role" id="terraform-custom-role"></a>
