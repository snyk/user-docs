...
Snyk Open Source is available in many common languages and platforms. See [Supported languages and package managers](language-and-package-manager-support/).
