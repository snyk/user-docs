...
![Snyk Open Source CLI test results](<../../../.gitbook/assets/image (6).png>)

## Summary of test findings

The summary of the test findings at the top shows the following:

![Snyk Open Source CLI dependencies tested, issues and vulnerabilities found](<../../../.gitbook/assets/image (77).png>)
