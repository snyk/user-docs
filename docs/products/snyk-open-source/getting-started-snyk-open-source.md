...
{% hint style="info" %}
This process describes getting started using the [Snyk Web UI](../../run-snyk/snyk-web-ui/) with a Git-based source repository.
...
See [view-project-information.md](../../run-snyk/snyk-web-ui/introduction-to-snyk-projects/view-project-information.md "mention") for more details.
