...
1. [Expose vulnerabilities](untitled-287.md) \(snyk monitor\)
2. [Use Snyk as a gatekeeper](untitled-287.md) \(snyk test\)
3. [Continuous monitoring](untitled-287.md) \(snyk test + Snyk monitor\)
...
* **Snyk CLI:** For teams with more complex workflows, or using a build system without a Snyk pre-built plugin, you can use the Snyk CLI tool during CI/CD setups. See [Setting up using Snyk CLI](untitled-287.md) for more details.
