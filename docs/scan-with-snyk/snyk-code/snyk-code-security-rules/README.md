...
{% hint style="info" %}
If you have followed a link for code quality from an IDE, see the [language documentation for that information](../../../getting-started/supported-languages-frameworks-and-feature-availability-overview/introduction-to-snyk-supported-languages-and-frameworks.md#code-quality).
{% endhint %}
