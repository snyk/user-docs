...
To use Snyk Code in an [IDE](../../developer-tools/snyk-ide-plugins-and-extensions/), [Snyk CLI](../../developer-tools/snyk-cli/scan-and-maintain-projects-using-the-cli/snyk-cli-for-snyk-code/), and [Snyk API](../../snyk-api/overview.md), you must perform the following actions:
...
For more information on how data is stored in Snyk, see [How Snyk handles your data](../../snyk-data-and-governance/how-snyk-handles-your-data.md). For more details about integrations, see [Integrate with Snyk](../../integrations/overview.md).
{% endhint %}
