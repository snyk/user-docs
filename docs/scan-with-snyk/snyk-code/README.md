...
* [Snyk IDE](../../scm-ide-and-ci-cd-workflow-and-integrations/use-snyk-in-your-ide/)
* [Snyk CLI](../../snyk-cli/)
* [Snyk API](../../snyk-api/)
...
Snyk Code supports many [languages and frameworks](../../supported-languages-and-package-managers/).
