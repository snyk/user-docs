...
You can also use this feature with Snyk Broker. To use this feature, you must upgrade Snyk Broker to v. 1.4.55.0 or later. For more information, see [Upgrade the Snyk Broker client](../../../../snyk-platform-administration/snyk-broker/update-the-snyk-broker-client.md).
