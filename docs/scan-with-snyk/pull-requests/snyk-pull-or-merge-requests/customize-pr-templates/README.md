...
When you fix or upgrade Snyk Open Source and Snyk Container Projects imported using the [SCM integrations](../../../../scm-integrations/snyk-scm-integrations/), Snyk raises pull requests (PRs) against your repository.&#x20;
