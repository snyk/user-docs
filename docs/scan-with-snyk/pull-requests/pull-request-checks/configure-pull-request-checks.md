...
PR Checks also support all programming languages and frameworks supported by the Snyk Code and Open Source engines. For more information, see programming language support for [Snyk Code](../../../supported-languages-and-frameworks/#code-analysis-snyk-code) and [Open Source](../../../supported-languages-and-frameworks/#open-source-and-licensing-snyk-open-source).
