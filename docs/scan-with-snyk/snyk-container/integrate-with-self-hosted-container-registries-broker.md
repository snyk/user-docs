...
For more details, see [Snyk Broker - Container Registry Agent](../../enterprise-configuration-and-implementation/snyk-broker/snyk-broker-container-registry-agent/).
