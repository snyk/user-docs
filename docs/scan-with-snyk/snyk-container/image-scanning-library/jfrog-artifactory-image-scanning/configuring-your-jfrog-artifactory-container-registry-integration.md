...
* If you're using self-hosted Artifactory, refer to our documentation for [Broker configuration](../../../../integrations/extensions/snyk-broker/snyk-broker-container-registry-agent/).
