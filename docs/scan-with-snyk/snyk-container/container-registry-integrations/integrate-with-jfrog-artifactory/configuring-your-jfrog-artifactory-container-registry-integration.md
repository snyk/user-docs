...
* If you are using a self-hosted Artifactory instance, see [Snyk Broker - Container Registry Agent](../../../../snyk-platform-administration/snyk-broker/snyk-broker-container-registry-agent/).
