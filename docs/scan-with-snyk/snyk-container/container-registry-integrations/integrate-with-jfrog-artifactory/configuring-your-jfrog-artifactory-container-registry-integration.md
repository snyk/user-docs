...
* If you are using a self-hosted Artifactory instance, see [Snyk Broker - Container Registry Agent](../../../../enterprise-setup/snyk-broker/classic-broker/snyk-broker-container-registry-agent/).
