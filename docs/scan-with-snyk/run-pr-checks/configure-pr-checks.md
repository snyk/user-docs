...
* You have the Group Admin role so you have access to all integration settings. See [Member roles](../../snyk-admin/manage-permissions-and-roles/manage-user-roles.md).
