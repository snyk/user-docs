...
* [Dashboard](../../getting-started/explore-the-snyk-web-ui.md#view-the-assets-dashboard) - offers you widgets that display an overview of your application and security controls.
