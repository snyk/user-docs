...
The following videos show the capabilities of Snyk Essentials and Snyk AppRisk.
...
Snyk Essentials and Snyk AppRisk core capabilities overview
{% endembed %}
...
On top of the Snyk Essentials features, Snyk AppRisk offers:
...
## Using Snyk Essentials and Snyk AppRisk

Access Snyk Essentials and Snyk AppRisk by following these steps:
...
Navigate to the [Snyk Essentials vs Snyk AppRisk](snyk-apprisk-essentials-vs-snyk-apprisk-pro.md) to check the features availability.
