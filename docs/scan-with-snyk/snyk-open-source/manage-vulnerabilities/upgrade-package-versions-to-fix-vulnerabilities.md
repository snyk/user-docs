...
See [Upgrading dependencies with automatic PRs](../snyk-fix-prs-and-fix-merge-requests-with-snyk-open-source/upgrade-dependencies-with-automatic-prs.md) for more details.
