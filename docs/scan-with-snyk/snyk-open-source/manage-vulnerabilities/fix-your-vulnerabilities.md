...
* If you are using a [Source code integration](../../../integrate-with-snyk/git-repositories-scms-integrations-with-snyk/):
  ...
  * Use [automated pull requests](../../snyk-pr-checks/automated-and-manual-prs/create-automatic-prs-for-new-fixes.md) when new fixes become available that help you to fix a vulnerability.

{% hint style="info" %}
**Automatic Fix PRs**\
When a new fixable vulnerability is found, Snyk can attempt to open a new pull request automatically. See [Automated pull request creation for new fixes](../../snyk-pr-checks/automated-and-manual-prs/create-automatic-prs-for-new-fixes.md) for details.
{% endhint %}
