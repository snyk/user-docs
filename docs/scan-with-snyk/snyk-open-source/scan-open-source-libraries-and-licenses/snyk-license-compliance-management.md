...
Snyk’s [Git-based integrations ](../../../integrate-with-snyk/snyk-scm-integrations/)support license scanning as part of the regular workflow. During scanning, license issues appear as a filterable list in the **Issues** tab:
