...
You can create and edit multiple license policies for Organizations. For details, see [Create a license policy and rules](../../../enterprise-configuration/policies/license-policies/create-a-license-policy-and-rules.md).
...
Alternatively, you may want to ignore the issue. For details, see [ignore issues](../../find-and-manage-priority-issues/ignore-issues/).
