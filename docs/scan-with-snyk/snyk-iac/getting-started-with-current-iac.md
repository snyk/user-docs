...
* A Git repository you have integrated with Snyk in the same way as for other Snyk products. For details, see [Git repository (SCM)](../../snyk-scm-ide-and-ci-cd-integrations/git-repositories-scms-integrations-with-snyk/).
