...
* Ensure you have already integrated your Git repository, For details, see [Git repository (SCM) integrations](../../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/).
