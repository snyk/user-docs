...
To retrieve the IaC template from the Snyk API, you need the API token for a Snyk Organization-level [service account](../../../../../snyk-platform-administration/service-accounts/) with an Org Admin role.
