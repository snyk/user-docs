...
To retrieve the IaC template from the [Snyk API](https://apidocs.snyk.io/?version=2022-12-21%7Ebeta#post-/orgs/-org_id-/cloud/permissions), you need the API token for a Snyk Organization-level [service account](../../../../../snyk-platform-administration/service-accounts/) with an Org Admin role.
