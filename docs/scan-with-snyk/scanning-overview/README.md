...
* Using [Git integrations](../../integrate-with-snyk/snyk-scm-integrations/), you can improve security in your Git repositories for both your code and deployed applications.
