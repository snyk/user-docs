...
The `.snyk` file is a YAML [policy](../enterprise-configuration/policies/) file that Snyk uses to define certain analysis behaviors and to specify patches for the CLI and CI/CD plugins.
