...
{% content-ref url="../../../../integrations/git-repository-and-ci-cd-integrations-comparisons/private-registry-integrations/artifactory-registry-for-maven.md" %}
[artifactory-registry-for-maven.md](../../../../integrations/git-repository-and-ci-cd-integrations-comparisons/private-registry-integrations/artifactory-registry-for-maven.md)
{% endcontent-ref %}
...
{% content-ref url="../../../../integrations/git-repository-and-ci-cd-integrations-comparisons/ci-cd-integrations/maven-plugin-integration.md" %}
[maven-plugin-integration.md](../../../../integrations/git-repository-and-ci-cd-integrations-comparisons/ci-cd-integrations/maven-plugin-integration.md)
{% endcontent-ref %}
