...
* Are you using [Application context](../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/application-context-for-scm-integrations.md), and are there fields that might be valuable in automating policies with Snyk AppRisk?
