...
* Are you using [Application context](../../../scm-integrations/application-context-for-scm-integrations/), and are there fields that might be valuable in automating policies with Snyk Essentials?
