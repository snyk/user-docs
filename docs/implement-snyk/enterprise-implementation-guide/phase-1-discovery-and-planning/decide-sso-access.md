...
For more information on SSO, see [Using Single Sign-On (SSO) for authentication](../../../enterprise-configuration-and-implementation/single-sign-on-sso-for-authentication-to-snyk/)&#x20;
...
For more information, see [Choose a Provisioning Option](../../../enterprise-configuration-and-implementation/single-sign-on-sso-for-authentication-to-snyk/choose-a-provisioning-option.md).
