...
On the [Snyk Essentials ](../../scan-with-snyk/snyk-essentials.md)and [Snyk AppRisk](../../scan-with-snyk/snyk-apprisk.md) pages, you can find more details about the features available for both offerings.
{% endhint %}
