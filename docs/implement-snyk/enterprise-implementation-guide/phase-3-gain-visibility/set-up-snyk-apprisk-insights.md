...
Learn about risk-based prioritization and how to set up and deploy the Kubernetes connector for Snyk AppRisk, using the [**Issues**](../../../getting-started/explore-the-snyk-web-ui.md#view-and-prioritize-issues) page from the Snyk AppRisk menu.
