...
You can connect your repositories for automatic scanning. See [Git repositories (SCMs) integrations with Snyk](../../../scm-ide-and-ci-cd-workflow-and-integrations/git-repositories-scms-integrations-with-snyk/) for more details.
