...
{% hint style="info" %}
See the [Getting started](../../../getting-started/) section and [Start scanning using the CLI, Web UI, or AP](../../../scan-using-snyk/start-scanning-using-the-cli-web-ui-or-api.md) for more details.
{% endhint %}
