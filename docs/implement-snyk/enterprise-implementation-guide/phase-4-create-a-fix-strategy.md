...
{% hint style="info" %}
For more information on how to use reports, see [Reporting](../../manage-issues/reporting/) and [Available Snyk Reports](../../manage-issues/reporting/available-snyk-reports.md).
{% endhint %}
