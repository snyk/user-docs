...
Navigate to the [Snyk Broker - SCM integrations](../../../enterprise-setup/snyk-broker/classic-broker/snyk-broker-apprisk.md#scm-integrations) page for more details about installing and configuring Snyk AppRisk using Snyk Broker.
