...
If you have on-premise Git repositories, you must configure and run [Snyk Broker](../../../../enterprise-configuration-and-implementation/snyk-broker/) to enable the integration.
