...
If you have on-premise Git repositories, you must configure and run [Snyk Broker](../../../../getting-started-with-the-snyk-enterprise-plan/snyk-broker/) to enable the integration.
