...
There are several [CI/CD integrations](../../../scm-ide-and-ci-cd-integrations/snyk-ci-cd-integrations/) available, or you can use the [Snyk CLI](../../../cli-ide-and-ci-cd-integrations/snyk-cli/) as part of your pipeline, in order to have more flexibility in the tests you are running.
