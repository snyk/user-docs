...
First, [install the Snyk CLI](../cli-ide-and-ci-cd-integrations/snyk-cli/install-or-update-the-snyk-cli/). After installation, you must authenticate it to your Snyk account, as demonstrated in this video.
