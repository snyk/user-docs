...
* [Example: Setting up custom mapping for Entra ID](example-setting-up-custom-mapping-for-azure-ad.md)
...
* [Example: Setting up custom mapping for Okta OIDC app](example-setting-up-oidc-okta-app-with-custom-claims.md)
