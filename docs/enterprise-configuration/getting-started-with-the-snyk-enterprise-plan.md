...
{% hint style="info" %}
The tool that best serves your tech stack, environment, and workflow depends on your individual circumstances. See the [guide](../scan-using-snyk/supported-languages-and-frameworks.md) specific to your language for more details.
{% endhint %}
