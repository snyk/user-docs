...
If your team needs to set up a service account in GitHub, you must use [GitHub Enterprise](../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/github-enterprise.md), which is available only with Snyk Enterprise accounts.
