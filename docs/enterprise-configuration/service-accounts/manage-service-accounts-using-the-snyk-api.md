...
This [paginated](../../snyk-api/using-snyk-api-articles/links-for-pagination-in-snyk-rest-api.md) call returns an array of objects, each describing a service account.
