...
For code repository (SCM) integrations, a Broker token can be generated using API or by contacting [Snyk support](https://support.snyk.io/hc/en-us/requests/new).
