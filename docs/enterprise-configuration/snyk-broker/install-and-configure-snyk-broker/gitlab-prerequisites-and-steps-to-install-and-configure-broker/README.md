...
Ensure that the GitLab permissions are correct for integration with Snyk. For details, see [Snyk GitLab integration](../../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/gitlab.md).
