...
{% hint style="info" %}
For additional instructions, see the integrations pages for [Git repositories (SCMs)](../snyk-scm-ide-and-ci-cd-integrations/git-repositories-scms-integrations-with-snyk/).
{% endhint %}
