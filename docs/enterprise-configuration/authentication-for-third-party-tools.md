...
{% hint style="info" %}
For additional instructions, see the integrations pages for [Git repositories (SCMs)](../scm.-ide-and-ci-cd-workflow/git-repositories-scms-integrations-with-snyk/).
{% endhint %}
