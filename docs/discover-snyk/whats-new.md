...
* The [`sbom monitor`](../developer-tools/snyk-cli/commands/sbom-monitor.md) command help was added.
...
* The Snyk AppRisk documentation section has been reorganized to enhance visibility and simplify the adoption of Snyk AppRisk. Here is where you can find the main features:
  ...
  * Integrations - [Snyk SCM integrations](../developer-tools/scm-integrations/group-level-integrations/) and [Integrate with Snyk](../integrations/overview.md) sections
