...
Navigate to the [Asset Dashboard](../../manage-risk/reporting/available-snyk-reports.md#asset-dashboard) documentation section for more details.

### View and manage your assets inventory

You can use the [Inventory](../../manage-assets/manage-assets.md) page to organize your repository assets, enabling you to visualize all repository assets from your SCM tools, track Snyk product control coverage, and prioritize coverage mitigation based on business impact.
...
For more details about available integrations, see [Snyk Essentials SCM integrations](../../developer-tools/scm-integrations/group-level-integrations/) and [Integrate with Snyk](../../integrations/integrate-with-snyk.md).
...
<figure><img src="../../.gitbook/assets/image (243).png" alt=""><figcaption><p>Edit an existing integration from the Integration Hub</p></figcaption></figure>
...
{% hint style="info" %}
You can also use Snyk functions from the [Snyk CLI](../../developer-tools/snyk-cli/), [in your IDE](../../developer-tools/snyk-ide-plugins-and-extensions/), and with the [Snyk API](../../snyk-api/snyk-api.md).
{% endhint %}
...
You can set up a range of integrations with Snyk from the [Integrations](../../integrations/integrate-with-snyk.md) page available on the Dashboard.
