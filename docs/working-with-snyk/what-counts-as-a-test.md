...
These Snyk features for [Git Repositories (SCM)](../scm-ide-and-ci-cd-workflow-and-integrations/git-repositories-scms-integrations-with-snyk/) integrations run scans automatically by default:
