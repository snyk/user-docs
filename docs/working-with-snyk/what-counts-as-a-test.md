...
These Snyk features for [Git Repositories (SCM)](../scm.-ide-and-ci-cd-workflow/git-repositories-scms-integrations-with-snyk/) integrations run scans automatically by default:
