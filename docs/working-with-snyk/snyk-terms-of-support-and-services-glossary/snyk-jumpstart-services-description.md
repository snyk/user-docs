...
The Snyk Consultant will work with the Customer to install the Snyk Broker in a pre-determined environment that follows the [Snyk Broker system requirements](../../enterprise-configuration-and-implementation/snyk-broker/prepare-snyk-broker-for-deployment.md).&#x20;
...
The Snyk Consultant will work with the Customer to install the Snyk Broker in a predetermined environment that follows the [Snyk Broker system requirements](../../enterprise-configuration-and-implementation/snyk-broker/prepare-snyk-broker-for-deployment.md).
