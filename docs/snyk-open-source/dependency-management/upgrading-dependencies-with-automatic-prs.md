...
1. From settings that load, scroll to the Automatic dependency upgrade pull requests and click Disabled.
2. From the options that appear:
...
3. Click ![image4.png](../../.gitbook/assets/uuid-a32f41fa-2cb8-f1e5-afc0-26ad43b84470-en.png).
