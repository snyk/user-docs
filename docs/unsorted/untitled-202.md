...
* [ Reachable Vulnerabilities](https://github.com/snyk/user-docs/tree/58f91d848e16ddf2ffcca3711d6b8852412be402/hc/en-us/articles/360010554837-Reachable-Vulnerabilities-/README.md)
...
2. Navigate into the folder of your app, where the relevant manifest files reside \(alternatively use the **--file&lt;file\_name&gt;** parameter to point to the right path\).
3. Run **snyk &lt;test/monitor&gt; --reachable**_._

#### Scanning for Reachable Vulnerabilities using Git Integrations

1. Set up your [GitHub integration](https://support.snyk.io/hc/en-us/articles/360004032117-GitHub-integration).
