...
1. (Optional) Examine the pull request generated by [Snyk Bot](../../integrate-with-snyk/git-repository-scm-integrations/snyk-github-integration.md#commit-signing) in the Conversation tab in GitHub.
