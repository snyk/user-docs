...
* You have the Group Admin role so you have access to all integration settings. See [Member roles](../../snyk-admin/manage-user-roles-and-permissions/manage-member-roles.md).
