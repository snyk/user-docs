...
Snyk Open Source is available in many common languages and platforms. See [Supported languages and package managers](../supported-languages-frameworks-and-feature-availability-overview/).
...
You can also use license policies to define how your company deals with license issues. For more information, see [License policies](../../scan-with-snyk/policies/license-policies/).
