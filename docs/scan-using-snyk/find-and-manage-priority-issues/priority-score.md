...
See [Understanding the Priority Score of the Snyk Code issues](../snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/priority-score-in-snyk-code.md) for details.
