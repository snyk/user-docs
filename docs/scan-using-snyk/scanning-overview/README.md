...
If you see hundreds or thousands of issues when first scanning your application, prioritization of issues becomes important. For information on prioritizing issues, see [Find and manage priority issues](../../manage-risk/prioritize-your-issues/).
...
4. If you import many legacy applications, you can use [Priority Score](../../manage-risk/prioritize-your-issues/priority-score.md) (typically 700 as a starting place). If you would like to have more control over the criteria, you can do the following:
