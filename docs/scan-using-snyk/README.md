...
For more information, see [Scanning overview](working-with-snyk-in-your-environment/) and [Start scanning using the CLI, Web UI, or API](start-scanning-using-the-cli-web-ui-or-api.md).
