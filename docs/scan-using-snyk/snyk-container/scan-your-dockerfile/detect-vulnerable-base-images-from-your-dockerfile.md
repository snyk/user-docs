...
After you [integrate your Git repository with Snyk](../../../integrate-with-snyk/git-repository-scm-integrations/), any Dockerfiles in that repository are automatically identified and shown in the Web UI as Projects.
