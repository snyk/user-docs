...
{% hint style="info" %}
[Snyk Code analysis](manage-code-vulnerabilities/exploring-the-history-of-snyk-code-results.md) can be applied to every pull request you create in your Git repository before you merge it into the target branch. See [PR Checks](../run-pr-checks/).
{% endhint %}
