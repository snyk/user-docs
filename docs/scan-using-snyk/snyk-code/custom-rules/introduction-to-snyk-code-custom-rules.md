...
You can test your Code Projects using the Snyk CLI with regular commands and options as long as you have the [.snyk file](../../the-.snyk-file.md) to hold any custom rules that you have created using Snyk Web UI.
...
IDE integrations with Snyk support custom rules as long as you have the [.snyk file](../../the-.snyk-file.md) to hold any custom rules that you have created using Snyk Web UI.&#x20;
