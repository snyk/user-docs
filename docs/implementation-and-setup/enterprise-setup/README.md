...
* If you want developers to try Snyk in their local environment using the IDE or CLI, review [Snyk API](../../snyk-api/overview.md) and [Snyk CLI](../../developer-tools/snyk-cli/).
