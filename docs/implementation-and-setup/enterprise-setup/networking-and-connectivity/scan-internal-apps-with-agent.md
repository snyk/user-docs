...
To install a Scanning Agent, refer to this article on [how to install a Scanning Agent](install-a-scanning-agent.md) and the installation reference and source code for the installer available at <a href="https://github.com/Probely/farcaster-onprem-agent/" rel="nofollow noopener noreferrer" target="_blank">Snyk API & Web's GitHub repositories</a>.
