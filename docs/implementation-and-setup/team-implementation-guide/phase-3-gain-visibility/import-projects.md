...
Here are some key points to determine the best starting point. For details, see [Git repositories and CI/CD comparisons](../../../developer-tools/git-repository-and-ci-cd-integrations-comparisons.md).
