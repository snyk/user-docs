...
* Internet-accessible repositories.\
  If your repositories are not internet-accessible, you must use [Snyk Broker](../../../snyk-platform-administration/snyk-broker/).
...
You cannot use the GitHub integration with a Snyk [Service Account](../../../snyk-platform-administration/service-accounts/), as the GitHub integration is associated with your user account, not with the Snyk Organization.
...
For availability with Snyk Broker, see the [Commit signing](../../../snyk-platform-administration/snyk-broker/snyk-broker-commit-signing.md) page in the Broker docs.
{% endhint %}
