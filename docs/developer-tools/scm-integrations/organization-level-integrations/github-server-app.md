...
This feature supports self-hosted instances of GitHub and Snyk [Universal Broker](../../../snyk-platform-administration/snyk-broker/universal-broker/). For instructions, see [GitHub Server App for Universal Broker](../scm-integrations-and-snyk-broker.md#github-server-app-for-universal-broker).
{% endhint %}
