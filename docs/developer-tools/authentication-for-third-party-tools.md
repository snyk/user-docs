...
* Single Sign-On (SSO): available with Enterprise plans.\
  See [Setting up Single Sign-On (SSO) for authentication](../snyk-platform-administration/single-sign-on-sso-for-authentication-to-snyk/).
