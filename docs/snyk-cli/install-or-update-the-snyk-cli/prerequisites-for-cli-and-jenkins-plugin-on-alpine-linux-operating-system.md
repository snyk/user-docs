...
For additional information see [Install or update the Snyk CLI](./) and [Jenkins Plugin](../../integrations/ci-cd-integrations/jenkins-integration-overview.md) in the CI/CD docs.
