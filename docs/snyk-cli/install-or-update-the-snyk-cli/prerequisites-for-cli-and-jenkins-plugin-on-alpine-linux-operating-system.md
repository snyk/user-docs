...
For additional information see [Install or update the Snyk CLI](./) and [Jenkins Plugin](../../integrate-with-snyk/snyk-ci-cd-integrations/jenkins-integration-overview.md) in the CI/CD docs.
