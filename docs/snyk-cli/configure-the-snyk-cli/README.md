...
You can use [environment variables](./#environment-variables) to configure the Snyk CLI. You can also set variables to configure the Snyk CLI to [connect to the Snyk API](./#configuration-to-connect-to-the-snyk-api).
