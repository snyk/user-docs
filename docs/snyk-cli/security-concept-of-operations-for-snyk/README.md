...
These pages provide a description of the [Snyk CLI](../getting-started-with-the-snyk-cli.md) and [IDE integrations](../../integrate-with-snyk/use-snyk-in-your-ide/) focused on security. The following information is included:
