...
Change the endpoint to use.  Run c`onfig environment --help` or see the [Config environment help page](https://docs.snyk.io/snyk-cli/commands/config-environment)
