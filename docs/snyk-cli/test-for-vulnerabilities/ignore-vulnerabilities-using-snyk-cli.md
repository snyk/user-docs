...
{% hint style="info" %}
For [Snyk Open Source](../../products/snyk-open-source/), these options work by default.
...
For [Snyk Infrastructure as Code](../../scan-cloud-deployment/snyk-infrastructure-as-code/), see [IaC ignores using the snyk policy file](../../scan-cloud-deployment/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/iac-ignores-using-the-.snyk-policy-file.md).

For [Snyk Code](../../products/snyk-code/), see [Excluding directories and files from the Snyk Code CLI test](../../products/snyk-code/cli-for-snyk-code/excluding-directories-and-files-from-the-snyk-code-cli-test.md).
{% endhint %}
