...
[Understanding the IaC CLI test output](../../scan-cloud-deployments/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/)
