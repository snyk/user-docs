...
<figure><img src="../../.gitbook/assets/untitled (3).png" alt="Result of scanning unmanaged JAR files"><figcaption><p>Result of scanning unmanaged JAR files</p></figcaption></figure>
