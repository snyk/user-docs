...
The Snyk CLI can scan unmanaged JAR files in [Java applications](../../getting-started/supported-languages-and-frameworks/java-and-kotlin/#open-source-and-licensing) to identify which open-source package they contain.
