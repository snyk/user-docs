...
You can specify either your personal API token or a service token, available for Enterprise customers only. See [Service accounts](../enterprise-configurations/service-accounts/) for information on using service tokens.
