...
{% hint style="warning" %}
This feature is currently in Open Beta. There are areas where it is not fully supported. Currently [Snyk Open Source](../../scan-with-snyk/snyk-open-source/) is supported.
{% endhint %}
