...
{% hint style="warning" %}
This feature is currently in [Early Access](../../getting-started/snyk-release-process.md). There are areas where it is not fully supported. Currently [Snyk Open Source](../../scan-with-snyk/snyk-open-source/) is supported.
{% endhint %}
