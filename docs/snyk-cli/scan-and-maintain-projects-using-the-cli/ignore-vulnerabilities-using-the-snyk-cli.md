...
For [Snyk Infrastructure as Code](../../scan-using-snyk/snyk-iac/scan-your-iac-source-code/), see [IaC ignores using the snyk policy file](snyk-cli-for-iac/iac-ignores-using-the-.snyk-policy-file.md).
