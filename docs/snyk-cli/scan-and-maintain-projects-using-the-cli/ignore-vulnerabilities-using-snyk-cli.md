...
For [Snyk Infrastructure as Code](../../scan-configurations/snyk-infrastructure-as-code/), see [IaC ignores using the snyk policy file](../../scan-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/iac-ignores-using-the-.snyk-policy-file.md).
