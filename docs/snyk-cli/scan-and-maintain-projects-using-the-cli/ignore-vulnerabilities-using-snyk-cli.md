...
For [Snyk Infrastructure as Code](../../scan-infrastructure/snyk-infrastructure-as-code/), see [IaC ignores using the snyk policy file](../../scan-infrastructure/snyk-cli-for-infrastructure-as-code/iac-ignores-using-the-.snyk-policy-file.md).
