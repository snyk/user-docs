...
* The **Snyk Code** option [enabled in your Snyk Org settings](../../../scan-with-snyk/start-scanning-using-the-cli-web-ui-or-api/scan-code/enable-the-snyk-code-option.md).
