...
* Manually creating a `.snyk` file in the tested folder. See [Excluding directories and files from the import process](../../../scan-with-snyk/import-project-repository/excluding-directories-and-files-from-the-import-process.md).
