...
* [Differences in **vulnerability counts** across environments](../../scan-applications/snyk-open-source/starting-to-fix-vulnerabilities/differences-in-vulnerability-counts-across-environments.md)
