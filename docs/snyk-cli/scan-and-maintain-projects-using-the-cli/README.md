...
* [The **.snyk** file](../test-for-vulnerabilities/the-.snyk-file.md)
...
* [Differences in **vulnerability counts** across environments](../test-for-vulnerabilities/differences-in-vulnerability-counts-across-environments.md)
