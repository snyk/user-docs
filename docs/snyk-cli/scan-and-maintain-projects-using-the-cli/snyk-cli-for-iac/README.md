...
Alternatively, you can add an [SCM integration](../../../integrate-with-snyk/snyk-scm-integrations/), and Snyk will monitor and test a given Git repository on a recurring basis.
