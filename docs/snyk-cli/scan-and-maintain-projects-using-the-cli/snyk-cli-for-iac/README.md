...
Alternatively, you can add an [SCM integration](../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/), and Snyk will monitor and test a given Git repository on a recurring basis.
