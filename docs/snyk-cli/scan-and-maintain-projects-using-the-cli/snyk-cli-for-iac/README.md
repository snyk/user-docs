...
Alternatively, you can add an [SCM integration](../../../snyk-scm-ide-and-ci-cd-integrations/git-repositories-scms-integrations-with-snyk/), and Snyk will monitor and test a given Git repository on a recurring basis.
