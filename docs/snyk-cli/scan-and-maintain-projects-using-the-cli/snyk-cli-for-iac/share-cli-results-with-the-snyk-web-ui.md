...
{% hint style="info" %}
Using [Custom rules](../../../scan-with-snyk/scan-infrastructure/build-your-own-iac-custom-rules/current-iac-custom-rules/) and the Share Results functionality together is not currently supported.
