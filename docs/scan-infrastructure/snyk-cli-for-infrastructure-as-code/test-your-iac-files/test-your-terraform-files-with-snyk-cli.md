...
For more information about variable processing, see [Terraform variables support](../../snyk-infrastructure-as-code/scan-terraform-files/terraform-variables-support.md).
