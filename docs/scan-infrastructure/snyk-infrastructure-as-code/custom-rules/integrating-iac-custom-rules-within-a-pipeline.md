...
* Steps were added steps to set up a Node.js environment to enable installing the `snyk-iac-rules` SDK using [npm](../../../scan-cloud-configurations/snyk-infrastructure-as-code/custom-rules/install-the-sdk.md#install-the-sdk-with-npm).
