...
* [Use IaC custom rules with the Snyk CLI](../../snyk-infrastructure-as-code/custom-rules/use-iac-custom-rules-with-cli/)
* [Integrating custom rules within a pipeline](../../snyk-infrastructure-as-code/custom-rules/integrating-iac-custom-rules-within-a-pipeline.md)
