...
In the Snyk Web UI, you can remove an environment by navigating to your Organization **Settings (cog icon) > Cloud environments**. See [Remove an IaC+ or cloud environment](../../introduction-to-iac+/snyk-environments/view-add-and-remove-environments.md#remove-an-iac+-or-cloud-environment).
