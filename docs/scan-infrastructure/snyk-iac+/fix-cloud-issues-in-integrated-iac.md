...
[Onboard IaC+](../start-using-snyk-iac/introduction-to-iac+.md) environments via the Snyk CLI workflow (`snyk iac test --report`), and onboard relevant AWS environments via [AWS Integration](../../integrations/cloud-platforms-integrations/aws-integration/).
