...
Follow the link in the CLI output to see your issues in the Snyk Web UI. To learn more about the cloud issues view, see [View Cloud and IaC+ issues in the Snyk Web UI](../introduction-to-iac+/cloud-and-integrated-iac-issues/view-cloud-and-integragted-iac-issues-in-the-snyk-web-ui.md).
...
4. Optional: View a list of all IaC+ and cloud context rules and adjust rule severity as needed. For more information, see [Managing Cloud and IaC+ rules](../introduction-to-iac+/manage-cloud-and-iac+-rules.md).
