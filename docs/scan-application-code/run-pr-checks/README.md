...
<figure><img src="../../.gitbook/assets/PR checks diagram (development workflow) (1) (1) (1) (1).png" alt="Diagram showing where Snyk checks for pull requests in the development workflow."><figcaption><p>Pull request checks in the development workflow</p></figcaption></figure>
