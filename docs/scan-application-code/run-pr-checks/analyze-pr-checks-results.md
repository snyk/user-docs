...
{% hint style="info" %}
Issues that have previously been ignored via the Snyk Web UI in the associated OPen Source or code analysis Project are not flagged in these checks. This reflects [ignored issues](../../manage-issues/prioritizing-issues/ignore-issues.md) across feature branch PRs.
{% endhint %}
