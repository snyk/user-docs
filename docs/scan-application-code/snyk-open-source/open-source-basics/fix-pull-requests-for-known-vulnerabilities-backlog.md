...
* One pull request is created per Project ([priority score](../../../manage-risk/priorities-for-fixing-issues/priority-score.md) of **700 and above only**).
...
1. Go to **Projects**, then expand the [target](../../../manage-risk/snyk-projects/#target) containing your open source Project.
