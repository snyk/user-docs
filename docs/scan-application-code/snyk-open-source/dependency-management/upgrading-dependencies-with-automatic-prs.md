...
3.  Click the **Project settings** (<img src="../../../.gitbook/assets/gear.png" alt="" data-size="line"> gear icon) at the end of the project row.
    ...
    <figure><img src="../../../.gitbook/assets/image (134) (1) (1) (1) (1).png" alt="Editing Project settings."><figcaption><p>Editing Project settings</p></figcaption></figure>
4.  In the **Project** **Settings** page, choose the relevant integration tab from the left submenu.

    <figure><img src="../../../.gitbook/assets/image (10) (1) (2) (1) (1) (1).png" alt="Project settings overview."><figcaption><p>Project settings overview</p></figcaption></figure>
