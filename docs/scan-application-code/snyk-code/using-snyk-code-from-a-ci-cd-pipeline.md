...
* Snyk Code is not yet supported in the Snyk CI plugins, for example, the Snyk Jenkins plugin, but you can use the [Snyk CLI](../../snyk-cli/analyze-code-with-the-snyk-code-cli/) to integrate with your CI server.
