...
* The **Snyk Code** option [enabled in your Snyk Org settings](../../../scan-applications/start-scanning/scan-code/getting-started-with-snyk-code/enabling-the-snyk-code-option-in-an-organization.md).
