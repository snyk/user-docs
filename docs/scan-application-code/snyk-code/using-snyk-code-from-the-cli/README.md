...
* The **Snyk Code** option [enabled in your Snyk Org settings](../../../scan-applications/snyk-code/start-using-snyk-code/enabling-the-snyk-code-option-in-an-organization.md).
