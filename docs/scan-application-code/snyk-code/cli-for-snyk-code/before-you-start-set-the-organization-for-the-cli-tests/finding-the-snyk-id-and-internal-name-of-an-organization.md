...
2\. Once the selected Organization is open, click the **Org Settings** button <img src="../../../../.gitbook/assets/Snyk Code - CLI - Org Settings button - Icon (2).png" alt="" data-size="line"> on the top menu:
