...
For a general understanding of how Snyk helps you fix Open Source vulnerabilities within your Projects, see [Fix your vulnerabilities](../../scan-applications/snyk-open-source/starting-to-fix-vulnerabilities/fix-your-vulnerabilities.md).
...
If you believe you have found false positives because the application runs on a system that always has the latest patches from Microsoft installed, which _may_ mean the vulnerability is no longer relevant to your Project, you may choose to [ignore](../../manage-risk/priorities-for-fixing-issues/ignore-issues.md) it.

#### **Vulnerabilities from runtime dependencies in CLI**

If you believe you have found false positives because when the application runs in production, you always pull the latest/explicit patches from Microsoft, which may mean the vulnerability is no longer relevant to your Project, you may [ignore](../../manage-risk/priorities-for-fixing-issues/ignore-issues.md) them and do the following:
...
:link: [Supported Operating System Distributions](../../scan-applications/snyk-container/how-snyk-container-works/supported-operating-system-distributions.md)

:link: [Snyk CLI for container security](../../scan-applications/snyk-container/snyk-cli-for-container-security/)&#x20;
...
* To help generate reports locally or at build time, see [snyk-to-html plugin](../../scan-applications/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/).
