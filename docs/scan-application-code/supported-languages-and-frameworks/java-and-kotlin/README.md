...
To apply best practices for Java environments, see [Deployment and rollout recommendations](snyk-for-java-developers.md#deployment-and-rollout-recommendations) and [Language-specific and package manager-specific notes](snyk-for-java-developers.md#language-specific-and-package-manager-specific-notes).
