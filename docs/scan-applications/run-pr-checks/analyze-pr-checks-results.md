...
1. (Optional) Examine the pull request generated by [Snyk Bot](../../integrations/git-repository-scm-integrations/snyk-github-integration.md#commit-signing) in the Conversation tab in GitHub.
...
[Troubleshooting PR Checks](../../scan-application-code/run-pr-checks/troubleshooting.md) has more information on how to troubleshoot PR Checks or how to restart them
