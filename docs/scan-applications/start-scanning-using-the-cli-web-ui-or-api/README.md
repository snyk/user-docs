...
* [Use Snyk Code from the CLI](../../snyk-cli/using-snyk-code-from-the-cli/)
...
* [Working with the Snyk Code CLI results](../../snyk-cli/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results.md)
