...
<figure><img src="../../.gitbook/assets/image (149).png" alt=""><figcaption><p>Enable full source code analysis</p></figcaption></figure>
...
Go Modules Projects imported using new [Snyk Broker](https://docs.snyk.io/integrations/snyk-broker/broker-introduction) clients should work as expected.
