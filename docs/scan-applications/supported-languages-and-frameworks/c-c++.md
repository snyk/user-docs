...
To apply best practices for C/C++ environments, see [Deployment and rollout recommendations](working-with-snyk-in-your-environment/best-practices-for-c-c++.md) and [Language/Open Source specific facts for using Snyk](broken-reference).
