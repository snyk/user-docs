...
A list of Jira tickets associated with the issues contained within the pull request. [Make sure ](#user-content-fn-1)[^1]that the Snyk Jira integration is enabled on your Project(repository)[^2] and that you have linked Snyk issues to JIRA tickets.
