...
* For known vulnerabilities see [Automated pull request for known vulnerabilities (backlog)](../../../scan-application-code/snyk-open-source/open-source-basics/fix-pull-requests-for-known-vulnerabilities-backlog.md)
