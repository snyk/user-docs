...
4. Select the **Fix Strategy** for your Backlog PRs as described in the [Fix strategy step of configuring for integrations](configure-automatic-fix-prs.md#configure-automatic-fix-prs-at-the-integration-level).
5. **Save changes**.
