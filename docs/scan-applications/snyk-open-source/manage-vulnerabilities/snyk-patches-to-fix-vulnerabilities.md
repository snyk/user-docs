...
The patches are a part of [Snyk’s open source vulnerability database](../starting-to-fix-vulnerabilities/using-the-snyk-vulnerability-database.md), so you can check them out before applying them.
