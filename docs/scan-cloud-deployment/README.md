...
* [Fix Cloud issues](integrated-iac-with-cloud-context/integrated-infrastructure-as-code/fix-cloud-issues-in-iac.md) directly in the IaC source code that was used to deploy the misconfigured Cloud resources, by linking a Cloud issue to the underlying IaC template via a SCM source code link.
