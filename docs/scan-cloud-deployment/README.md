...
* Suppress false positives in IaC tests by applying [context from deployed infrastructure](integrated-iac-with-cloud-context/integrated-infrastructure-as-code/adding-cloud-context-to-your-iac-test.md).
