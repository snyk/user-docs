...
<figure><img src="../../../.gitbook/assets/image (14) (1) (1) (1) (1) (1).png" alt="End to end flow of writing your own custom rules to distributing and using them to scan files with the Snyk CLI"><figcaption><p>End to end flow of writing your own custom rules to distributing and using them to scan files with the Snyk CLI</p></figcaption></figure>
