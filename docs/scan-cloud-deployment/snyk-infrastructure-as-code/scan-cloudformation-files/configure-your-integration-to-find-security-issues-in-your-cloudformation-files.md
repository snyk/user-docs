...
* Ensure you have already integrated your Git repository, For details, see the [Git repository (SCM) integrations](https://docs.snyk.io/integrations/git-repository-scm-integrations).
