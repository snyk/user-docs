...
Log in to the [Snyk Web UI](../../getting-started/introducing-snyk/snyk-web-ui/) and go to your organization's project page, to see the specific snapshot of your scanned project.
