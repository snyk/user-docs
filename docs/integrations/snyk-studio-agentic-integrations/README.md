...
Snyk Studio supports large-scale distribution and centralized governance. For guidance on how to handle scaling across your organization, visit [Distribution at scale](snyk-studio-and-secure-at-inception.md).
