...
For existing user&#x73;_,_ select the log-in method associated with your account. If you do not have access to Snyk Code, the LLM will prompt you to enable it prior to your first scan. You can also [enable it directly in Snyk's Settings](/broken/pages/0dMWUuicl71g7r1ziVoJ).
