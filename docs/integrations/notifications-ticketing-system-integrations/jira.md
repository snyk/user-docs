...
For the availability of this feature for Snyk Infrastructure as Code, see [Jira Integration for IaC](../../scan-infrastructure/snyk-iac-integrations/jira-integration-for-iac.md).\
