...
For the availability of this feature for Snyk Infrastructure as Code, see [Jira Integration for IaC](../../scan-cloud-configurations/snyk-infrastructure-as-code/jira-integration.md).\
