...
{% hint style="info" %}
You can also add a Cloud environment from **Organization Settings (cog icon) > Cloud environments**. See [View Environments](../../../../scan-infrastructure/key-concepts-in-iac+/snyk-environments/view-add-and-remove-environments.md).
{% endhint %}
