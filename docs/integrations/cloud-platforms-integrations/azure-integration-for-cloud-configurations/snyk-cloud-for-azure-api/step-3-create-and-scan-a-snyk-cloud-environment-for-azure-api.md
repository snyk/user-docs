...
To manually re-scan an environment, see [Scan a Cloud Environment](../../../../scan-applications/scan-infrastructure/introduction-to-iac+/snyk-environments/scan-a-cloud-environment.md).
