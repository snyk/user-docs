...
To re-scan an environment, see [Scan a Cloud Environment](../../../../scan-with-snyk/scan-infrastructure/introduction-to-iac+/snyk-environments/scan-a-cloud-environment.md).
