...
<figure><img src="../../.gitbook/assets/aws-ctl-2.png" alt="Organization ID on Snyk settings page"><figcaption><p>Organization ID on Snyk settings page</p></figcaption></figure>
