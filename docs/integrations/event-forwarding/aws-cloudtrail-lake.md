...
<figure><img src="../../.gitbook/assets/aws-ctl-4.png" alt="Integration name, AWS Account ID, Channel ARN"><figcaption><p>Integration name, AWS Account ID, Channel ARN</p></figcaption></figure>
