...
{% hint style="info" %}
Navigate to the [Third-party integrations for Snyk AppRisk](broken-reference) to check all available integrations and their setup details.
{% endhint %}
...
See the [Group-level integrations](../developer-tools/scm-integrations/group-level-integrations/) page or the [Third-party integrations for Snyk AppRisk](broken-reference) page for step-by-step details about how to set up an integration.
