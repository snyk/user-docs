...
<figure><img src="../../.gitbook/assets/image (520).png" alt="View import results"><figcaption><p>View import results</p></figcaption></figure>
...
3.  Set the Azure DevOps organization that you want to integrate with by entering the slug for your organization (![](<../../.gitbook/assets/image (28).png>)) and the personal access token that you generated.
