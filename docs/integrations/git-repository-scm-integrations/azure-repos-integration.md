...
3.  Set the Azure DevOps organization that you want to integrate with by entering the slug for your organization (![](<../../.gitbook/assets/image (127) (1) (2).png>)) and the personal access token that you generated.
