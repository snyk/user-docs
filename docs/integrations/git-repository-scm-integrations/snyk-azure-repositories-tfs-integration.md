...
{% hint style="info" %}
The Azure Repository integration works like the other Snyk [Git integrations](./). To continue to monitor, fix, and manage your Projects, see the [Projects](../../manage-risk/snyk-projects/) documentation.
{% endhint %}
