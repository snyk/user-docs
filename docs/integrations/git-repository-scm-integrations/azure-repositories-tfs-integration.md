# Azure Repositories (TFS) integration
...
1. Generate a unique Azure DevOps personal access token (PAT) for Snyk, based on a username and password combination, and configured with the specific permissions Snyk needs to access your Azure repositories.\
   For more information, see [Configure your Azure Repository integration](azure-repositories-tfs-integration.md#configure-your-azure-repository-integration).
...
{% hint style="info" %}
The Azure Repository integration works like the other Snyk [Git integrations](./). To continue to monitor, fix, and manage your Projects, see the [Projects](../../manage-issues/snyk-projects/) documentation.
{% endhint %}
