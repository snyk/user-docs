...
3. In the **Account credentials >** **Creating an app password** section in Snyk, use the link <img src="../../.gitbook/assets/image (13).png" alt="" data-size="line"> to jump to your Bitbucket Cloud account.
