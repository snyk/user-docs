...
3. In the **Account credentials >** **Creating an app password** section in Snyk, use the link <img src="../../.gitbook/assets/image (365) (1) (1) (1).png" alt="" data-size="line"> (**Create an App password**) to jump to your Bitbucket Cloud account.
...
<figure><img src="../../.gitbook/assets/444 (1) (1) (1) (1) (1) (19).png" alt="The Imported projects in your Projects page"><figcaption><p>The Imported projects in your <strong>Projects</strong> page</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/bitbucket_cloud-auto_fix_prs_30june2022 (1) (1) (1) (3).png" alt="Modify the automatic fix pull requests"><figcaption><p>Modify the automatic fix pull requests</p></figcaption></figure>
