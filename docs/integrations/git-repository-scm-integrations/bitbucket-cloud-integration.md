...
<figure><img src="../../.gitbook/assets/bitbucket_cloud-auto_fix_prs_30june2022 (3).png" alt="Modify the automatic fix pull requests"><figcaption><p>Modify the automatic fix pull requests</p></figcaption></figure>
