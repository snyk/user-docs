...
3.  Set the Azure DevOps Organization that you want to integrate with by entering the slug for your Organization (![](<../../.gitbook/assets/image (127) (1) (1).png>)) and the PAT that you generated.
