...
* Pull requests:
  ...
  * [Automatic dependency upgrade PRs](../../scan-with-snyk/snyk-open-source/open-source-basics/upgrading-dependencies-with-automatic-prs.md)
...
By default, the badge will test against the first [valid manifest file](broken-reference) it detects in the root of your Project.
