...
* Pull requests:
  ...
  * [Automatic dependency upgrade PRs](../../scan-applications/snyk-open-source/automatic-and-manual-prs-with-snyk-open-source/upgrade-dependencies-with-automatic-prs.md)
