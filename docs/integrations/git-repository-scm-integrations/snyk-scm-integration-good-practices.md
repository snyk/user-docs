...
<figure><img src="../../.gitbook/assets/image (429).png" alt="Add projects to Snyk"><figcaption><p>Add projects to Snyk</p></figcaption></figure>
...
{% hint style="info" %}
To confirm that a Project was imported, go to the **Add project** import page for the integration. Imported projects are indicated by a ✔ next to the repository name: <img src="../../.gitbook/assets/image (38) (1).png" alt="Check next to name of repo" data-size="line">
{% endhint %}
...
<figure><img src="../../.gitbook/assets/security-check (2).png" alt="Snyk security check failure"><figcaption><p>Snyk security check failure</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/merge-advice-review-recommended (2) (2) (2) (15) (1).png" alt="Merge advice label"><figcaption></figcaption></figure>

![](<../../.gitbook/assets/advice-green (1) (2) (2) (4) (3) (2) (1).png>)

![Merge advice label](<../../.gitbook/assets/merge-advice (2) (2) (4) (2) (1) (15).png>)
...
2.  Select and expand the relevant Project, select the relevant Target, and using the cog icon, open the **Settings**:
    ...
    <img src="../../.gitbook/assets/image (56) (2) (3) (3) (3) (3) (4) (5) (5) (5) (5) (3) (1) (2).png" alt="Cog icon for Project settings" data-size="original">
