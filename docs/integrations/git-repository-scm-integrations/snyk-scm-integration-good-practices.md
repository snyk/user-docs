...
<figure><img src="../../.gitbook/assets/image (91).png" alt="Add projects to Snyk"><figcaption><p>Add projects to Snyk</p></figcaption></figure>
...
{% hint style="info" %}
To confirm that a Project was imported, go to the **Add project** import page for the integration. Imported projects are indicated by a ✔ next to the repository name: <img src="../../.gitbook/assets/image (38) (2).png" alt="Check next to name of repo" data-size="line">
{% endhint %}
...
<figure><img src="../../.gitbook/assets/merge-advice-review-recommended (2) (2) (2) (15).png" alt="Merge advice label"><figcaption></figcaption></figure>
...
2.  Select and expand the relevant Project, select the relevant Target, and using the cog icon, open the **Settings**:
    ...
    <img src="../../.gitbook/assets/image (56) (2) (3) (3) (3) (3) (4) (5) (5) (5) (5) (3) (1) (2) (1).png" alt="Cog icon for Project settings" data-size="original">
