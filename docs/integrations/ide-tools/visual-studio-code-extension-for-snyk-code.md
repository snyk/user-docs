...
Visual Studio Code requires Snyk CLI, see [install-the-snyk-cli.md](../../snyk-cli/install-the-snyk-cli.md "mention").
{% endhint %}
...
![](<../../.gitbook/assets/image (76) (1) (1) (1) (1) (1) (1).png>)
...
1.  Once the extension is installed, click on the Snyk Icon in the left navigation bar:
    ...
    ![](<../../.gitbook/assets/image (62) (1) (1) (1) (2).png>)
...
![](<../../.gitbook/assets/image (62) (2) (3).png>)
...
| ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](<../../.gitbook/assets/image (64) (1) (1) (1) (1).png>) High severity    | May allow attackers to access sensitive data on your application.                                                                            |
| ![](<../../.gitbook/assets/image (63) (1) (1) (1).png>) Medium severity      | May allow attackers under some conditions to access sensitive data on your application.                                                      |
...
![](<../../.gitbook/assets/oss-editor-show-vulnerability (1) (1).png>)
