...
<figure><img src="../../../.gitbook/assets/image (387) (1) (1).png" alt="Adding the Eclipse LSP4e update site"><figcaption><p>Adding the Eclipse LSP4e update site</p></figcaption></figure>
