...
<figure><img src="../../../.gitbook/assets/image (400) (1).png" alt="Adding the Eclipse LSP4e update site"><figcaption><p>Adding the Eclipse LSP4e update site</p></figcaption></figure>
