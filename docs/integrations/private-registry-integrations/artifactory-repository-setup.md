...
These instructions apply to configuring publicly accessible instances. For instructions on configuring a brokered instance see [Set up Snyk Broker with Artifactory Repository](../../snyk-admin/snyk-broker/set-up-snyk-broker/snyk-broker-set-up-examples/set-up-snyk-broker-with-artifactory-repository.md).
...
When you have permissions to add a private registry, continue with the instructions on [Set up Snyk Broker with Artifactory Repository](../../snyk-admin/snyk-broker/set-up-snyk-broker/snyk-broker-set-up-examples/set-up-snyk-broker-with-artifactory-repository.md).
