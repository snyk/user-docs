...
These instructions apply to configuring publicly accessible instances. For instructions on configuring a brokered instance see [Set up Snyk Broker with Nexus Repository Manager](../../snyk-admin/snyk-broker/install-and-configure-snyk-broker/set-up-snyk-broker-with-nexus-repository-manager.md)
