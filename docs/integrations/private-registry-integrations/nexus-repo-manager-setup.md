...
* The integration currently supports [Node.js](../../scan-application-code/snyk-open-source/language-and-package-manager-support/snyk-for-javascript.md) (npm and Yarn) and [Maven](../../scan-application-code/snyk-open-source/language-and-package-manager-support/snyk-for-java-gradle-maven.md) projects.
...
* Instances on a private network accessed via a [Snyk Broker](../../integrate-with-snyk/snyk-broker/broker-introduction.md) (with or without basic authentication).
