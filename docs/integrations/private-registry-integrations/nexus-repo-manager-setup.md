...
These instructions apply to configuring publicly accessible instances. For instructions on configuring a brokered instance see [Set up Snyk Broker with Nexus Repository Manager](../../snyk-admin/snyk-broker/install-and-configure-broker-using-docker/snyk-broker-set-up-examples/set-up-snyk-broker-with-nexus-repository-manager.md).
...
When you have permissions to add a private registry, continue with the instructions on [Set up Snyk Broker with Nexus Repository Manager](../../snyk-admin/snyk-broker/install-and-configure-broker-using-docker/snyk-broker-set-up-examples/set-up-snyk-broker-with-nexus-repository-manager.md).
