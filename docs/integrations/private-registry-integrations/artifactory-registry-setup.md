...
2. Instances on a private network accessed via a [Snyk Broker](../../integrate-with-snyk/snyk-broker/broker-introduction.md) (with or without basic authentication)
