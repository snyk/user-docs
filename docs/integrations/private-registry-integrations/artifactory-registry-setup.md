...
2. Instances on a private network accessed via a [Snyk Broker](../../features/integrations/snyk-broker/broker-introduction.md) (with or without basic authentication)
