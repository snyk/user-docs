...
* [Bitbucket Server / Data Center](../../git-repository-and-ci-cd-integrations-comparisons/git-repository-scm-integrations/bitbucket-data-center-server-integration.md) (On-prem)
* [Azure Repos](https://docs.snyk.io/integrations/git-repository-scm-integrations/azure-repos-integration) (Cloud and On-prem)

In addition, Snyk Broker integrates with [Jira Server/Jira Data Center](../../git-repository-and-ci-cd-integrations-comparisons/notifications-ticketing-system-integrations/jira.md), [JFrog Artifactory](../../git-repository-and-ci-cd-integrations-comparisons/private-registry-integrations/artifactory-registry-setup.md), and [Nexus Repository Manager](../../git-repository-and-ci-cd-integrations-comparisons/private-registry-integrations/nexus-repo-manager-setup.md).
