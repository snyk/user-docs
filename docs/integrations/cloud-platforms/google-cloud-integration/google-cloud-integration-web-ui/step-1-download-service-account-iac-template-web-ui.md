...
{% hint style="info" %}
You can also add a cloud environment from **Organization Settings (cog icon) > Cloud environments**. See [View Environments, Add a Cloud environment](../../../../scan-cloud-deployment/integrated-iac-with-cloud-context/view-snyk-cloud-environments.md#add-an-environment).
{% endhint %}
