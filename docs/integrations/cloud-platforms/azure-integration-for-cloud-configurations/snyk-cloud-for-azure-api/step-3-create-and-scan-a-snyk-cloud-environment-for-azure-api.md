...
To manually re-scan an environment, see [Scan a Cloud Environment](../../../../scan-cloud-configurations/integrated-iac-with-cloud-context/snyk-environments/scan-a-cloud-environment.md).
