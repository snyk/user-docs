...
| [Cursor](agentic-integrations-snyk-mcp-server/quickstart-guides-for-mcp/cursor-guide.md)                                       | Add the Snyk MCP server to Cursor to secure code generated with agentic workflows through an LLM.                                                                   |
