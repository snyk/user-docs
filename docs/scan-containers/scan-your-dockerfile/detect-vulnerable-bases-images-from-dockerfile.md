...
See [Base image detection](../../scan-applications/snyk-container/use-snyk-container-from-the-web-ui/detect-the-container-base-image.md) for more details about detecting vulnerable base images and fix recommendations.
