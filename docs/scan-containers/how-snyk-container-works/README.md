...
\
To detect changes in your application, such as updated dependencies, you must re-import your container image in Snyk. To see an example of how to import your image, see [Getting started with Snyk Container](../../scan-applications/snyk-container/start-using-snyk-container.md).
{% endhint %}
