...
* [Set up integration](../getting-started/quickstart/set-up-an-integration.md) for your container registry, for example Docker Hub. Snyk supports multiple registries; see [image-scanning-library](snyk-container-integrations/image-scanning-library/ "mention") for details.
