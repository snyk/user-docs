...
* If you're using a self-hosted Artifactory, refer to the Snyk documentation for [Broker configuration](../../../snyk-admin/snyk-broker/snyk-broker-container-registry-agent/).
