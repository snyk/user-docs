...
* **API only:** An Organization-level [service account](../../../enterprise-configuration-and-implementation/service-accounts/) with an Org Admin role to use the Snyk API
