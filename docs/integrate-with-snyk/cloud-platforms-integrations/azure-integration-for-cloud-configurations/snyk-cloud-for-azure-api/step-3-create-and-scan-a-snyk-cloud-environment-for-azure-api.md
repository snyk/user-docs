...
To manually re-scan an environment, see [Scan a Cloud Environment](../../../../scan-using-snyk/snyk-iac/getting-started-with-iac+-and-cloud-scans/snyk-environments/scan-a-cloud-environment.md).
