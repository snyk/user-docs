...
Snyk tests and monitors Azure Repos by evaluating root folders and custom file locations for the [languages that Snyk supports](../../scan-using-snyk/supported-languages-and-frameworks.md).
