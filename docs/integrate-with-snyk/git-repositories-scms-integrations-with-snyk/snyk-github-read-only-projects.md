...
* Use [automated fix PRs](../../scan-with-snyk/snyk-pr-checks/automated-and-manual-prs/create-automatic-prs-for-new-fixes.md) to recommend minimal changes to fix vulnerabilities.
* Use [automated dependency upgrade PRs](../../scan-with-snyk/snyk-pr-checks/automated-and-manual-prs/upgrade-dependencies-with-automatic-prs.md) to keep dependencies up to date, avoid new vulnerabilities, and simplify fixing those that are found.
