...
For more information, see [Snyk automated pull requests](../../scan-using-snyk/pull-requests/snyk-fix-pull-or-merge-requests/create-automatic-prs-for-new-fixes.md).
{% endhint %}
