...
Snyk scans your Projects on either a daily or a weekly basis. When new vulnerabilities are found, Snyk notifies you by email and by opening [automated pull requests](../../scan-with-snyk/snyk-open-source/snyk-fix-prs-and-fix-merge-requests-with-snyk-open-source/automated-pull-request-creation-for-new-fixes.md) with fixes for your repositories.
...
For more information, see [Automated pull request creation for new fixes](../../scan-with-snyk/snyk-open-source/snyk-fix-prs-and-fix-merge-requests-with-snyk-open-source/automated-pull-request-creation-for-new-fixes.md).
{% endhint %}
