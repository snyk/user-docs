...
* Pull requests:
  ...
  * [Automatic dependency upgrade PRs](../../scan-with-snyk/snyk-pr-checks/automated-and-manual-prs/upgrade-dependencies-with-automatic-prs.md)
...
* Pull request status checks ([PR Checks](../../scan-with-snyk/snyk-pr-checks/))
  * [Open Source security and licenses](../../scan-with-snyk/snyk-pr-checks/configure-pr-checks.md#configure-pr-checks-at-the-integration-level)
  * [Code analysis](../../scan-with-snyk/snyk-pr-checks/configure-pr-checks.md#configure-pr-checks-at-the-integration-level)
* Dockerfiles
...
The Snyk [PR Checks](../../scan-with-snyk/snyk-pr-checks/) feature allows Snyk to test any new PR in your repositories for security vulnerabilities and sends a status check to GitHub. This lets you see, directly in GitHub, whether or not the pull request introduces new security issues.
