...
You can use a common [`.snyk` policy file](../../../scan-using-snyk/policies/the-.snyk-file.md) if you maintain ignores and patches in one place to be applied for all detected workspaces by providing the policy path as follows:
...
See [Java and Kotlin](../../../scan-applications/supported-languages-and-frameworks/java-and-kotlin.md) for more information.
