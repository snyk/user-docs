...
Enterprise users should use a **service account** for any type of automation, including CI/CD setup. For more information, see [Service accounts](../../../enterprise-configuration-and-implementation/service-accounts/).
