...
{% hint style="info" %}
If your Jira instance is private, use [the Snyk Broker deployment method](../../enterprise-setup/snyk-broker/install-and-configure-snyk-broker/jira-install-and-configure-broker/jira-install-and-configure-using-docker.md).
{% endhint %}
...
See [Set up Snyk Broker with Jira](../../enterprise-setup/snyk-broker/install-and-configure-snyk-broker/jira-install-and-configure-broker/jira-install-and-configure-using-docker.md).
