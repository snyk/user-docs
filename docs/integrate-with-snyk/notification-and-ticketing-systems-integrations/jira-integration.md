...
For Snyk Infrastructure as Code, see [Jira Integration for IaC](../../scan-using-snyk/snyk-iac/snyk-iac-integrations/jira-integration-for-iac.md).
{% endhint %}
...
{% hint style="info" %}
If your Jira instance is private, use [the Snyk Broker deployment method](../../enterprise-configuration/snyk-broker/install-and-configure-snyk-broker/jira-prerequisites-to-install-and-configure-broker/setup-broker-with-jira.md).
{% endhint %}
...
See [Set up Snyk Broker with Jira](../../enterprise-configuration/snyk-broker/install-and-configure-snyk-broker/jira-prerequisites-to-install-and-configure-broker/setup-broker-with-jira.md).
