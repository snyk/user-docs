...
* If you are using a self-hosted Artifactory instance, see [Snyk Broker - Container Registry Agent](../../../enterprise-configurations/snyk-broker/snyk-broker-container-registry-agent/).
