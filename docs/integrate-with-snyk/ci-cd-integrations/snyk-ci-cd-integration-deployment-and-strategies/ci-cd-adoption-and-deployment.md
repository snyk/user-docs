...
For information about `snyk monitor`, see the [`monitor` command help](../../../run-snyk/snyk-cli/commands/monitor.md).
...
For information about `snyk test`, see the [`test` command help](../../../run-snyk/snyk-cli/commands/test.md).
...
Follow steps similar to those for [installing the CLI](../../../run-snyk/snyk-cli/install-the-snyk-cli.md) locally. You must be able to run an npm command in the pipeline script. This method has the advantage of completely aligning with the CLI experience so you can easily troubleshoot and configure.
