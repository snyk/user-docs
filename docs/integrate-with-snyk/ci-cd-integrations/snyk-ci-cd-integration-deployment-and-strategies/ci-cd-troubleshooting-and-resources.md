...
Try various CLI options. Use the Snyk CLI tool to find and fix known vulnerabilities as you run it in the pipeline. For more information see the [CLI docs](../../../run-snyk/snyk-cli/).
...
Try to replace the native plugin with the CLI by installing the CLI. See [Install the Snyk CLI ](../../../run-snyk/snyk-cli/install-the-snyk-cli.md)for instructions.
