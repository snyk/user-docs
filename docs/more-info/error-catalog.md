...
### [SNYK-0002](#snyk-0002) - Not implemented
...
### [SNYK-0003](#snyk-0003) - Bad request
...
### [SNYK-004](#snyk-004) - Timeout error
...
### [SNYK-005](#snyk-005) - Unauthorised error
...
---
# OpenAPI
### [SNYK-OPENAPI-001](#snyk-openapi-001) - Bad request
...
### [SNYK-OPENAPI-002](#snyk-openapi-002) - Forbidden
...
### [SNYK-OPENAPI-003](#snyk-openapi-003) - Not acceptable
...
### [SNYK-OPENAPI-004](#snyk-openapi-004) - Not found
...
### [SNYK-OPENAPI-005](#snyk-openapi-005) - Method not allowed
...
### [SNYK-OPENAPI-006](#snyk-openapi-006) - Request entity too large
...
### [SNYK-OPENAPI-007](#snyk-openapi-007) - Unauthorized
...
### [SNYK-OPENAPI-008](#snyk-openapi-008) - Unsupported media type
...
### [SNYK-OS-0003](#snyk-os-0003) - Lock file out of sync with manifest file
...
### [SNYK-OS-0004](#snyk-os-0004) - Unable to parse lock file
...
### [SNYK-OS-0005](#snyk-os-0005) - Unknown dependency version
...
---
# SbomExport
### [SNYK-OS-9000](#snyk-os-9000) - Internal Server Error
...
### [SNYK-OS-9001](#snyk-os-9001) - Error while getting dependency graph
  Apologies, unfortunately an unexpected error has occurred. Please try again shortly. If the error persists please contact the Snyk support team.
...
### [SNYK-OS-9002](#snyk-os-9002) - Error parsing dependency graph
  Apologies, unfortunately an unexpected error has occurred. Please try again shortly. If the error persists please contact the Snyk support team.
...
### [SNYK-OS-9003](#snyk-os-9003) - Not Found
...
### [SNYK-OS-9004](#snyk-os-9004) - We do not currently provide an SBOM document for this project type
...
### [SNYK-OS-9005](#snyk-os-9005) - Unsuccessful request
...
### [SNYK-OS-9006](#snyk-os-9006) - Unauthorized
  Missing API token.
...
### [SNYK-OS-9007](#snyk-os-9007) - The body of the request can not be empty
...
### [SNYK-OS-9008](#snyk-os-9008) - The provided depgraph in the body is invalid
...
---
# Workspaces
### [SNYK-OS-9101](#snyk-os-9101) - Unauthorized Credentials
...
### [SNYK-OS-9102](#snyk-os-9102) - Insufficient Privileges
...
### [SNYK-OS-9103](#snyk-os-9103) - Invalid Credentials
...
### [SNYK-OS-9104](#snyk-os-9104) - Invalid Token
...
### [SNYK-OS-9105](#snyk-os-9105) - Missing Access Token
...
### [SNYK-OS-9106](#snyk-os-9106) - Unauthorized Request
...
### [SNYK-OS-9201](#snyk-os-9201) - Target Not Found
...
### [SNYK-OS-9202](#snyk-os-9202) - Invalid Target
...
### [SNYK-OS-9301](#snyk-os-9301) - File Size Error
...
### [SNYK-OS-9302](#snyk-os-9302) - File Not Found
...
### [SNYK-OS-9901](#snyk-os-9901) - Too Many Requests
...
### [SNYK-OS-9902](#snyk-os-9902) - Service Unavailable
...
### [SNYK-OSJVM-001](#snyk-osjvm-001) - Maven Search Service Unavailable
...
### [SNYK-OSJVM-002](#snyk-osjvm-002) - SHA1 Not Found
...
### [SNYK-OSSI-2010](#snyk-ossi-2010) - Invalid PURL has been provided
...
### [SNYK-OSSI-2011](#snyk-ossi-2011) - Ensure you specify a namespace in the purl and then try again
  ...
  **Help Links:**
  ...
  - [https://github.com/package-url/purl-spec/blob/master/PURL-SPECIFICATION.rst](https://github.com/package-url/purl-spec/blob/master/PURL-SPECIFICATION.rst)
### [SNYK-OSSI-2020](#snyk-ossi-2020) - Ecosystem is not supported
...
### [SNYK-OSSI-2021](#snyk-ossi-2021) - Purl components required
...
### [SNYK-OSSI-2022](#snyk-ossi-2022) - You have submitted a purl with components which are not supported
...
### [SNYK-OSSI-2030](#snyk-ossi-2030) - Requested package not found
...
### [SNYK-OSSI-2031](#snyk-ossi-2031) - Vulnerability service is currently not available
...
### [SNYK-OSSI-2032](#snyk-ossi-2032) - This issue is unexpected and the service should recover quickly if not please contact support
...
### [SNYK-OSSI-2033](#snyk-ossi-2033) - This issue is unexpected and the service should recover quickly if not please contact support
...
### [SNYK-OSSI-2040](#snyk-ossi-2040) - An error was experienced by the service when processing the request
  This issue is unexpected, and the service should recover quickly. If not, please contact support.
...
### [SNYK-OSSI-2041](#snyk-ossi-2041) - Invalid pagination parameters
...
### [SNYK-OSSI-2042](#snyk-ossi-2042) - Purls provided exceeds limit
...
### [SNYK-OSSI-2043](#snyk-ossi-2043) - Number of issues exceeds limit
...
### [SNYK-OSSI-OSPI-1001](#snyk-ossi-ospi-1001) - Invalid request
...
### [SNYK-OSSI-OSPI-1002](#snyk-ossi-ospi-1002) - Unable to return valid API response
...
### [SNYK-OSSI-OSPI-2001](#snyk-ossi-ospi-2001) - Failed to process data
  This should resolve, however please contact support if you continue to experience issues.
...
### [SNYK-OSSI-OSPI-3001](#snyk-ossi-ospi-3001) - Failed to store issue data
...
### [SNYK-OSSI-OSPI-4001](#snyk-ossi-ospi-4001) - Internal server error
  This issue is unexpected, and the service should recover quickly. If not, please contact support.
...
### [SNYK-OSSI-OSPSS-1001](#snyk-ossi-ospss-1001) - Invalid request
  Please check the body of your request and try again.
...
### [SNYK-OSSI-OSPSS-1002](#snyk-ossi-ospss-1002) - Unable to return valid API response
  This should resolve, however please contact support if you continue to experience issues.
...
### [SNYK-OSSI-OSPSS-2001](#snyk-ossi-ospss-2001) - Failed to process data
  This should resolve, however please contact support if you continue to experience issues.
...
### [SNYK-OSSI-OSPSS-3001](#snyk-ossi-ospss-3001) - Failed to store snapshot data
  Please check your inputs and try again. If you continue to experience issues please contact support.
...
### [SNYK-OSSI-OSPSS-4001](#snyk-ossi-ospss-4001) - Internal server error
  This issue is unexpected, and the service should recover quickly. If not, please contact support.
...
Genererated at 2023-03-27T10:27:32.244Z