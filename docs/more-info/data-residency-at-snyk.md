...
Data residency is available for [Snyk Open Source](../scan-applications/snyk-open-source/), [Snyk Code](../scan-applications/snyk-code/), [Snyk Container](../scan-applications/snyk-container/), and [Snyk Infrastructure as Code (IaC)](../scan-infrastructure/snyk-infrastructure-as-code/).
