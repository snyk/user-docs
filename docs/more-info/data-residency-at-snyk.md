...
Data residency is available for [Snyk Open Source](../scan-applications/snyk-open-source/), [Snyk Code](../scan-applications/snyk-code/), [Snyk Container](../scan-containers/), and [Snyk Infrastructure as Code (IaC)](../scan-cloud-configurations/snyk-infrastructure-as-code/).
