...
Bitbucket pipeline implementation for Java \(Maven and Gradle\) requires the [Snyk CLI](https://support.snyk.io/hc/en-us/categories/360000456217-Snyk-CLI).
...
`SNYK_TOKEN: '<string>':` It's preferable to encrypt this value and enter the string $SNYK\_TOKEN only in the pipeline. See the table below for more information.
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <ol>
          ...
          <li>From the pipeline YAML file that you&apos;re building, enter $SNYK_TOKEN
            as the value for the SNYK_TOKEN parameter in the Snyk pipe.</li>
        </ol>
