...
Ensure you meet all prerequisites listed on the [GitHub and GitHub Enterprise permission requirements](../organization-level-integrations/#github-and-github-enterprise-permissions-requirements) page.
