...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><a href="deployment-recommendations.md#stage-1-set-up-your-organization-and-group-level-scm-integrations"><strong>Stage 1:</strong></a><br>Set up an Organization-level SCM integration in your first Snyk Organization.<br><br>Set up a Group-level SCM integration in Snyk Essentials.</p> | <p>See the <a href="snyk-scm-integrations/#organization-level-snyk-scm-integrations">setup documentation</a> for the applicable SCM integration, and read the <a href="snyk-scm-integrations/#user-permissions-and-access-scope-requirements">User permissions and access scope requirements</a> section to ensure accessibility for the right users in your Snyk hierarchy.<br><br>See the <a href="snyk-scm-integrations/#group-level-snyk-essentials-scm-integrations">setup documentation</a> for the applicable Essentials SCM integration.</p> | <p>A configured integration, ready to import Projects.<br><br>Essentials will detect your Git repositories so you can track your progress in rolling out Snyk scanning.</p>                                                                                                                                                                                      |
...
See [Group level SCM integrations](snyk-scm-integrations/#group-level-snyk-essentials-scm-integrations) for details.
...
For details on these permissions, see [User permissions and access scope requirements](snyk-scm-integrations/#user-permissions-and-access-scope-requirements) for your chosen SCM integration.
