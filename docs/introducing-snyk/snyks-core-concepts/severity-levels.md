...
See [Snyk Priority Score](../../features/fixing-and-prioritizing-issues/prioritizing-issues/snyk-priority-score.md) for details of how severity levels are used in Snyk's priority scores.
