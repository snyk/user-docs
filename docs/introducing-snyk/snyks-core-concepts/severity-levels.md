...
See [Snyk Priority Score](../../features/fixing-and-prioritizing-issues/prioritizing-and-managing-issues/snyk-priority-score.md) for details of how severity levels are used in Snyk's priority scores.
