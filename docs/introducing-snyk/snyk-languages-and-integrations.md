...
* **Snyk Container**: see [Supported operating system distribution](../products/snyk-container/snyk-container-security-basics/supported-operating-system-distributions.md).&#x20;
