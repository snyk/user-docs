...
{% hint style="info" %}
This report is available only if you have [Snyk IaC+](../../../scan-configurations/snyk-iac+/) or the legacy Snyk Cloud enabled.
{% endhint %}

The Cloud Compliance Issues report shows cloud and IaC+ issues for an entire Organization, organized by [compliance standard](../../../scan-configurations/snyk-iac+/key-concepts-in-iac+.md#docs-internal-guid-e2e38027-7fff-9271-f2c0-e23677542f6e).
...
Selecting an issue count lets you view the list of issues associated with that control in the [Cloud Issues UI](../../../scan-configurations/snyk-iac+/cloud-and-integrated-iac-issues/view-cloud-and-integragted-iac-issues-in-the-snyk-web-ui.md), where you can view each issue in detail.
