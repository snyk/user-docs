...
See [Snyk Priority Score and Kubernetes](../../scan-applications/snyk-container/integrate-with-kubernetes/navigate-the-kubernetes-integration-ui/snyk-priority-score-and-kubernetes.md) for more details.
