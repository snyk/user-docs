...
{% hint style="info" %}
Severity levels also apply to license issues. See [Licenses](../../scan-with-snyk/start-scanning-using-the-cli-web-ui-or-api/scan-open-source-libraries-and-licenses/open-source-license-compliance.md).
{% endhint %}
