...
Add Snyk [Project tags](../../../snyk-admin/snyk-projects/project-tags.md) to all the Projects used by your application, to link these Projects together and allow Insights to represent the whole of the application that you are testing.&#x20;
...
| <p><br></p>                  | Built container image called `image-A` | <p>Snyk Org: my-team</p><p><br></p><p>Project name: image-A</p>      | <p><code>component=pkg:github/my-team/front-end@main</code></p><p></p><p><code>component=pkg:github/my-team/back-end@main</code></p> | <p>The image has two tags applied, as there are two upstream dependencies which have different tags. <br></p><p>You can apply multiple tags to an image. </p> |
