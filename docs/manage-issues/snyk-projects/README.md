...
The grouping option controls whether the filtering attributes are applied at the Target or at the Project level. **Group by none** (ungrouped) lets you apply [tags](project-tags.md) and [filtering attributes at the Project level](../introduction-to-snyk-projects/project-attributes.md) to the individual Projects.
...
Use **Group by none** (ungrouped) for better Project visibility and to apply [filtering attributes at the Project level](../introduction-to-snyk-projects/project-attributes.md).
