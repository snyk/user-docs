...
If you change severity, results from scans are updated in the [Snyk Web UI](../../../getting-started/explore-snyk-through-the-web-ui.md), in [your IDE](../../../integrate-with-snyk/use-snyk-in-your-ide/), or in Snyk [PR Checks](../../../scan-using-snyk/run-pr-checks/).
