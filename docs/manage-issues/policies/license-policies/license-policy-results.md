...
If you change severity, results from scans are updated in the [Snyk Web UI](../../../getting-started/exploring-the-snyk-web-ui.md), in [your IDE](../../../integrations/ide-tools/), or in Snyk [PR Checks](../../../scan-applications/run-pr-checks/).
