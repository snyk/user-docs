...
If you change severity, results from scans are updated in the [Snyk Web UI](../../../getting-started/explore-snyk-through-the-web-ui.md), in [your IDE](../../../integrations/ide-tools/), or in Snyk [PR Checks](../../../scan-with-snyk/run-pr-checks/).
