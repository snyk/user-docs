...
* From the **Filters** drop-down, check the applicable boxes to filter by [Severity level](../../manage-risk/find-and-manage-priority-issues/severity-levels.md) or Project type.
