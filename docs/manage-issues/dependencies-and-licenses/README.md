...
* From the **Filters** drop-down, check the applicable boxes to filter by [Severity level](../../manage-risk/prioritize-your-issues/severity-levels.md) or Project type.
