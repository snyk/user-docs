...
To understand more about roles and permissions within Snyk, see [Pre-defined roles](../../user-roles/pre-defined-roles.md). See also [user role management](../../user-roles/user-role-management.md).
...
* The pre-defined Group-level role **Group Viewer** for all groups in the SSO. See [pre-defined roles](../../user-roles/pre-defined-roles.md) for the permission this grants
...
For more details on roles, and specifically, custom roles, see [user role management](../../user-roles/user-role-management.md).
...
Snyk has a set of [pre-defined roles](../../user-roles/pre-defined-roles.md). Their corresponding normalized names are listed below.
