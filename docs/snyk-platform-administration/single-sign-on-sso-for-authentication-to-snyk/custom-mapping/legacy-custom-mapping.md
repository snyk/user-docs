...
* **role**:
  ...
  * Custom Role can also be used for `{role}` and should use the normalized name. See [Roles in custom SSO](../../user-roles/user-role-management.md#use-roles-in-custom-sso) for more details.
