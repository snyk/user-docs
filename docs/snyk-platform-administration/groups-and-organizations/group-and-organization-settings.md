...
* **Open Source**: Enable Reachable vulnerabilities analysis and edit language settings; see [Snyk Open Source - supported languages and package managers](../../supported-languages/supported-languages-package-managers-and-frameworks.md) for details.
