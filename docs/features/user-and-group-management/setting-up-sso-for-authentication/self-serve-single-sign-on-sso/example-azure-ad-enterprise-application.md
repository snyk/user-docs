...
7.  For the new app, select **Set up single sign on** and **Get started**.
    ...
    <figure><img src="../../../../.gitbook/assets/7 (1) (1).png" alt="Set up single sign-on, Get started"><figcaption><p>Set up single sign-on, Get started</p></figcaption></figure>
...
9.  Click **Edit** under **Basic SAML configuration**.
    ...
    <figure><img src="../../../../.gitbook/assets/9 (3).png" alt="Edit basic SAML configuration"><figcaption><p>Edit basic SAML configuration</p></figcaption></figure>
