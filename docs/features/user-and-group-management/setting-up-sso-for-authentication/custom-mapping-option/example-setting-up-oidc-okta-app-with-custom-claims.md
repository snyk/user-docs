...
1.  In Okta, select **Applications -> Applications -> Create App Integration** then choose **OICD OpenID Connect** and **Web Application.**
    ...
    <figure><img src="../../../../.gitbook/assets/1 (6).png" alt="Create a new app integration in Okta"><figcaption><p>Create a new app integration in Okta</p></figcaption></figure>
...
2.  Select **+Add Attribute.**
    ...
    <figure><img src="../../../../.gitbook/assets/3 (4).png" alt="Okta profile editor"><figcaption><p>Okta profile editor</p></figcaption></figure>
