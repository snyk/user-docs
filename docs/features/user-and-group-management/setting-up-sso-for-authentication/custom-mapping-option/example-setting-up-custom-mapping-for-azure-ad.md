...
5.  Configure Attribute: expand the **Claim conditions**.\
    ...
    <figure><img src="../../../../.gitbook/assets/Name-Claim-conditions-section (1) (1) (1) (1) (1) (1).png" alt="Enter the Name and expand Claim conditions"><figcaption><p>Enter the Name and expand Claim conditions</p></figcaption></figure>
...
7.  Repeat for all required groups and roles that should be assigned. Then verify that the list looks similar to this.
    ...
    <figure><img src="../../../../.gitbook/assets/image (6) (1) (3).png" alt="Users and group list"><figcaption><p>Users and group list</p></figcaption></figure>
