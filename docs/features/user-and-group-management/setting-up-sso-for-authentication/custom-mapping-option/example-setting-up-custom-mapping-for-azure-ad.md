...
1.  In your app registration menu, select the name of your Enterprise Application.
    ...
    <figure><img src="../../../../.gitbook/assets/image (181).png" alt="App registration, select name of Enterprise Application"><figcaption><p>App registration, select name of Enterprise Application</p></figcaption></figure>
2.  Select **App roles**, then **Create app role**.

    <figure><img src="../../../../.gitbook/assets/image (1) (3).png" alt="Select App roles, Create app role"><figcaption><p>Select App roles, Create app role</p></figcaption></figure>
3.  Create an app role with details as needed.\
    ...
    <figure><img src="../../../../.gitbook/assets/image (2) (3).png" alt="Create app role with details"><figcaption><p>Create app role with details</p></figcaption></figure>
