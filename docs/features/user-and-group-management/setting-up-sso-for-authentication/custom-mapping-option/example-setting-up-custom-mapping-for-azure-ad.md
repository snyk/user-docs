...
1.  In your app registration menu, select the name of your Enterprise Application.
    ...
    <figure><img src="../../../../.gitbook/assets/image (7).png" alt="App registration, select name of Enterprise Application"><figcaption><p>App registration, select name of Enterprise Application</p></figcaption></figure>
...
4.  In Azure AD, select your Enterprise Application.
    ...
    <figure><img src="../../../../.gitbook/assets/image (3).png" alt="Select Enterprise Application in Azure AD"><figcaption><p>Select Enterprise Application in Azure AD</p></figcaption></figure>
