...
The [Snyk CLI](../../../../snyk-cli/) can be used to create the Snyk App. If you do not already have the Snyk CLI installed on your machine, you can install it by following the steps in [Getting started with the CLI](../../../../snyk-cli/getting-started-with-the-cli/). See [Create a Snyk App using the CLI](../../../../snyk-apps/create-a-snyk-app-using-the-snyk-cli.md) for details.
