...
* [Install the Snyk plugin on your Jenkins account](broken-reference)
* [Jenkins integration: Snyk for your pipeline](broken-reference)
* [Jenkins integration: Snyk for freestyle](broken-reference)
