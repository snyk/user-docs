...
* \*\*\*\*![](<../../../.gitbook/assets/image (50).png>) **Low:** the application may expose some data allowing vulnerability mapping, which can be used with other vulnerabilities to attack the application.
* \*\*\*\*![](<../../../.gitbook/assets/image (117).png>) **Medium:** may allow attackers under some conditions to access sensitive data on your application.
