...
For more details about fixing the affected packages, see our [Log4Shell fix cheatsheet](https://snyk.io/blog/log4shell-remediation-cheat-sheet).

### Limitations

* The Snyk CLI compares file signatures to a database of known files. If the Log4Shell vulnerability is fixed by a different way than updating the log4j library, the library will still be reported in the results.
* If the source code of the log4j library has been modified, it will not be detected.
