...
* **SNYK\_TOKEN -** your Snyk API token, as also used by the CLI, see [Authenticate the CLI with your account](../../snyk-cli/authenticate-the-cli-with-your-account.md) for additional details.
