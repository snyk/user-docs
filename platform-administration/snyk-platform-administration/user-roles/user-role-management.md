...
{% hint style="info" %}
**Feature availability**\
Service accounts are available only with Enterprise plans. Free and Team users have access to [personal tokens](https://app.gitbook.com/o/-M4tdxG8qotLgGZnLpFR/s/IEEjSXQQu36y0vmFV8zf/snyk-cli/snyk-cli/authenticate-to-use-the-cli) only. Personal tokens are recommended for use with IDEs and the local CLI.
