...
<figure><img src="../../.gitbook/assets/create-custom-organization-level-role.png" alt="Create a custom Organization-level role" width="375"><figcaption><p>Create a custom Organization-level role</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/role-details-custom-role.png" alt="Role Details for a custom role" width="563"><figcaption><p>Role Details for a custom role</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/organization-level-permissions-section.png" alt="Organization-level permissions section"><figcaption><p>Organization-level permissions section</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/role-update-confirmation-message.png" alt="Role update confirmation message"><figcaption><p>Role update confirmation message</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/duplicate-role-using-copy-icon-member-roles-page.png" alt="Duplicate a role using the copy icon on the Member Roles page"><figcaption><p>Duplicate a role using the copy icon on the Member Roles page</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/duplicate-role-using-duplicate-role-button-under-role.png" alt="Duplicate a role using the Duplicate role button under Role Details"><figcaption><p>Duplicate a role using the Duplicate role button under Role Details</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/duplicate-role-creation.png" alt="Duplicate role creation" width="375"><figcaption><p>Duplicate role creation</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/prompt-delete-role-reassign-members.png" alt="Prompt to delete a role and reassign members"><figcaption><p>Prompt to delete a role and reassign members</p></figcaption></figure>
...
{% hint style="info" %}
You can use the API to update the role assigned to a user in an Organization. For details, see the endpoint [Update a member's role in the organization](https://docs.snyk.io/developer-tools/snyk-api/reference/organizations-v1#org-orgid-members-update-userid).
{% endhint %}
...
<figure><img src="../../.gitbook/assets/org-member-change-role.png" alt="Select member role"><figcaption><p>Select member role</p></figcaption></figure>
...
<div align="left"><figure><img src="../../.gitbook/assets/add-members-organization.png" alt="Add members to your Organization"><figcaption><p>Add members to your Organization</p></figcaption></figure></div>
...
Alternatively, use the endpoints [Update a member in the organization](https://docs.snyk.io/developer-tools/snyk-api/reference/organizations-v1#org-orgid-members-userid) and [Remove a member from the organization](https://docs.snyk.io/developer-tools/snyk-api/reference/organizations-v1#org-orgid-members-userid-1) to update the role of members in your Organization. This API call does not support updating the role of Group Members.
