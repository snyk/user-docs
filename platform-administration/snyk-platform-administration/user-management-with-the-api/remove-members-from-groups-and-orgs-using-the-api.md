...
**Endpoint**: [Remove a member from the organization](https://docs.snyk.io/developer-tools/snyk-api/reference/organizations-v1#org-orgid-members-userid-1)
...
**Endpoint**: [List all members in a group](https://docs.snyk.io/developer-tools/snyk-api/reference/groups-v1#group-groupid-members)
