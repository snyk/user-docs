...
**Endpoint:** [List all roles in a group](https://docs.snyk.io/developer-tools/snyk-api/reference/groups-v1#group-groupid-roles)
...
**Endpoint**: [List members](https://docs.snyk.io/developer-tools/snyk-api/reference/organizations-v1#org-orgid-members)
...
**Endpoint**: [Update a member's role in the organization](https://docs.snyk.io/developer-tools/snyk-api/reference/organizations-v1#org-orgid-members-update-userid)
