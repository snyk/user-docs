...
Organizations represent business areas such as teams, products, or environments. An Organization contains [Snyk Projects](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-projects) that contain the code team members are scanning.
