...
* **Ignores**: Define Organization-wide ignore settings. You can choose from the following options:
  ...
  * **Require reason for each ignore**
    ...
    * `Not required`
    * See [Configure Ignore settings](https://docs.snyk.io/scan-fix-and-prevent/fix/prioritize-issues-for-fixing/ignore-issues#configure-ignore-settings) in the Ignore issues documentation for more details.
