...
* **Snyk IaC**: Enable rules to add checks to Snyk rules when you are scanning configuration files with the Snyk CLI. See the [IaC documentation](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-iac) for details.
