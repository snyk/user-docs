...
<figure><img src="../../../.gitbook/assets/settings_group_settings_general.png" alt="Group settings"><figcaption><p>Group settings</p></figcaption></figure>
...
* **Group ID**: View and copy the unique ID for this Group. You will need this ID when using the [Snyk API](https://docs.snyk.io/developer-tools/snyk-api/snyk-api).
