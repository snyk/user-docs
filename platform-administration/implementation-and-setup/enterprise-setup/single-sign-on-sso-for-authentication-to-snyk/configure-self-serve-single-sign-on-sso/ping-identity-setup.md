...
11. Click the cog icon and add the following attributes:
    ...
    **name**: the expression `user.name.given + ' ' + user.name.famil`y; click the cog icon to enter an advanced description.
    ...
    <figure><img src="../../../../.gitbook/assets/8 (3).png" alt="Add an advanced expression for the name attribute"><figcaption><p>Add an advanced expression for the name attribute</p></figcaption></figure>
