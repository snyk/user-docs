---
description: How to set up an Entra ID (formerly Azure AD) Enterprise Application and connect it to Snyk for SSO
---
...
5.  Choose **Create your own application**.
    ...
    <figure><img src="../../../../.gitbook/assets/5 (4).png" alt="Create your own application"><figcaption><p>Create your own application</p></figcaption></figure>
