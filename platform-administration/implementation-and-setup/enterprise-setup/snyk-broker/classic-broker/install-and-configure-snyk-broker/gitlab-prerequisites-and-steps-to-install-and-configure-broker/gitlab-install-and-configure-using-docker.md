...
Copy the following command to set up a fully configured Broker Client to analyze Open Source, IaC, Container, Code files, and Snyk Essentials information. Enable [Snyk Essentials ](https://docs.snyk.io/scan-fix-and-prevent/scan-with-snyk/snyk-essentials)to identify your application assets, monitor them, and prioritize the risks.
