...
If your team needs to set up a service account in GitHub, you must use [GitHub Enterprise](https://docs.snyk.io/developer-tools/integrations/scm-integrations/organization-level-integrations/github-enterprise), which is available only with Snyk Enterprise accounts.
...
<figure><img src="../../../.gitbook/assets/group-settings.png" alt="Group settings"><figcaption><p>Group settings</p></figcaption></figure>
